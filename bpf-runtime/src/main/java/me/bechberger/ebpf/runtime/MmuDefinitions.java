...
/**
 * Generated class for BPF runtime types that start with mmu
 */
...
public final class MmuDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void __mmu_notifier_arch_invalidate_secondary_tlbs(Ptr<mm_struct> mm,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int __mmu_notifier_clear_flush_young(Ptr<mm_struct> mm, @Unsigned long start,
      @Unsigned long end) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int __mmu_notifier_clear_young(Ptr<mm_struct> mm, @Unsigned long start,
      @Unsigned long end) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void __mmu_notifier_invalidate_range_end(Ptr<mmu_notifier_range> range) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int __mmu_notifier_invalidate_range_start(Ptr<mmu_notifier_range> range) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int __mmu_notifier_register(Ptr<mmu_notifier> subscription, Ptr<mm_struct> mm) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void __mmu_notifier_release(Ptr<mm_struct> mm) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void __mmu_notifier_subscriptions_destroy(Ptr<mm_struct> mm) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int __mmu_notifier_test_young(Ptr<mm_struct> mm, @Unsigned long address) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void mmu_notifier_free_rcu(Ptr<callback_head> rcu) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void mmu_notifier_invalidate_range_end(Ptr<mmu_notifier_range> range) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void mmu_notifier_invalidate_range_start(Ptr<mmu_notifier_range> range) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int mmu_notifier_register(Ptr<mmu_notifier> subscription, Ptr<mm_struct> mm) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void mmu_notifier_unregister(Ptr<mmu_notifier> subscription, Ptr<mm_struct> mm) {
    throw new MethodIsBPFRelatedFunction();
  }

  @Type(
      noCCodeGeneration = true,
      cType = "enum mmu_notifier_event"
  )
  public enum mmu_notifier_event implements Enum<mmu_notifier_event>, TypedEnum<mmu_notifier_event, java.lang. @Unsigned Integer> {
    /**
     * {@code MMU_NOTIFY_UNMAP = 0}
     */
    @EnumMember(
        value = 0L,
    ...
    /**
     * {@code MMU_NOTIFY_PROTECTION_VMA = 2}
     */
    @EnumMember(
        value = 2L,
    ...
    /**
     * {@code MMU_NOTIFY_PROTECTION_PAGE = 3}
     */
    @EnumMember(
        value = 3L,
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct mmu_notifier_ops"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class mmu_notifier_ops extends Struct {
    public Ptr<?> release;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct mmu_notifier"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class mmu_notifier extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct mmu_notifier_range"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class mmu_notifier_range extends Struct {
    public Ptr<mm_struct> mm;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct mmu_update"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class mmu_update extends Struct {
    public @Unsigned @OriginalName("uint64_t") long ptr;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct mmu_table_batch"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class mmu_table_batch extends Struct {
    public callback_head rcu;

    public @Unsigned int nr;

    public Ptr<?> @Size(0) [] tables;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct mmu_gather_batch"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class mmu_gather_batch extends Struct {
    ...
    public @OriginalName("encoded_page") Ptr<?> @Size(0) [] encoded_pages;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct mmu_gather"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class mmu_gather extends Struct {
    public Ptr<mm_struct> mm;
    ...
    public Ptr<page> @Size(8) [] __pages;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct mmu_notifier_subscriptions"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class mmu_notifier_subscriptions extends Struct {
    ...
    public rb_root_cached itree;

    public @OriginalName("wait_queue_head_t") wait_queue_head wq;

    public hlist_head deferred_list;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct mmu_interval_notifier_ops"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class mmu_interval_notifier_ops extends Struct {
    public Ptr<?> invalidate;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct mmu_interval_notifier"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class mmu_interval_notifier extends Struct {
    public interval_tree_node interval_tree;

    public Ptr<mmu_interval_notifier_ops> ops;

    public Ptr<mm_struct> mm;

    public hlist_node deferred_item;

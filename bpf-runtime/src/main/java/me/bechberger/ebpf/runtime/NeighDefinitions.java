...
/**
 * Generated class for BPF runtime types that start with neigh
 */
...
public final class NeighDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction("__neigh_event_send($arg1, $arg2, (const _Bool)$arg3)")
  public static int __neigh_event_send(Ptr<neighbour> neigh, Ptr<sk_buff> skb,
      boolean immediate_ok) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction("__neigh_for_each_release($arg1, (int (*)(struct neighbour*))$arg2)")
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int __neigh_ifdown(Ptr<neigh_table> tbl, Ptr<net_device> dev, boolean skip_perm) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void __neigh_notify(Ptr<neighbour> n, int type, int flags, @Unsigned int pid) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void __neigh_set_probe_once(Ptr<neighbour> neigh) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int neigh_add(Ptr<sk_buff> skb, Ptr<nlmsghdr> nlh, Ptr<netlink_ext_ack> extack) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void neigh_add_timer(Ptr<neighbour> n, @Unsigned long when) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void neigh_app_ns(Ptr<neighbour> n) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int neigh_blackhole(Ptr<neighbour> neigh, Ptr<sk_buff> skb) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int neigh_carrier_down(Ptr<neigh_table> tbl, Ptr<net_device> dev) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void neigh_changeaddr(Ptr<neigh_table> tbl, Ptr<net_device> dev) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void neigh_cleanup_and_release(Ptr<neighbour> neigh) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int neigh_connected_output(Ptr<neighbour> neigh, Ptr<sk_buff> skb) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int neigh_del_timer(Ptr<neighbour> n) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int neigh_delete(Ptr<sk_buff> skb, Ptr<nlmsghdr> nlh, Ptr<netlink_ext_ack> extack) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void neigh_destroy(Ptr<neighbour> neigh) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int neigh_direct_output(Ptr<neighbour> neigh, Ptr<sk_buff> skb) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int neigh_dump_info(Ptr<sk_buff> skb, Ptr<netlink_callback> cb) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<neighbour> neigh_event_ns(Ptr<neigh_table> tbl, Ptr<java.lang.Character> lladdr,
      Ptr<?> saddr, Ptr<net_device> dev) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int neigh_fill_info(Ptr<sk_buff> skb, Ptr<neighbour> neigh, @Unsigned int pid,
      @Unsigned int seq, int type, @Unsigned int flags) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void neigh_flush_one(Ptr<neighbour> n) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction("neigh_for_each($arg1, (void (*)(struct neighbour*, void*))$arg2, $arg3)")
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int neigh_get(Ptr<sk_buff> in_skb, Ptr<nlmsghdr> nlh, Ptr<netlink_ext_ack> extack) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<neighbour> neigh_get_first(Ptr<seq_file> seq) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<neighbour> neigh_get_next(Ptr<seq_file> seq, Ptr<neighbour> n,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void neigh_hash_free_rcu(Ptr<callback_head> head) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int neigh_ifdown(Ptr<neigh_table> tbl, Ptr<net_device> dev) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void neigh_invalidate(Ptr<neighbour> neigh) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void neigh_managed_work(Ptr<work_struct> work) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<neigh_parms> neigh_parms_alloc(Ptr<net_device> dev, Ptr<neigh_table> tbl) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void neigh_periodic_work(Ptr<work_struct> work) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void neigh_probe(Ptr<neighbour> neigh) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void neigh_proxy_process(Ptr<timer_list> t) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void neigh_rcu_free_parms(Ptr<callback_head> head) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void neigh_release(Ptr<neighbour> neigh) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static boolean neigh_remove_one(Ptr<neighbour> n) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int neigh_resolve_output(Ptr<neighbour> neigh, Ptr<sk_buff> skb) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<?> neigh_seq_next(Ptr<seq_file> seq, Ptr<?> v,
      Ptr<java.lang. @OriginalName("loff_t") Long> pos) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<?> neigh_seq_start(Ptr<seq_file> seq,
      Ptr<java.lang. @OriginalName("loff_t") Long> pos, Ptr<neigh_table> tbl,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void neigh_seq_stop(Ptr<seq_file> seq, Ptr<?> v) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<?> neigh_stat_seq_next(Ptr<seq_file> seq, Ptr<?> v,
      Ptr<java.lang. @OriginalName("loff_t") Long> pos) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int neigh_stat_seq_show(Ptr<seq_file> seq, Ptr<?> v) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<?> neigh_stat_seq_start(Ptr<seq_file> seq,
      Ptr<java.lang. @OriginalName("loff_t") Long> pos) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void neigh_stat_seq_stop(Ptr<seq_file> seq, Ptr<?> v) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int neigh_sysctl_register(Ptr<net_device> dev, Ptr<neigh_parms> p, Ptr<?> handler) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int neigh_table_clear(int index, Ptr<neigh_table> tbl) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void neigh_table_init(int index, Ptr<neigh_table> tbl) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void neigh_timer_handler(Ptr<timer_list> t) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @Type(
      ...
      cType = "struct neigh_parms"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class neigh_parms extends Struct {
    ...
    public int @Size(14) [] data;

    public @Unsigned long @Size(1) [] data_state;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct neigh_table"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class neigh_table extends Struct {
    public int family;
    ...
    public delayed_work managed_work;

    public timer_list proxy_timer;

    public sk_buff_head proxy_queue;

    public atomic_t entries;

    public atomic_t gc_entries;
    ...
    public mutex phash_lock;

    public Ptr<Ptr<pneigh_entry>> phash_buckets;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct neigh_statistics"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class neigh_statistics extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct neigh_ops"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class neigh_ops extends Struct {
    public int family;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct neigh_hash_table"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class neigh_hash_table extends Struct {
    public Ptr<hlist_head> hash_heads;

    public @Unsigned int hash_shift;

    public @Unsigned int @Size(4) [] hash_rnd;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct neigh_seq_state"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class neigh_seq_state extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct neigh_dump_filter"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class neigh_dump_filter extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct neigh_sysctl_table"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class neigh_sysctl_table extends Struct {
    public Ptr<ctl_table_header> sysctl_header;

    public ctl_table @Size(21) [] neigh_vars;
  }
}

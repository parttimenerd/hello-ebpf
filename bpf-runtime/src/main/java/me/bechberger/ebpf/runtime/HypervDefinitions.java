...
/**
 * Generated class for BPF runtime types that start with hyperv
 */
...
public final class HypervDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int hyperv_fill_flush_guest_mapping_list(Ptr<hv_guest_mapping_flush_list> flush,
      @Unsigned long start_gfn, @Unsigned long pages) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int hyperv_flush_guest_mapping_range(@Unsigned long as,
      @OriginalName("hyperv_fill_flush_list_func") Ptr<?> fill_flush_list_func, Ptr<?> data) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int hyperv_irq_remapping_alloc(Ptr<irq_domain> domain, @Unsigned int virq,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void hyperv_irq_remapping_free(Ptr<irq_domain> domain, @Unsigned int virq,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int hyperv_irq_remapping_select(Ptr<irq_domain> d, Ptr<irq_fwspec> fwspec,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void hyperv_report_panic(Ptr<pt_regs> regs, long err, boolean in_die) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void hyperv_root_ir_compose_msi_msg(Ptr<irq_data> irq_data, Ptr<msi_msg> msg) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int hyperv_root_irq_remapping_alloc(Ptr<irq_domain> domain, @Unsigned int virq,
      @Unsigned int nr_irqs, Ptr<?> arg) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void hyperv_root_irq_remapping_free(Ptr<irq_domain> domain, @Unsigned int virq,
      @Unsigned int nr_irqs) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @Type(
      ...
      cType = "struct hyperv_root_ir_data"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class hyperv_root_ir_data extends Struct {
    public char ioapic_id;

    public boolean is_level;

    public hv_interrupt_entry entry;
  }
}

...
/**
 * Generated class for BPF runtime types that start with kexec
 */
...
public final class KexecDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int kexec_alloc_contig(Ptr<kexec_buf> kbuf) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int kexec_calculate_store_digests(Ptr<kimage> image) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long kexec_crash_loaded_show(Ptr<kobject> kobj,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long kexec_crash_size_show(Ptr<kobject> kobj,
      Ptr<kobj_attribute> attr, String buf) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int kexec_image_post_load_cleanup_default(Ptr<kimage> image) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int kexec_image_probe_default(Ptr<kimage> image, Ptr<?> buf,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int kexec_load_purgatory(Ptr<kimage> image, Ptr<kexec_buf> kbuf) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long kexec_loaded_show(Ptr<kobject> kobj,
      Ptr<kobj_attribute> attr, String buf) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int kexec_purgatory_setup_sechdrs(Ptr<purgatory_info> pi, Ptr<kexec_buf> kbuf) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int kexec_should_crash(Ptr<task_struct> p) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction("kexec_walk_memblock($arg1, (int (*)(struct resource*, void*))$arg2)")
  public static int kexec_walk_memblock(Ptr<kexec_buf> kbuf, Ptr<?> func) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  public static class kexec_segment extends Struct {
    @InlineUnion(9097)
    public Ptr<?> buf;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct kexec_file_ops"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class kexec_file_ops extends Struct {
    public Ptr<?> probe;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct kexec_entry64_regs"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class kexec_entry64_regs extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct kexec_buf"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class kexec_buf extends Struct {
    public Ptr<kimage> image;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct kexec_load_limit"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class kexec_load_limit extends Struct {
    public mutex mutex;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct kexec_sha_region"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class kexec_sha_region extends Struct {

...
/**
 * Generated class for BPF runtime types that start with sysctl
 */
...
public final class SysctlDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void sysctl_core_net_exit(Ptr<net> net) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int sysctl_core_net_init(Ptr<net> net) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction("sysctl_follow_link($arg1, (const struct ctl_table**)$arg2)")
  public static int sysctl_follow_link(Ptr<Ptr<ctl_table_header>> phead,
      Ptr<Ptr<ctl_table>> pentry) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static boolean sysctl_is_alias(String param) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void sysctl_net_exit(Ptr<net> net) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int sysctl_net_init(Ptr<net> net) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void sysctl_print_dir(Ptr<ctl_dir> dir) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void sysctl_route_net_exit(Ptr<net> net) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int sysctl_route_net_init(Ptr<net> net) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @Type(
      ...
      cType = "struct sysctl_fib_multipath_hash_seed"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class sysctl_fib_multipath_hash_seed extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "enum sysctl_writes_mode"
  )
  public enum sysctl_writes_mode implements Enum<sysctl_writes_mode>, TypedEnum<sysctl_writes_mode, java.lang.Integer> {
    /**
     * {@code SYSCTL_WRITES_LEGACY = -1}
     */
    @EnumMember(
        value = -1L,
        name = "SYSCTL_WRITES_LEGACY"
    )
    SYSCTL_WRITES_LEGACY,

    /**
     * {@code SYSCTL_WRITES_WARN = 0}
     */
    @EnumMember(
        value = 0L,
        name = "SYSCTL_WRITES_WARN"
    )
    SYSCTL_WRITES_WARN,

    /**
     * {@code SYSCTL_WRITES_STRICT = 1}
     */
    @EnumMember(
        value = 1L,
        name = "SYSCTL_WRITES_STRICT"
    )
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct sysctl_alias"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class sysctl_alias extends Struct {

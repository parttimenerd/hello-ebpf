...
/**
 * Generated class for BPF runtime types that start with drmm
 */
...
public final class DrmmDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void __drmm_mutex_release(Ptr<drm_device> dev, Ptr<?> res) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<?> __drmm_simple_encoder_alloc(Ptr<drm_device> dev, @Unsigned long size,
      @Unsigned long offset, int encoder_type) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void __drmm_workqueue_release(Ptr<drm_device> device, Ptr<?> res) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void drmm_add_final_kfree(Ptr<drm_device> dev, Ptr<?> container) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void drmm_cg_unregister_region(Ptr<drm_device> dev, Ptr<?> arg) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  public static int drmm_connector_hdmi_init(Ptr<drm_device> dev, Ptr<drm_connector> connector,
      ...
      @Unsigned long supported_formats, @Unsigned int max_bpc) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void drmm_crtc_init_with_planes_cleanup(Ptr<drm_device> dev, Ptr<?> ptr) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void drmm_drm_panel_bridge_release(Ptr<drm_device> drm, Ptr<?> ptr) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void drmm_encoder_alloc_release(Ptr<drm_device> dev, Ptr<?> ptr) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void drmm_kfree(Ptr<drm_device> dev, Ptr<?> data) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<?> drmm_kmalloc(Ptr<drm_device> dev, @Unsigned long size,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void drmm_kms_helper_poll_init(Ptr<drm_device> dev) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int drmm_mode_config_init(Ptr<drm_device> dev) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<drm_bridge> drmm_panel_bridge_add(Ptr<drm_device> drm, Ptr<drm_panel> panel) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void drmm_release_action(Ptr<drm_device> dev,
      @OriginalName("drmres_release_t") Ptr<?> action, Ptr<?> data) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void drmm_universal_plane_alloc_release(Ptr<drm_device> dev, Ptr<?> ptr) {
    throw new MethodIsBPFRelatedFunction();
  }

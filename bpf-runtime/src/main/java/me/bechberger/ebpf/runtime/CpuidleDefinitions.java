...
/**
 * Generated class for BPF runtime types that start with cpuidle
 */
@java.lang.SuppressWarnings("unused")
public final class CpuidleDefinitions {
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int cpuidle_add_device_sysfs(Ptr<cpuidle_device> device) {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int cpuidle_add_state_sysfs(Ptr<cpuidle_device> device) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void cpuidle_driver_state_disabled(Ptr<cpuidle_driver> drv, int idx,
      boolean disable) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int cpuidle_enter(Ptr<cpuidle_driver> drv, Ptr<cpuidle_device> dev, int index) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int cpuidle_enter_state(Ptr<cpuidle_device> dev, Ptr<cpuidle_driver> drv,
      int index) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int cpuidle_find_deepest_state(Ptr<cpuidle_driver> drv, Ptr<cpuidle_device> dev,
      @Unsigned long latency_limit_ns) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static long cpuidle_governor_latency_req(@Unsigned int cpu) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void cpuidle_reflect(Ptr<cpuidle_device> dev, int index) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction("cpuidle_register($arg1, (const const struct cpumask*)$arg2)")
  public static int cpuidle_register(Ptr<cpuidle_driver> drv, Ptr<cpumask> coupled_cpus) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void cpuidle_remove_device_sysfs(Ptr<cpuidle_device> device) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void cpuidle_remove_interface(Ptr<device> dev) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int cpuidle_select(Ptr<cpuidle_driver> drv, Ptr<cpuidle_device> dev,
      Ptr<java.lang. @OriginalName("bool") Boolean> stop_tick) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void cpuidle_setup_broadcast_timer(Ptr<?> arg) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long cpuidle_show(Ptr<kobject> kobj, Ptr<attribute> attr,
      String buf) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long cpuidle_state_show(Ptr<kobject> kobj,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void cpuidle_state_sysfs_release(Ptr<kobject> kobj) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void cpuidle_sysfs_release(Ptr<kobject> kobj) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @Type(
      ...
      cType = "struct cpuidle_state_usage"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class cpuidle_state_usage extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct cpuidle_state"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class cpuidle_state extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct cpuidle_device"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class cpuidle_device extends Struct {
    ...
    public cpuidle_state_usage @Size(10) [] states_usage;

    public Ptr<cpuidle_state_kobj> @Size(10) [] kobjs;

    public @OriginalName("cpuidle_driver_kobj") Ptr<?> kobj_driver;

    public Ptr<cpuidle_device_kobj> kobj_dev;

    public list_head device_list;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct cpuidle_driver"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class cpuidle_driver extends Struct {
    public String name;
    ...
    public cpuidle_state @Size(10) [] states;

    public int state_count;

    public int safe_state_index;

    public Ptr<cpumask> cpumask;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct cpuidle_governor"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class cpuidle_governor extends Struct {
    public char @Size(16) [] name;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct cpuidle_state_kobj"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class cpuidle_state_kobj extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct cpuidle_device_kobj"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class cpuidle_device_kobj extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct cpuidle_attr"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class cpuidle_attr extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct cpuidle_state_attr"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class cpuidle_state_attr extends Struct {
    public attribute attr;

...
/**
 * Generated class for BPF runtime types that start with mdio
 */
@java.lang.SuppressWarnings("unused")
public final class MdioDefinitions {
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long mdio_bus_device_stat_field_show(Ptr<device> dev,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int mdio_bus_phy_resume(Ptr<device> dev) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int mdio_bus_phy_suspend(Ptr<device> dev) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long mdio_bus_stat_field_show(Ptr<device> dev,
      Ptr<device_attribute> attr, String buf) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<mdio_device> mdio_device_create(Ptr<mii_bus> bus, int addr) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void mdio_device_release(Ptr<device> dev) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int mdio_probe(Ptr<device> dev) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int mdio_remove(Ptr<device> dev) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void mdio_shutdown(Ptr<device> dev) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @Type(
      ...
      cType = "struct mdio_device"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class mdio_device extends Struct {
    public device dev;

    public Ptr<mii_bus> bus;
    ...
    public Ptr<reset_control> reset_ctrl;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct mdio_bus_stats"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class mdio_bus_stats extends Struct {
    public u64_stats_t transfers;

    public u64_stats_t errors;

    public u64_stats_t writes;

    public u64_stats_t reads;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct mdio_board_info"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class mdio_board_info extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct mdio_board_entry"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class mdio_board_entry extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct mdio_driver_common"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class mdio_driver_common extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct mdio_driver"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class mdio_driver extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct mdio_bus_stat_attr"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class mdio_bus_stat_attr extends Struct {
    public int addr;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct mdio_device_id"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class mdio_device_id extends Struct {

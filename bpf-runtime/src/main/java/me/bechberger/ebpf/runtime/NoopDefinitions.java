...
/**
 * Generated class for BPF runtime types that start with noop
 */
...
public final class NoopDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<sk_buff> noop_dequeue(Ptr<Qdisc> qdisc) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long noop_direct_IO(Ptr<kiocb> iocb, Ptr<iov_iter> iter) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static boolean noop_dirty_folio(Ptr<address_space> mapping, Ptr<folio> folio) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int noop_enqueue(Ptr<sk_buff> skb, Ptr<Qdisc> qdisc, Ptr<Ptr<sk_buff>> to_free) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int noop_fsync(Ptr<file> file, @OriginalName("loff_t") long start,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("loff_t") long noop_llseek(Ptr<file> file,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @Unsigned int noop_ret(Ptr<irq_data> data) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void noop_send_IPI(int cpu, int vector) {
    throw new MethodIsBPFRelatedFunction();
  }

...
/**
 * Generated class for BPF runtime types that start with fpu
 */
...
public final class FpuDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int fpu_clone(Ptr<task_struct> dst, @Unsigned long clone_flags, boolean minimal,
      @Unsigned long ssp) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void fpu_copy_guest_fpstate_to_uabi(Ptr<fpu_guest> gfpu, Ptr<?> buf,
      @Unsigned int size, @Unsigned long xfeatures, @Unsigned int pkru) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int fpu_enable_guest_xfd_features(Ptr<fpu_guest> guest_fpu,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void fpu_reset_fpstate_regs() {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void fpu_sync_fpstate(Ptr<fpu> fpu) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void fpu_thread_struct_whitelist(Ptr<java.lang. @Unsigned Long> offset,
  ...
  @Type(
      ...
      cType = "struct fpu_guest"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class fpu_guest extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct { u8 x[512]; }"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class fpu_ctxt_of_vcpu_guest_context extends Struct {
    public char @Size(512) [] x;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct fpu_state_perm"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class fpu_state_perm extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct fpu_state_config"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class fpu_state_config extends Struct {

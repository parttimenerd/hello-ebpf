...
/**
 * Generated class for BPF runtime types that start with led
 */
...
public final class LedDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void led_blink_set(Ptr<led_classdev> led_cdev,
      Ptr<java.lang. @Unsigned Long> delay_on, Ptr<java.lang. @Unsigned Long> delay_off) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void led_blink_set_nosleep(Ptr<led_classdev> led_cdev, @Unsigned long delay_on,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void led_blink_set_oneshot(Ptr<led_classdev> led_cdev,
      Ptr<java.lang. @Unsigned Long> delay_on, Ptr<java.lang. @Unsigned Long> delay_off,
      int invert) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void led_blink_setup(Ptr<led_classdev> led_cdev,
      Ptr<java.lang. @Unsigned Long> delay_on, Ptr<java.lang. @Unsigned Long> delay_off) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void led_classdev_notify_brightness_hw_changed(Ptr<led_classdev> led_cdev,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int led_classdev_register_ext(Ptr<device> parent, Ptr<led_classdev> led_cdev,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int led_compose_name(Ptr<device> dev, Ptr<led_init_data> init_data,
      String led_classdev_name) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<led_classdev> led_get(Ptr<device> dev, String con_id) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction("((const u8*)led_get_color_name($arg1))")
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<java.lang. @Unsigned Integer> led_get_default_pattern(
      Ptr<led_classdev> led_cdev, Ptr<java.lang. @Unsigned Integer> size) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static led_default_state led_init_default_state_get(Ptr<fwnode_handle> fwnode) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void led_mc_set_brightness(Ptr<led_classdev> led_cdev,
      Ptr<java.lang. @Unsigned Integer> intensity_value, @Unsigned int num_colors,
      @Unsigned int brightness) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void led_mc_trigger_event(Ptr<led_trigger> trig,
      Ptr<java.lang. @Unsigned Integer> intensity_value, @Unsigned int num_colors,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static long led_panic_blink(int state) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void led_parse_fwnode_props(Ptr<device> dev, Ptr<fwnode_handle> fwnode,
      Ptr<led_properties> props) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int led_resume(Ptr<device> dev) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int led_suspend(Ptr<device> dev) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void led_timer_function(Ptr<timer_list> t) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void led_trigger_blink(Ptr<led_trigger> trig, @Unsigned long delay_on,
      @Unsigned long delay_off) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void led_trigger_blink_oneshot(Ptr<led_trigger> trig, @Unsigned long delay_on,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int led_trigger_format(String buf, @Unsigned long size,
      Ptr<led_classdev> led_cdev) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int led_trigger_panic_notifier(Ptr<notifier_block> nb, @Unsigned long code,
      Ptr<?> unused) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void led_work(Ptr<work_struct> work) {
    throw new MethodIsBPFRelatedFunction();
  }

  @Type(
      noCCodeGeneration = true,
      cType = "enum led_brightness"
  )
  public enum led_brightness implements Enum<led_brightness>, TypedEnum<led_brightness, java.lang. @Unsigned Integer> {
    /**
     * {@code LED_OFF = 0}
     */
    @EnumMember(
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "enum led_default_state"
  )
  public enum led_default_state implements Enum<led_default_state>, TypedEnum<led_default_state, java.lang. @Unsigned Integer> {
    /**
     * {@code LEDS_DEFSTATE_OFF = 0}
     */
    @EnumMember(
        value = 0L,
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct led_init_data"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class led_init_data extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct led_hw_trigger_type"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class led_hw_trigger_type extends Struct {
    public int dummy;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct led_classdev"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class led_classdev extends Struct {
    public String name;
    ...
    public work_struct set_brightness_work;
    ...
    public rw_semaphore trigger_lock;

    public Ptr<led_trigger> trigger;

    public list_head trig_list;
    ...
    public Ptr<kernfs_node> brightness_hw_changed_kn;

    public mutex led_access;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct led_pattern"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class led_pattern extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct led_trigger"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class led_trigger extends Struct {
    public String name;
    ...
    public @OriginalName("spinlock_t") spinlock leddev_list_lock;

    public list_head led_cdevs;

    public list_head next_trig;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct led_properties"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class led_properties extends Struct {
    public @Unsigned int color;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct led_classdev_mc"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class led_classdev_mc extends Struct {
    public led_classdev led_cdev;

    public @Unsigned int num_colors;

    public Ptr<mc_subled> subled_info;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct led_lookup_data"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class led_lookup_data extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct led_trigger_cpu"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class led_trigger_cpu extends Struct {

...
/**
 * Generated class for BPF runtime types that start with wiphy
 */
@java.lang.SuppressWarnings("unused")
public final class WiphyDefinitions {
  @Type(
      noCCodeGeneration = true,
      cType = "enum wiphy_flags"
  )
  public enum wiphy_flags implements Enum<wiphy_flags>, TypedEnum<wiphy_flags, java.lang. @Unsigned Integer> {
    /**
  ...
  public static class wiphy_wowlan_tcp_support extends Struct {
    public Ptr<nl80211_wowlan_tcp_data_token_feature> tok;
  ...
  public static class wiphy_wowlan_support extends Struct {
    ...
    public Ptr<wiphy_wowlan_tcp_support> tcp;
  }
  ...
  public static class wiphy_iftype_ext_capab extends Struct {
    ...
    public Ptr<java.lang.Character> extended_capabilities;

    public Ptr<java.lang.Character> extended_capabilities_mask;

    public char extended_capabilities_len;
  ...
  public static class wiphy_iftype_akm_suites extends Struct {
    ...
    public Ptr<java.lang. @Unsigned Integer> akm_suites;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct wiphy_radio_cfg"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class wiphy_radio_cfg extends Struct {
    public @Unsigned int rts_threshold;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct wiphy_radio_freq_range"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class wiphy_radio_freq_range extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct wiphy_radio"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class wiphy_radio extends Struct {
    public Ptr<wiphy_radio_freq_range> freq_range;

    public int n_freq_range;

    public Ptr<ieee80211_iface_combination> iface_combinations;

    public int n_iface_combinations;

    public @Unsigned int antenna_mask;
  }

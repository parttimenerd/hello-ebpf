...
/**
 * Generated class for BPF runtime types that start with closure
 */
...
public final class ClosureDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void closure_put_after_sub(Ptr<closure> cl, int flags) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void closure_sync_fn(Ptr<work_struct> ws) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  public enum closure_state implements Enum<closure_state>, TypedEnum<closure_state, java.lang. @Unsigned Integer> {
    /**

...
/**
 * Generated class for BPF runtime types that start with cpufreq
 */
@java.lang.SuppressWarnings("unused")
public final class CpufreqDefinitions {
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int __cpufreq_driver_target(Ptr<cpufreq_policy> policy, @Unsigned int target_freq,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void __cpufreq_offline(@Unsigned int cpu, Ptr<cpufreq_policy> policy) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int cpufreq_add_dev(Ptr<device> dev, Ptr<subsys_interface> sif) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int cpufreq_add_dev_interface(Ptr<cpufreq_policy> policy) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction("cpufreq_add_update_util_hook($arg1, $arg2, (void (*)(struct update_util_data*, long long unsigned int, unsigned int))$arg3)")
  public static void cpufreq_add_update_util_hook(int cpu, Ptr<update_util_data> data,
      Ptr<?> func) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int cpufreq_boost_set_sw(Ptr<cpufreq_policy> policy, int state) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<cpufreq_policy> cpufreq_cpu_get(@Unsigned int cpu) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<cpufreq_policy> cpufreq_cpu_get_raw(@Unsigned int cpu) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void cpufreq_dbs_data_release(Ptr<kobject> kobj) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void cpufreq_driver_adjust_perf(@Unsigned int cpu, @Unsigned long min_perf,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @Unsigned int cpufreq_driver_fast_switch(Ptr<cpufreq_policy> policy,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @Unsigned int cpufreq_driver_resolve_freq(Ptr<cpufreq_policy> policy,
      @Unsigned int target_freq) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int cpufreq_driver_target(Ptr<cpufreq_policy> policy, @Unsigned int target_freq,
      @Unsigned int relation) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void cpufreq_freq_transition_begin(Ptr<cpufreq_policy> policy,
      Ptr<cpufreq_freqs> freqs) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void cpufreq_freq_transition_end(Ptr<cpufreq_policy> policy,
      Ptr<cpufreq_freqs> freqs, int transition_failed) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int cpufreq_frequency_table_cpuinfo(Ptr<cpufreq_policy> policy,
      Ptr<cpufreq_frequency_table> table) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int cpufreq_frequency_table_get_index(Ptr<cpufreq_policy> policy,
      @Unsigned int freq) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int cpufreq_frequency_table_target(Ptr<cpufreq_policy> policy,
      @Unsigned int target_freq, @Unsigned int min, @Unsigned int max, @Unsigned int relation) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int cpufreq_frequency_table_verify(Ptr<cpufreq_policy_data> policy,
      Ptr<cpufreq_frequency_table> table) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @Unsigned int cpufreq_generic_get(@Unsigned int cpu) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void cpufreq_generic_init(Ptr<cpufreq_policy> policy,
      Ptr<cpufreq_frequency_table> table, @Unsigned int transition_latency) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @Unsigned int cpufreq_get(@Unsigned int cpu) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction("((const u8*)cpufreq_get_current_driver())")
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @Unsigned int cpufreq_get_hw_max_freq(@Unsigned int cpu) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int cpufreq_notifier_max(Ptr<notifier_block> nb, @Unsigned long freq, Ptr<?> data) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int cpufreq_notifier_min(Ptr<notifier_block> nb, @Unsigned long freq, Ptr<?> data) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void cpufreq_notify_transition(Ptr<cpufreq_policy> policy, Ptr<cpufreq_freqs> freqs,
      @Unsigned int state) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int cpufreq_online(@Unsigned int cpu) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int cpufreq_passive_notifier_call(Ptr<notifier_block> nb, @Unsigned long event,
      Ptr<?> ptr) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int cpufreq_passive_register_notifier(Ptr<devfreq> devfreq) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<cpufreq_policy> cpufreq_policy_alloc(@Unsigned int cpu) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int cpufreq_policy_online(Ptr<cpufreq_policy> policy, @Unsigned int cpu,
      boolean new_policy) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void cpufreq_policy_refresh(Ptr<cpufreq_policy> policy) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @Unsigned int cpufreq_quick_get(@Unsigned int cpu) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static @Unsigned int cpufreq_quick_get_max(@Unsigned int cpu) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int cpufreq_register_notifier(Ptr<notifier_block> nb, @Unsigned int list) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void cpufreq_remove_dev(Ptr<device> dev, Ptr<subsys_interface> sif) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void cpufreq_remove_update_util_hook(int cpu) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int cpufreq_set_cur_state(@Unsigned int cpu, int state) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int cpufreq_set_policy(Ptr<cpufreq_policy> policy, Ptr<cpufreq_governor> new_gov,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void cpufreq_stats_record_transition(Ptr<cpufreq_policy> policy,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void cpufreq_sysfs_release(Ptr<kobject> kobj) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int cpufreq_table_index_unsorted(Ptr<cpufreq_policy> policy,
      @Unsigned int target_freq, @Unsigned int min, @Unsigned int max, @Unsigned int relation) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int cpufreq_unregister_notifier(Ptr<notifier_block> nb, @Unsigned int list) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void cpufreq_update_limits(@Unsigned int cpu) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void cpufreq_update_policy(@Unsigned int cpu) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @Unsigned int cpufreq_verify_current_freq(Ptr<cpufreq_policy> policy,
      boolean update) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @Type(
      ...
      cType = "enum cpufreq_table_sorting"
  )
  public enum cpufreq_table_sorting implements Enum<cpufreq_table_sorting>, TypedEnum<cpufreq_table_sorting, java.lang. @Unsigned Integer> {
    /**
     * {@code CPUFREQ_TABLE_UNSORTED = 0}
     */
    @EnumMember(
        value = 0L,
    ...
    /**
     * {@code CPUFREQ_TABLE_SORTED_ASCENDING = 1}
     */
    @EnumMember(
        value = 1L,
    ...
    /**
     * {@code CPUFREQ_TABLE_SORTED_DESCENDING = 2}
     */
    @EnumMember(
        value = 2L,
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct cpufreq_cpuinfo"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class cpufreq_cpuinfo extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct cpufreq_policy"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class cpufreq_policy extends Struct {
    public @OriginalName("cpumask_var_t") Ptr<cpumask> cpus;

    public @OriginalName("cpumask_var_t") Ptr<cpumask> related_cpus;

    public @OriginalName("cpumask_var_t") Ptr<cpumask> real_cpus;
    ...
    public char @Size(16) [] last_governor;

    public work_struct update;

    public freq_constraints constraints;

    public Ptr<freq_qos_request> min_freq_req;

    public Ptr<freq_qos_request> max_freq_req;
    ...
    public completion kobj_unregister;
    ...
    public @OriginalName("spinlock_t") spinlock transition_lock;

    public @OriginalName("wait_queue_head_t") wait_queue_head transition_wait;

    public Ptr<task_struct> transition_task;
    ...
    public notifier_block nb_min;

    public notifier_block nb_max;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct cpufreq_governor"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class cpufreq_governor extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct cpufreq_frequency_table"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class cpufreq_frequency_table extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct cpufreq_freqs"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class cpufreq_freqs extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct cpufreq_policy_data"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class cpufreq_policy_data extends Struct {
    public cpufreq_cpuinfo cpuinfo;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct cpufreq_driver"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class cpufreq_driver extends Struct {
    public char @Size(16) [] name;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct cpufreq_stats"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class cpufreq_stats extends Struct {

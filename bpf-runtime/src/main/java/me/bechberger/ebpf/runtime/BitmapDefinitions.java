...
/**
 * Generated class for BPF runtime types that start with bitmap
 */
...
public final class BitmapDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void __bitmap_clear(Ptr<java.lang. @Unsigned Long> map, @Unsigned int start,
      int len) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<bitmap> __bitmap_create(Ptr<mddev> mddev, int slot) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void __bitmap_end_sync(Ptr<bitmap> bitmap,
      @Unsigned @OriginalName("sector_t") long offset,
      Ptr<java.lang. @Unsigned @OriginalName("sector_t") Long> blocks, boolean aborted) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int __bitmap_resize(Ptr<bitmap> bitmap,
      @Unsigned @OriginalName("sector_t") long blocks, int chunksize, boolean init) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void __bitmap_set(Ptr<java.lang. @Unsigned Long> map, @Unsigned int start,
      int len) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void __bitmap_unplug(Ptr<bitmap> bitmap) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<java.lang. @Unsigned Long> bitmap_alloc(@Unsigned int nbits,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<java.lang. @Unsigned Long> bitmap_alloc_node(@Unsigned int nbits,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @Unsigned long bitmap_clear_ll(Ptr<java.lang. @Unsigned Long> map,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void bitmap_close_sync(Ptr<mddev> mddev) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void bitmap_cond_end_sync(Ptr<mddev> mddev,
      @Unsigned @OriginalName("sector_t") long sector, boolean force) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int bitmap_copy_from_slot(Ptr<mddev> mddev, int slot,
      Ptr<java.lang. @Unsigned @OriginalName("sector_t") Long> low,
      Ptr<java.lang. @Unsigned @OriginalName("sector_t") Long> high, boolean clear_bits) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int bitmap_create(Ptr<mddev> mddev) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void bitmap_daemon_work(Ptr<mddev> mddev) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void bitmap_destroy(Ptr<mddev> mddev) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void bitmap_dirty_bits(Ptr<mddev> mddev, @Unsigned long s, @Unsigned long e) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static boolean bitmap_enabled(Ptr<mddev> mddev) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void bitmap_end_behind_write(Ptr<mddev> mddev) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void bitmap_end_sync(Ptr<mddev> mddev,
      @Unsigned @OriginalName("sector_t") long offset,
      Ptr<java.lang. @Unsigned @OriginalName("sector_t") Long> blocks) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void bitmap_end_write(Ptr<mddev> mddev,
      @Unsigned @OriginalName("sector_t") long offset, @Unsigned long sectors) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static @Unsigned long bitmap_find_next_zero_area_off(Ptr<java.lang. @Unsigned Long> map,
      @Unsigned long size, @Unsigned long start, @Unsigned int nr, @Unsigned long align_mask,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void bitmap_flush(Ptr<mddev> mddev) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<?> bitmap_get_from_slot(Ptr<mddev> mddev, int slot) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int bitmap_get_stats(Ptr<?> data, Ptr<md_bitmap_stats> stats) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int bitmap_load(Ptr<mddev> mddev) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void bitmap_print_sb(Ptr<bitmap> bitmap) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int bitmap_resize(Ptr<mddev> mddev, @Unsigned @OriginalName("sector_t") long blocks,
      int chunksize, boolean init) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void bitmap_start_behind_write(Ptr<mddev> mddev) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static boolean bitmap_start_sync(Ptr<mddev> mddev,
      @Unsigned @OriginalName("sector_t") long offset,
      Ptr<java.lang. @Unsigned @OriginalName("sector_t") Long> blocks, boolean degraded) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void bitmap_start_write(Ptr<mddev> mddev,
      @Unsigned @OriginalName("sector_t") long offset, @Unsigned long sectors) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void bitmap_sync_with_cluster(Ptr<mddev> mddev,
      @Unsigned @OriginalName("sector_t") long old_lo,
      @Unsigned @OriginalName("sector_t") long old_hi,
      @Unsigned @OriginalName("sector_t") long new_lo,
      @Unsigned @OriginalName("sector_t") long new_hi) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void bitmap_unplug(Ptr<mddev> mddev, boolean sync) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void bitmap_wait_behind_writes(Ptr<mddev> mddev) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void bitmap_write_all(Ptr<mddev> mddev) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<java.lang. @Unsigned Long> bitmap_zalloc(@Unsigned int nbits,
      @Unsigned @OriginalName("gfp_t") int flags) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<java.lang. @Unsigned Long> bitmap_zalloc_node(@Unsigned int nbits,
      @Unsigned @OriginalName("gfp_t") int flags, int node) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @Type(
      ...
      cType = "union { long long unsigned int phys; struct kho_mem_phys_bits *ptr; }"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class bitmap_of_khoser_mem_bitmap_ptr extends Union {
    public @Unsigned @OriginalName("phys_addr_t") long phys;

    public Ptr<kho_mem_phys_bits> ptr;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct { struct file *file; long long int offset; long unsigned int space; long long int default_offset; long unsigned int default_space; struct mutex mutex; long unsigned int chunksize; long unsigned int daemon_sleep; long unsigned int max_write_behind; int external; int nodes; u8 cluster_name[64]; }"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class bitmap_info_of_mddev extends Struct {
    ...
    public @OriginalName("loff_t") long default_offset;
    ...
    public char @Size(64) [] cluster_name;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct bitmap_operations"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class bitmap_operations extends Struct {
    public Ptr<?> enabled;
    ...
    public Ptr<?> start_behind_write;

    public Ptr<?> end_behind_write;

    public Ptr<?> wait_behind_writes;

    public Ptr<?> start_write;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "enum bitmap_state"
  )
  public enum bitmap_state implements Enum<bitmap_state>, TypedEnum<bitmap_state, java.lang. @Unsigned Integer> {
    /**
     * {@code BITMAP_STALE = 1}
     */
    @EnumMember(
    ...
    /**
     * {@code BITMAP_WRITE_ERROR = 2}
     */
    @EnumMember(
        value = 2L,
        name = "BITMAP_WRITE_ERROR"
    )
    BITMAP_WRITE_ERROR,

    /**
     * {@code BITMAP_HOSTENDIAN = 15}
     */
    @EnumMember(
        value = 15L,
        name = "BITMAP_HOSTENDIAN"
    )
    BITMAP_HOSTENDIAN
  }
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct bitmap_super_s"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class bitmap_super_s extends Struct {
    public @Unsigned @OriginalName("__le32") int magic;

    public @Unsigned @OriginalName("__le32") int version;

    public char @Size(16) [] uuid;

    public @Unsigned @OriginalName("__le64") long events;

    public @Unsigned @OriginalName("__le64") long events_cleared;

    public @Unsigned @OriginalName("__le64") long sync_size;

    public @Unsigned @OriginalName("__le32") int state;

    public @Unsigned @OriginalName("__le32") int chunksize;

    public @Unsigned @OriginalName("__le32") int daemon_sleep;

    public @Unsigned @OriginalName("__le32") int write_behind;

    public @Unsigned @OriginalName("__le32") int sectors_reserved;

    public @Unsigned @OriginalName("__le32") int nodes;

    public char @Size(64) [] cluster_name;

    public char @Size(120) [] pad;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct bitmap_page"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class bitmap_page extends Struct {
    public String map;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct bitmap_counts"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class bitmap_counts extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct bitmap_storage"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class bitmap_storage extends Struct {
    public Ptr<file> file;
    ...
    public Ptr<Ptr<page>> filemap;

    public Ptr<java.lang. @Unsigned Long> filemap_attr;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "enum bitmap_page_attr"
  )
  public enum bitmap_page_attr implements Enum<bitmap_page_attr>, TypedEnum<bitmap_page_attr, java.lang. @Unsigned Integer> {
    /**
     * {@code BITMAP_PAGE_DIRTY = 0}
     */
    @EnumMember(
        value = 0L,
        name = "BITMAP_PAGE_DIRTY"
    )
    BITMAP_PAGE_DIRTY,

    /**
     * {@code BITMAP_PAGE_PENDING = 1}
     */
    @EnumMember(
        value = 1L,
        name = "BITMAP_PAGE_PENDING"
    )
    BITMAP_PAGE_PENDING,

    /**
     * {@code BITMAP_PAGE_NEEDWRITE = 2}
     */
    @EnumMember(
        value = 2L,
        name = "BITMAP_PAGE_NEEDWRITE"
    )
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct bitmap_unplug_work"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class bitmap_unplug_work extends Struct {
    public work_struct work;

    public Ptr<bitmap> bitmap;

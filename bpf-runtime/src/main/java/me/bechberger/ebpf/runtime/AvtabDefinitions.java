...
/**
 * Generated class for BPF runtime types that start with avtab
 */
@java.lang.SuppressWarnings("unused")
public final class AvtabDefinitions {
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int avtab_alloc(Ptr<avtab> h, @Unsigned int nrules) {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void avtab_destroy(Ptr<avtab> h) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void avtab_init(Ptr<avtab> h) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int avtab_read(Ptr<avtab> a, Ptr<policy_file> fp, Ptr<policydb> pol) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction("avtab_read_item($arg1, $arg2, $arg3, (int (*)(struct avtab*, const struct avtab_key*, const struct avtab_datum*, void*))$arg4, $arg5, $arg6)")
  public static int avtab_read_item(Ptr<avtab> a, Ptr<policy_file> fp, Ptr<policydb> pol,
      Ptr<?> insertf, Ptr<?> p, boolean conditional) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<avtab_node> avtab_search_node_next(Ptr<avtab_node> node,
      @Unsigned short specified) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int avtab_write(Ptr<policydb> p, Ptr<avtab> a, Ptr<policy_file> fp) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @Type(
      ...
      cType = "struct avtab_key"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class avtab_key extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct avtab_extended_perms"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class avtab_extended_perms extends Struct {
    public char specified;

    public char driver;

    public extended_perms_data perms;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct avtab_datum"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class avtab_datum extends Struct {
    public u_of_avtab_datum u;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct avtab_node"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class avtab_node extends Struct {

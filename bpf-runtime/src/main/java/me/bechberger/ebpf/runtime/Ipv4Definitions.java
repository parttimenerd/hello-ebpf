...
/**
 * Generated class for BPF runtime types that start with ipv4
 */
@java.lang.SuppressWarnings("unused")
public final class Ipv4Definitions {
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void __ipv4_sk_update_pmtu(Ptr<sk_buff> skb, Ptr<sock> sk, @Unsigned int mtu) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<dst_entry> ipv4_blackhole_route(Ptr<net> net, Ptr<dst_entry> dst_orig) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<java.lang. @Unsigned Integer> ipv4_cow_metrics(Ptr<dst_entry> dst,
      @Unsigned long old) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<dst_entry> ipv4_dst_check(Ptr<dst_entry> dst, @Unsigned int cookie) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void ipv4_dst_destroy(Ptr<dst_entry> dst) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void ipv4_frags_exit_net(Ptr<net> net) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int ipv4_frags_init_net(Ptr<net> net) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void ipv4_frags_pre_exit_net(Ptr<net> net) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void ipv4_inetpeer_exit(Ptr<net> net) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int ipv4_inetpeer_init(Ptr<net> net) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void ipv4_link_failure(Ptr<sk_buff> skb) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void ipv4_mib_exit_net(Ptr<net> net) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int ipv4_mib_init_net(Ptr<net> net) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void ipv4_negative_advice(Ptr<sock> sk, Ptr<dst_entry> dst) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void ipv4_redirect(Ptr<sk_buff> skb, Ptr<net> net, int oif, char protocol) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void ipv4_send_dest_unreach(Ptr<sk_buff> skb) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void ipv4_sk_redirect(Ptr<sk_buff> skb, Ptr<sock> sk) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void ipv4_sk_update_pmtu(Ptr<sk_buff> skb, Ptr<sock> sk, @Unsigned int mtu) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int ipv4_skb_to_auditdata(Ptr<sk_buff> skb, Ptr<common_audit_data> ad,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void ipv4_sysctl_exit_net(Ptr<net> net) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int ipv4_sysctl_init_net(Ptr<net> net) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void ipv4_update_pmtu(Ptr<sk_buff> skb, Ptr<net> net, @Unsigned int mtu, int oif,
      char protocol) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @Type(
      ...
      cType = "struct { unsigned int src; unsigned int dst; }"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class ipv4_of_u_of_ip_tunnel_key extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct ipv4_devconf"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class ipv4_devconf extends Struct {
    public Ptr<?> sysctl;

    public int @Size(33) [] data;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct { unsigned int saddr; unsigned int daddr; short unsigned int sport; short unsigned int dport; }"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class ipv4_of_anon_member_of_bpf_sock_tuple extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct ipv4_addr_key"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class ipv4_addr_key extends Struct {

...
/**
 * Generated class for BPF runtime types that start with cookie
 */
...
public final class CookieDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<request_sock> cookie_bpf_check(Ptr<sock> sk, Ptr<sk_buff> skb) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static @Unsigned long cookie_init_timestamp(Ptr<request_sock> req, @Unsigned long now) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int cookie_tcp_reqsk_init(Ptr<sock> sk, Ptr<sk_buff> skb, Ptr<request_sock> req) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<sock> cookie_v4_check(Ptr<sock> sk, Ptr<sk_buff> skb) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<sock> cookie_v6_check(Ptr<sock> sk, Ptr<sk_buff> skb) {
    throw new MethodIsBPFRelatedFunction();
  }

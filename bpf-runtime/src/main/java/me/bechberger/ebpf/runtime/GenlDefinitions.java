...
/**
 * Generated class for BPF runtime types that start with genl
 */
@java.lang.SuppressWarnings("unused")
public final class GenlDefinitions {
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<?> __genl_sk_priv_get(Ptr<genl_family> family, Ptr<sock> sk) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int genl_allocate_reserve_groups(int n_groups, Ptr<java.lang.Integer> first_id) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int genl_bind(Ptr<net> net, int group) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int genl_done(Ptr<netlink_callback> cb) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int genl_dumpit(Ptr<sk_buff> skb, Ptr<netlink_callback> cb) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void genl_op_from_split(Ptr<genl_op_iter> iter) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static boolean genl_op_iter_next(Ptr<genl_op_iter> iter) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void genl_pernet_exit(Ptr<net> net) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int genl_pernet_init(Ptr<net> net) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void genl_rcv(Ptr<sk_buff> skb) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int genl_rcv_msg(Ptr<sk_buff> skb, Ptr<nlmsghdr> nlh, Ptr<netlink_ext_ack> extack) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void genl_release(Ptr<sock> sk, Ptr<java.lang. @Unsigned Long> groups) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<?> genl_sk_priv_get(Ptr<genl_family> family, Ptr<sock> sk) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int genl_start(Ptr<netlink_callback> cb) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void genl_unbind(Ptr<net> net, int group) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @Type(
      ...
      cType = "struct genl_multicast_group"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class genl_multicast_group extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct genl_family"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class genl_family extends Struct {
    ...
    public Ptr<xarray> sock_privs;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct genl_split_ops"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class genl_split_ops extends Struct {
    @InlineUnion(14952)
    public anon_member_of_anon_member_of_genl_split_ops anon0$0;

    @InlineUnion(14952)
    public anon_member_of_anon_member_of_genl_split_ops anon0$1;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct genl_info"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class genl_info extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct genl_ops"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class genl_ops extends Struct {
    public Ptr<?> doit;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct genl_small_ops"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class genl_small_ops extends Struct {
    public Ptr<?> doit;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "enum genl_validate_flags"
  )
  public enum genl_validate_flags implements Enum<genl_validate_flags>, TypedEnum<genl_validate_flags, java.lang. @Unsigned Integer> {
    /**
     * {@code GENL_DONT_VALIDATE_STRICT = 1}
     */
    @EnumMember(
        value = 1L,
        name = "GENL_DONT_VALIDATE_STRICT"
    )
    GENL_DONT_VALIDATE_STRICT,

    /**
     * {@code GENL_DONT_VALIDATE_DUMP = 2}
     */
    @EnumMember(
        value = 2L,
        name = "GENL_DONT_VALIDATE_DUMP"
    )
    GENL_DONT_VALIDATE_DUMP,

    /**
     * {@code GENL_DONT_VALIDATE_DUMP_STRICT = 4}
     */
    @EnumMember(
        value = 4L,
        name = "GENL_DONT_VALIDATE_DUMP_STRICT"
    )
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct genl_dumpit_info"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class genl_dumpit_info extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct genl_op_iter"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class genl_op_iter extends Struct {
    public Ptr<genl_family> family;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct genl_start_context"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class genl_start_context extends Struct {
    public Ptr<genl_family> family;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct genlmsghdr"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class genlmsghdr extends Struct {
    public char cmd;

...
/**
 * Generated class for BPF runtime types that start with profile
 */
@java.lang.SuppressWarnings("unused")
public final class ProfileDefinitions {
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int profile_capable(Ptr<aa_profile> profile, int cap, @Unsigned int opts,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int profile_cmp(Ptr<aa_profile> a, Ptr<aa_profile> b) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int profile_graph_entry(Ptr<ftrace_graph_ent> trace, Ptr<fgraph_ops> gops,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void profile_graph_return(Ptr<ftrace_graph_ret> trace, Ptr<fgraph_ops> gops,
      Ptr<ftrace_regs> fregs) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void profile_hits(int type, Ptr<?> __pc, @Unsigned int nr_hits) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int profile_open(Ptr<inode> inode, Ptr<file> file) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @Unsigned long profile_pc(Ptr<pt_regs> regs) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int profile_remote_perm(Ptr<aa_profile> profile, Ptr<sock> sk,
      @Unsigned int request, Ptr<match_addr> raddr, Ptr<match_addr> laddr,
      Ptr<apparmor_audit_data> ad) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void profile_tick(int type) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @Type(
      ...
      cType = "struct profile_fgraph_data"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class profile_fgraph_data extends Struct {
    public @Unsigned long calltime;

    public @Unsigned long subtime;

    public @Unsigned long sleeptime;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "enum profile_mode"
  )
  public enum profile_mode implements Enum<profile_mode>, TypedEnum<profile_mode, java.lang. @Unsigned Integer> {
    /**
     * {@code APPARMOR_ENFORCE = 0}
     */
    @EnumMember(
        value = 0L,
        name = "APPARMOR_ENFORCE"
    )
    APPARMOR_ENFORCE,

    /**
     * {@code APPARMOR_COMPLAIN = 1}
     */
    @EnumMember(
        value = 1L,
        name = "APPARMOR_COMPLAIN"
    )
    APPARMOR_COMPLAIN,

    /**
     * {@code APPARMOR_KILL = 2}
     */
    @EnumMember(
        value = 2L,
        name = "APPARMOR_KILL"

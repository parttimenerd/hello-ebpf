...
/**
 * Generated class for BPF runtime types that start with gpiod
 */
...
public final class GpiodDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void gpiod_add_lookup_tables(Ptr<Ptr<gpiod_lookup_table>> tables,
      @Unsigned long n) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int gpiod_direction_input(Ptr<gpio_desc> desc) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int gpiod_direction_input_nonotify(Ptr<gpio_desc> desc) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int gpiod_direction_output(Ptr<gpio_desc> desc, int value) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int gpiod_direction_output_nonotify(Ptr<gpio_desc> desc, int value) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int gpiod_direction_output_raw(Ptr<gpio_desc> desc, int value) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int gpiod_direction_output_raw_commit(Ptr<gpio_desc> desc, int value) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int gpiod_disable_hw_timestamp_ns(Ptr<gpio_desc> desc, @Unsigned long flags) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int gpiod_enable_hw_timestamp_ns(Ptr<gpio_desc> desc, @Unsigned long flags) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int gpiod_export(Ptr<gpio_desc> desc, boolean direction_may_change) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<gpiod_lookup_table> gpiod_find_lookup_table(Ptr<device> dev) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void gpiod_free(Ptr<gpio_desc> desc) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void gpiod_free_commit(Ptr<gpio_desc> desc) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int gpiod_get_array_value(@Unsigned int array_size, Ptr<Ptr<gpio_desc>> desc_array,
      Ptr<gpio_array> array_info, Ptr<java.lang. @Unsigned Long> value_bitmap) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int gpiod_get_array_value_cansleep(@Unsigned int array_size,
      Ptr<Ptr<gpio_desc>> desc_array, Ptr<gpio_array> array_info,
      Ptr<java.lang. @Unsigned Long> value_bitmap) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int gpiod_get_array_value_complex(boolean raw, boolean can_sleep,
      @Unsigned int array_size, Ptr<Ptr<gpio_desc>> desc_array, Ptr<gpio_array> array_info,
      Ptr<java.lang. @Unsigned Long> value_bitmap) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int gpiod_get_direction(Ptr<gpio_desc> desc) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction("((const u8*)gpiod_get_label($arg1))")
  public static String gpiod_get_label(Ptr<gpio_desc> desc) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int gpiod_get_raw_array_value(@Unsigned int array_size,
      Ptr<Ptr<gpio_desc>> desc_array, Ptr<gpio_array> array_info,
      Ptr<java.lang. @Unsigned Long> value_bitmap) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int gpiod_get_raw_array_value_cansleep(@Unsigned int array_size,
      Ptr<Ptr<gpio_desc>> desc_array, Ptr<gpio_array> array_info,
      Ptr<java.lang. @Unsigned Long> value_bitmap) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void gpiod_line_state_notify(Ptr<gpio_desc> desc, @Unsigned long action) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void gpiod_put(Ptr<gpio_desc> desc) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void gpiod_put_array(Ptr<gpio_descs> descs) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int gpiod_set_array_value(@Unsigned int array_size, Ptr<Ptr<gpio_desc>> desc_array,
      Ptr<gpio_array> array_info, Ptr<java.lang. @Unsigned Long> value_bitmap) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int gpiod_set_array_value_cansleep(@Unsigned int array_size,
      Ptr<Ptr<gpio_desc>> desc_array, Ptr<gpio_array> array_info,
      Ptr<java.lang. @Unsigned Long> value_bitmap) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int gpiod_set_array_value_complex(boolean raw, boolean can_sleep,
      @Unsigned int array_size, Ptr<Ptr<gpio_desc>> desc_array, Ptr<gpio_array> array_info,
      Ptr<java.lang. @Unsigned Long> value_bitmap) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int gpiod_set_config(Ptr<gpio_desc> desc, @Unsigned long config) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int gpiod_set_debounce(Ptr<gpio_desc> desc, @Unsigned int debounce) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int gpiod_set_raw_array_value(@Unsigned int array_size,
      Ptr<Ptr<gpio_desc>> desc_array, Ptr<gpio_array> array_info,
      Ptr<java.lang. @Unsigned Long> value_bitmap) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int gpiod_set_raw_array_value_cansleep(@Unsigned int array_size,
      Ptr<Ptr<gpio_desc>> desc_array, Ptr<gpio_array> array_info,
      Ptr<java.lang. @Unsigned Long> value_bitmap) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int gpiod_set_raw_value(Ptr<gpio_desc> desc, int value) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int gpiod_set_raw_value_cansleep(Ptr<gpio_desc> desc, int value) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int gpiod_set_raw_value_commit(Ptr<gpio_desc> desc, boolean value) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int gpiod_set_transitory(Ptr<gpio_desc> desc, boolean transitory) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int gpiod_set_value(Ptr<gpio_desc> desc, int value) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int gpiod_set_value_cansleep(Ptr<gpio_desc> desc, int value) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int gpiod_set_value_nocheck(Ptr<gpio_desc> desc, int value) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<gpio_device> gpiod_to_gpio_device(Ptr<gpio_desc> desc) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void gpiod_toggle_active_low(Ptr<gpio_desc> desc) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void gpiod_unexport(Ptr<gpio_desc> desc) {
    throw new MethodIsBPFRelatedFunction();
  }

  @Type(
      noCCodeGeneration = true,
      cType = "enum gpiod_flags"
  )
  public enum gpiod_flags implements Enum<gpiod_flags>, TypedEnum<gpiod_flags, java.lang. @Unsigned Integer> {
    /**
     * {@code GPIOD_ASIS = 0}
     */
    @EnumMember(
    ...
    /**
     * {@code GPIOD_OUT_LOW_OPEN_DRAIN = 11}
     */
    @EnumMember(
        value = 11L,
    ...
    /**
     * {@code GPIOD_OUT_HIGH_OPEN_DRAIN = 15}
     */
    @EnumMember(
        value = 15L,
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct gpiod_lookup"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class gpiod_lookup extends Struct {
    public String key;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct gpiod_lookup_table"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class gpiod_lookup_table extends Struct {
    public list_head list;

    public String dev_id;

    public gpiod_lookup @Size(0) [] table;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct gpiod_hog"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class gpiod_hog extends Struct {
    public list_head list;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct gpiod_data"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class gpiod_data extends Struct {
    public list_head list;
    ...
    public Ptr<kernfs_node> value_kn;
    ...
    public Ptr<kobject> parent;

    public device_attribute dir_attr;

    public device_attribute val_attr;

    public device_attribute edge_attr;

    public device_attribute active_low_attr;

    public Ptr<attribute> @Size(5) [] class_attrs;

    public attribute_group class_attr_group;

    public Ptr<attribute_group> @Size(2) [] class_attr_groups;

    public Ptr<attribute> @Size(3) [] chip_attrs;

    public attribute_group chip_attr_group;

    public Ptr<attribute_group> @Size(2) [] chip_attr_groups;
  }
}

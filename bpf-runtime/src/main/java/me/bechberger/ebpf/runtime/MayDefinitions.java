...
/**
 * Generated class for BPF runtime types that start with may
 */
...
public final class MayDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int may_delete(Ptr<mnt_idmap> idmap, Ptr<inode> dir, Ptr<dentry> victim,
      boolean isdir) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static boolean may_enter_fs(Ptr<folio> folio,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static boolean may_expand_vm(Ptr<mm_struct> mm,
      @Unsigned @OriginalName("vm_flags_t") long flags, @Unsigned long npages) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int may_link(Ptr<inode> dir, Ptr<dentry> dentry, int kind) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int may_rename(Ptr<inode> old_dir, Ptr<dentry> old_dentry, Ptr<inode> new_dir,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int may_setattr(Ptr<mnt_idmap> idmap, Ptr<inode> inode, @Unsigned int ia_valid) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int may_umount(Ptr<vfsmount> mnt) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int may_umount_tree(Ptr<vfsmount> m) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static boolean may_update_sockmap(Ptr<bpf_verifier_env> env, int func_id) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int may_write_xattr(Ptr<mnt_idmap> idmap, Ptr<inode> inode) {
    throw new MethodIsBPFRelatedFunction();
  }
}

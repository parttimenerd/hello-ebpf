...
/**
 * Generated class for BPF runtime types that start with sha1
 */
@java.lang.SuppressWarnings("unused")
public final class Sha1Definitions {
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void __sha1_final(Ptr<sha1_ctx> ctx, Ptr<java.lang.Character> out) {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void sha1_final(Ptr<sha1_ctx> ctx, Ptr<java.lang.Character> out) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void sha1_init(Ptr<sha1_ctx> ctx) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void sha1_init_raw(Ptr<java.lang. @Unsigned Integer> buf) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void sha1_mod_exit() {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int sha1_mod_init() {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void sha1_ni_transform() {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void sha1_transform_avx() {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void sha1_transform_avx2() {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void sha1_transform_ssse3() {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @Type(
      ...
      cType = "struct sha1_hash"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class sha1_hash extends Struct {
    public char @Size(20) [] hash;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct { u8 unused; u8 type; }"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class sha1_of_xattr_of_anon_member_of_anon_member_of_ima_digest_data_and_xattr_of_ima_digest_data_hdr extends Struct {
    public char unused;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct sha1_block_state"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class sha1_block_state extends Struct {
    public @Unsigned int @Size(5) [] h;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct sha1_ctx"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class sha1_ctx extends Struct {
    public sha1_block_state state;

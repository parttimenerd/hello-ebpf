...
/**
 * Generated class for BPF runtime types that start with dyn
 */
...
public final class DynDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int dyn_event_open(Ptr<inode> inode, Ptr<file> file) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<?> dyn_event_seq_next(Ptr<seq_file> m, Ptr<?> v,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int dyn_event_seq_show(Ptr<seq_file> m, Ptr<?> v) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<?> dyn_event_seq_start(Ptr<seq_file> m,
      Ptr<java.lang. @OriginalName("loff_t") Long> pos) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void dyn_event_seq_stop(Ptr<seq_file> m, Ptr<?> v) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int dyn_events_release_all(Ptr<dyn_event_operations> type) {
    throw new MethodIsBPFRelatedFunction();
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct dyn_arch_ftrace"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class dyn_arch_ftrace extends Struct {
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct dyn_ftrace"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class dyn_ftrace extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct dyn_event_operations"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class dyn_event_operations extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct dyn_event"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class dyn_event extends Struct {
    public list_head list;

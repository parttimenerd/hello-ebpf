...
/**
 * Generated class for BPF runtime types that start with sha512
 */
@java.lang.SuppressWarnings("unused")
public final class Sha512Definitions {
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void __sha512_final(Ptr<__sha512_ctx> ctx, Ptr<java.lang.Character> out,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void sha512_final(Ptr<sha512_ctx> ctx, Ptr<java.lang.Character> out) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void sha512_init(Ptr<sha512_ctx> ctx) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void sha512_mod_exit() {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int sha512_mod_init() {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @Type(
      ...
      cType = "struct sha512_block_state"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class sha512_block_state extends Struct {
    public @Unsigned long @Size(8) [] h;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct __sha512_ctx"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class __sha512_ctx extends Struct {
    public sha512_block_state state;

    public @Unsigned long bytecount_lo;

    public @Unsigned long bytecount_hi;

    public char @Size(128) [] buf;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct sha512_ctx"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class sha512_ctx extends Struct {
    public __sha512_ctx ctx;
  }
}

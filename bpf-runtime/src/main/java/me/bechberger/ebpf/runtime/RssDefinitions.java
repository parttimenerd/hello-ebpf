...
/**
 * Generated class for BPF runtime types that start with rss
 */
@java.lang.SuppressWarnings("unused")
public final class RssDefinitions {
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void __rss_prepare_ctx(Ptr<net_device> dev, Ptr<rss_reply_data> data,
      Ptr<ethtool_rxfh_context> ctx) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void rss_cleanup_data(Ptr<ethnl_reply_data> reply_base) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int rss_dump_one_ctx(Ptr<sk_buff> skb, Ptr<netlink_callback> cb,
      Ptr<net_device> dev, @Unsigned int rss_context) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int rss_get_data_alloc(Ptr<net_device> dev, Ptr<rss_reply_data> data) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int rss_parse_request(Ptr<ethnl_req_info> req_info, Ptr<Ptr<nlattr>> tb,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void rss_set_ctx_update(Ptr<ethtool_rxfh_context> ctx, Ptr<Ptr<nlattr>> tb,
      Ptr<rss_reply_data> data, Ptr<ethtool_rxfh_param> rxfh) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int rss_set_prep_indir(Ptr<net_device> dev, Ptr<genl_info> info,
      Ptr<rss_reply_data> data, Ptr<ethtool_rxfh_param> rxfh,
      Ptr<java.lang. @OriginalName("bool") Boolean> reset,
  ...
  public static class rss_reply_data extends Struct {
    ...
    public boolean has_flow_hash;

    public boolean no_key_fields;
    ...
    public Ptr<java.lang. @Unsigned Integer> indir_table;

    public Ptr<java.lang.Character> hkey;

    public int @Size(28) [] flow_hash;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct rss_nl_dump_ctx"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class rss_nl_dump_ctx extends Struct {
    public @Unsigned long ifindex;

    public @Unsigned long ctx_idx;

    public @Unsigned int match_ifindex;

    public @Unsigned int start_ctx;
  }
}

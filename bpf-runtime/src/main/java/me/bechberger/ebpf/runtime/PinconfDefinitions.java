...
/**
 * Generated class for BPF runtime types that start with pinconf
 */
...
public final class PinconfDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int pinconf_check_ops(Ptr<pinctrl_dev> pctldev) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void pinconf_generic_dump_config(Ptr<pinctrl_dev> pctldev, Ptr<seq_file> s,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int pinconf_groups_open(Ptr<inode> inode, Ptr<file> file) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int pinconf_groups_show(Ptr<seq_file> s, Ptr<?> what) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void pinconf_init_device_debugfs(Ptr<dentry> devroot, Ptr<pinctrl_dev> pctldev) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int pinconf_pins_open(Ptr<inode> inode, Ptr<file> file) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int pinconf_pins_show(Ptr<seq_file> s, Ptr<?> what) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int pinconf_set_config(Ptr<pinctrl_dev> pctldev, @Unsigned int pin,
      Ptr<java.lang. @Unsigned Long> configs, @Unsigned long nconfigs) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void pinconf_show_config(Ptr<seq_file> s, Ptr<pinctrl_dev> pctldev,
  ...
  @Type(
      ...
      cType = "struct pinconf_generic_params"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class pinconf_generic_params extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct pinconf_ops"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class pinconf_ops extends Struct {

...
/**
 * Generated class for BPF runtime types that start with fsverity
 */
@java.lang.SuppressWarnings("unused")
public final class FsverityDefinitions {
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void __fsverity_cleanup_inode(Ptr<inode> inode) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int __fsverity_file_open(Ptr<inode> inode, Ptr<file> filp) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int __fsverity_prepare_setattr(Ptr<dentry> dentry, Ptr<iattr> attr) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void fsverity_enqueue_verify_work(Ptr<work_struct> work) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int fsverity_get_descriptor(Ptr<inode> inode,
      Ptr<Ptr<fsverity_descriptor>> desc_ret) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int fsverity_get_digest(Ptr<inode> inode, Ptr<java.lang.Character> raw_digest,
      Ptr<java.lang.Character> alg, Ptr<hash_algo> halg) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int fsverity_ioctl_measure(Ptr<file> filp, Ptr<?> _uarg) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void fsverity_set_info(Ptr<inode> inode, Ptr<fsverity_info> vi) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void fsverity_verify_bio(Ptr<bio> bio) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static boolean fsverity_verify_blocks(Ptr<folio> folio, @Unsigned long len,
  ...
  @Type(
      ...
      cType = "struct fsverity_operations"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class fsverity_operations extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct fsverity_info"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class fsverity_info extends Struct {
    public merkle_tree_params tree_params;

    public char @Size(64) [] root_hash;

    public char @Size(64) [] file_digest;

    public Ptr<inode> inode;

    public Ptr<java.lang. @Unsigned Long> hash_block_verified;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct fsverity_enable_arg"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class fsverity_enable_arg extends Struct {
    ...
    public @Unsigned long @Size(11) [] __reserved2;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct fsverity_descriptor"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class fsverity_descriptor extends Struct {
    public char version;
    ...
    public @Unsigned @OriginalName("__le32") int sig_size;
    ...
    public char @Size(144) [] __reserved;

    public char @Size(0) [] signature;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct fsverity_hash_alg"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class fsverity_hash_alg extends Struct {
    public String name;
    ...
    public hash_algo algo_id;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "union fsverity_hash_ctx"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class fsverity_hash_ctx extends Union {
    public sha256_ctx sha256;

    public sha512_ctx sha512;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct fsverity_digest"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class fsverity_digest extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct fsverity_read_metadata_arg"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class fsverity_read_metadata_arg extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct fsverity_formatted_digest"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class fsverity_formatted_digest extends Struct {
    public char @Size(8) [] magic;

    public @Unsigned @OriginalName("__le16") short digest_algorithm;

    public @Unsigned @OriginalName("__le16") short digest_size;

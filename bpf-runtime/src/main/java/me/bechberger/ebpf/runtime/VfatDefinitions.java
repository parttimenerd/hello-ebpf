...
/**
 * Generated class for BPF runtime types that start with vfat
 */
...
public final class VfatDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int vfat_create(Ptr<mnt_idmap> idmap, Ptr<inode> dir, Ptr<dentry> dentry,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int vfat_create_shortname(Ptr<inode> dir, Ptr<nls_table> nls,
      Ptr<java.lang. @Unsigned @OriginalName("wchar_t") Short> uname, int ulen, String name_res,
      String lcase) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int vfat_fill_super(Ptr<super_block> sb, Ptr<fs_context> fc) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int vfat_get_tree(Ptr<fs_context> fc) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int vfat_init_fs_context(Ptr<fs_context> fc) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<dentry> vfat_lookup(Ptr<inode> dir, Ptr<dentry> dentry, @Unsigned int flags) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<dentry> vfat_mkdir(Ptr<mnt_idmap> idmap, Ptr<inode> dir, Ptr<dentry> dentry,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int vfat_parse_param(Ptr<fs_context> fc, Ptr<fs_parameter> param) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int vfat_rename(Ptr<inode> old_dir, Ptr<dentry> old_dentry, Ptr<inode> new_dir,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int vfat_rename2(Ptr<mnt_idmap> idmap, Ptr<inode> old_dir, Ptr<dentry> old_dentry,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int vfat_rename_exchange(Ptr<inode> old_dir, Ptr<dentry> old_dentry,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int vfat_rmdir(Ptr<inode> dir, Ptr<dentry> dentry) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int vfat_unlink(Ptr<inode> dir, Ptr<dentry> dentry) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void vfat_update_dir_metadata(Ptr<inode> dir, Ptr<timespec64> ts) {
    throw new MethodIsBPFRelatedFunction();
  }
}

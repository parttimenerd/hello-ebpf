...
/**
 * Generated class for BPF runtime types that start with iov
 */
@java.lang.SuppressWarnings("unused")
public final class IovDefinitions {
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long __iov_iter_get_pages_alloc(Ptr<iov_iter> i,
      Ptr<Ptr<Ptr<page>>> pages, @Unsigned long maxsize, @Unsigned int maxpages,
      Ptr<java.lang. @Unsigned Long> start) {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void iov_iter_discard(Ptr<iov_iter> i, @Unsigned int direction,
      @Unsigned long count) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long iov_iter_extract_pages(Ptr<iov_iter> i,
      Ptr<Ptr<Ptr<page>>> pages, @Unsigned long maxsize, @Unsigned int maxpages,
      @Unsigned @OriginalName("iov_iter_extraction_t") int extraction_flags,
      Ptr<java.lang. @Unsigned Long> offset0) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long iov_iter_get_pages2(Ptr<iov_iter> i,
      Ptr<Ptr<page>> pages, @Unsigned long maxsize, @Unsigned int maxpages,
      Ptr<java.lang. @Unsigned Long> start) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long iov_iter_get_pages_alloc2(Ptr<iov_iter> i,
      Ptr<Ptr<Ptr<page>>> pages, @Unsigned long maxsize, Ptr<java.lang. @Unsigned Long> start) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void iov_iter_restore(Ptr<iov_iter> i, Ptr<iov_iter_state> state) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void iov_iter_xarray(Ptr<iov_iter> i, @Unsigned int direction, Ptr<xarray> xarray,
      @OriginalName("loff_t") long start, @Unsigned long count) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int iov_resources_unassigned(Ptr<pci_dev> dev, Ptr<?> data) {
    throw new MethodIsBPFRelatedFunction();
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct iov_iter"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class iov_iter extends Struct {
    ...
    @InlineUnion(907)
    public anon_member_of_anon_member_of_iov_iter anon4$1;

    @InlineUnion(908)
    public @Unsigned long nr_segs;

    @InlineUnion(908)
    public char folioq_slot;

    @InlineUnion(908)
    public @OriginalName("loff_t") long xarray_start;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct iov_iter_state"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class iov_iter_state extends Struct {
    public @Unsigned long iov_offset;

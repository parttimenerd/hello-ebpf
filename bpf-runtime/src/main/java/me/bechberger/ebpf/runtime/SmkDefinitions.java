...
/**
 * Generated class for BPF runtime types that start with smk
 */
@java.lang.SuppressWarnings("unused")
public final class SmkDefinitions {
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int smk_access(Ptr<smack_known> subject, Ptr<smack_known> object, int request,
      Ptr<smk_audit_info> a) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int smk_access_entry(String subject_label, String object_label,
      Ptr<list_head> rule_list) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int smk_curacc(Ptr<smack_known> obj_known, @Unsigned int mode,
      Ptr<smk_audit_info> a) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void smk_destroy_label_list(Ptr<list_head> list) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int smk_fill_super(Ptr<super_block> sb, Ptr<fs_context> fc) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int smk_get_tree(Ptr<fs_context> fc) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<smack_known> smk_import_allocated_label(String smack,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int smk_init_fs_context(Ptr<fs_context> fc) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void smk_insert_entry(Ptr<smack_known> skp) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int smk_ipv4_check(Ptr<sock> sk, Ptr<sockaddr_in> sap) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int smk_ipv6_check(Ptr<smack_known> subject, Ptr<smack_known> object,
      Ptr<sockaddr_in6> address, int act) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int smk_netlbl_mls(int level, String catset, Ptr<netlbl_lsm_secattr> sap, int len) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int smk_open_cipso(Ptr<inode> inode, Ptr<file> file) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int smk_open_cipso2(Ptr<inode> inode, Ptr<file> file) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int smk_open_load(Ptr<inode> inode, Ptr<file> file) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int smk_open_load2(Ptr<inode> inode, Ptr<file> file) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int smk_open_load_self(Ptr<inode> inode, Ptr<file> file) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int smk_open_load_self2(Ptr<inode> inode, Ptr<file> file) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int smk_open_net4addr(Ptr<inode> inode, Ptr<file> file) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int smk_open_net6addr(Ptr<inode> inode, Ptr<file> file) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int smk_open_onlycap(Ptr<inode> inode, Ptr<file> file) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int smk_open_relabel_self(Ptr<inode> inode, Ptr<file> file) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int smk_parse_label_list(String data, Ptr<list_head> list) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long smk_parse_long_rule(String data,
      Ptr<smack_parsed_rule> rule, int _import, int tokens) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long smk_read_ambient(Ptr<file> filp, String buf,
      @Unsigned long cn, Ptr<java.lang. @OriginalName("loff_t") Long> ppos) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long smk_read_direct(Ptr<file> filp, String buf,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long smk_read_doi(Ptr<file> filp, String buf,
      @Unsigned long count, Ptr<java.lang. @OriginalName("loff_t") Long> ppos) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long smk_read_logging(Ptr<file> filp, String buf,
      @Unsigned long count, Ptr<java.lang. @OriginalName("loff_t") Long> ppos) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long smk_read_mapped(Ptr<file> filp, String buf,
      @Unsigned long count, Ptr<java.lang. @OriginalName("loff_t") Long> ppos) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long smk_read_ptrace(Ptr<file> filp, String buf,
      @Unsigned long count, Ptr<java.lang. @OriginalName("loff_t") Long> ppos) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long smk_read_syslog(Ptr<file> filp, String buf,
      @Unsigned long cn, Ptr<java.lang. @OriginalName("loff_t") Long> ppos) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void smk_rule_show(Ptr<seq_file> s, Ptr<smack_rule> srp, int max) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void smk_seq_stop(Ptr<seq_file> s, Ptr<?> v) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int smk_set_access(Ptr<smack_parsed_rule> srp, Ptr<list_head> rule_list,
      Ptr<mutex> rule_lock) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int smk_skb_to_addr_ipv6(Ptr<sk_buff> skb, Ptr<sockaddr_in6> sip) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int smk_tskacc(Ptr<task_smack> tsp, Ptr<smack_known> obj_known, @Unsigned int mode,
      Ptr<smk_audit_info> a) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @Type(
      ...
      cType = "struct smk_net4addr"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class smk_net4addr extends Struct {
    public list_head list;

    public in_addr smk_host;

    public in_addr smk_mask;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct smk_net6addr"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class smk_net6addr extends Struct {
    public list_head list;

    public in6_addr smk_host;

    public in6_addr smk_mask;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct smk_audit_info"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class smk_audit_info extends Struct {
    public common_audit_data a;

    public smack_audit_data sad;
  }
  ...
  public enum smk_inos implements Enum<smk_inos>, TypedEnum<smk_inos, java.lang. @Unsigned Integer> {
    /**
     * {@code SMK_ROOT_INO = 2}
     */
    @EnumMember(
    ...
    /**
     * {@code SMK_REVOKE_SUBJ = 18}
     */
    @EnumMember(
        value = 18L,
        name = "SMK_REVOKE_SUBJ"
    )
    SMK_REVOKE_SUBJ,

    /**
     * {@code SMK_CHANGE_RULE = 19}
     */
    @EnumMember(
        value = 19L,
        name = "SMK_CHANGE_RULE"
    )
    SMK_CHANGE_RULE,
    ...
    /**
     * {@code SMK_RELABEL_SELF = 24}
     */
    @EnumMember(
        value = 24L,
        name = "SMK_RELABEL_SELF"
    )
    SMK_RELABEL_SELF
  }
}

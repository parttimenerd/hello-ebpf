...
/**
 * Generated class for BPF runtime types that start with vfs
 */
...
public final class VfsDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int vfs_cancel_lock(Ptr<file> filp, Ptr<file_lock> fl) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void vfs_clean_context(Ptr<fs_context> fc) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void vfs_cleanup_quota_inode(Ptr<super_block> sb, int type) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("loff_t") long vfs_clone_file_range(Ptr<file> file_in,
      @OriginalName("loff_t") long pos_in, Ptr<file> file_out, @OriginalName("loff_t") long pos_out,
      @OriginalName("loff_t") long len, @Unsigned int remap_flags) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int vfs_cmd_create(Ptr<fs_context> fc, boolean exclusive) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long vfs_copy_file_range(Ptr<file> file_in,
      @OriginalName("loff_t") long pos_in, Ptr<file> file_out, @OriginalName("loff_t") long pos_out,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int vfs_create(Ptr<mnt_idmap> idmap, Ptr<inode> dir, Ptr<dentry> dentry,
      @Unsigned @OriginalName("umode_t") short mode, boolean want_excl) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<vfsmount> vfs_create_mount(Ptr<fs_context> fc) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int vfs_dedupe_file_range(Ptr<file> file, Ptr<file_dedupe_range> same) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int vfs_dedupe_file_range_compare(Ptr<file> src,
      @OriginalName("loff_t") long srcoff, Ptr<file> dest, @OriginalName("loff_t") long dstoff,
      @OriginalName("loff_t") long len, Ptr<java.lang. @OriginalName("bool") Boolean> is_same) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("loff_t") long vfs_dedupe_file_range_one(Ptr<file> src_file,
      @OriginalName("loff_t") long src_pos, Ptr<file> dst_file,
      @OriginalName("loff_t") long dst_pos, @OriginalName("loff_t") long len,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int vfs_dentry_acceptable(Ptr<?> context, Ptr<dentry> dentry) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<fs_context> vfs_dup_fs_context(Ptr<fs_context> src_fc) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int vfs_fadvise(Ptr<file> file, @OriginalName("loff_t") long offset,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int vfs_fallocate(Ptr<file> file, int mode, @OriginalName("loff_t") long offset,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int vfs_fchmod(Ptr<file> file, @Unsigned @OriginalName("umode_t") short mode) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int vfs_fchown(Ptr<file> file, @Unsigned @OriginalName("uid_t") int user,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int vfs_fileattr_get(Ptr<dentry> dentry, Ptr<file_kattr> fa) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int vfs_fileattr_set(Ptr<mnt_idmap> idmap, Ptr<dentry> dentry, Ptr<file_kattr> fa) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int vfs_fstat(int fd, Ptr<kstat> stat) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int vfs_fsync(Ptr<file> file, int datasync) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int vfs_fsync_range(Ptr<file> file, @OriginalName("loff_t") long start,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int vfs_get_fsid(Ptr<dentry> dentry, Ptr<__kernel_fsid_t> fsid) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction("((const u8*)vfs_get_link($arg1, $arg2))")
  public static String vfs_get_link(Ptr<dentry> dentry, Ptr<delayed_call> done) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int vfs_get_tree(Ptr<fs_context> fc) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static boolean vfs_inode_has_locks(Ptr<inode> inode) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long vfs_iocb_iter_read(Ptr<file> file, Ptr<kiocb> iocb,
      Ptr<iov_iter> iter) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long vfs_iocb_iter_write(Ptr<file> file, Ptr<kiocb> iocb,
      Ptr<iov_iter> iter) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int vfs_ioctl(Ptr<file> filp, @Unsigned int cmd, @Unsigned long arg) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long vfs_iter_read(Ptr<file> file, Ptr<iov_iter> iter,
      Ptr<java.lang. @OriginalName("loff_t") Long> ppos, @OriginalName("rwf_t") int flags) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long vfs_iter_write(Ptr<file> file, Ptr<iov_iter> iter,
      Ptr<java.lang. @OriginalName("loff_t") Long> ppos, @OriginalName("rwf_t") int flags) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int vfs_link(Ptr<dentry> old_dentry, Ptr<mnt_idmap> idmap, Ptr<inode> dir,
      Ptr<dentry> new_dentry, Ptr<Ptr<inode>> delegated_inode) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long vfs_listxattr(Ptr<dentry> dentry, String list,
      @Unsigned long size) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("loff_t") long vfs_llseek(Ptr<file> file,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int vfs_lock_file(Ptr<file> filp, @Unsigned int cmd, Ptr<file_lock> fl,
      Ptr<file_lock> conf) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<dentry> vfs_mkdir(Ptr<mnt_idmap> idmap, Ptr<inode> dir, Ptr<dentry> dentry,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int vfs_mknod(Ptr<mnt_idmap> idmap, Ptr<inode> dir, Ptr<dentry> dentry,
      @Unsigned @OriginalName("umode_t") short mode, @Unsigned @OriginalName("dev_t") int dev) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction("vfs_mkobj($arg1, $arg2, (int (*)(struct dentry*, short unsigned int, void*))$arg3, $arg4)")
  public static int vfs_mkobj(Ptr<dentry> dentry, @Unsigned @OriginalName("umode_t") short mode,
      Ptr<?> f, Ptr<?> arg) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static String vfs_parse_comma_sep(Ptr<String> s) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int vfs_parse_fs_param(Ptr<fs_context> fc, Ptr<fs_parameter> param) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int vfs_parse_fs_param_source(Ptr<fs_context> fc, Ptr<fs_parameter> param) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction("vfs_parse_monolithic_sep($arg1, $arg2, (u8* (*)(u8**))$arg3)")
  public static int vfs_parse_monolithic_sep(Ptr<fs_context> fc, Ptr<?> data, Ptr<?> sep) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @Unsigned long vfs_pressure_ratio(@Unsigned long val) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long vfs_read(Ptr<file> file, String buf,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int vfs_readlink(Ptr<dentry> dentry, String buffer, int buflen) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int vfs_rmdir(Ptr<mnt_idmap> idmap, Ptr<inode> dir, Ptr<dentry> dentry) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int vfs_setlease(Ptr<file> filp, int arg, Ptr<Ptr<file_lease>> lease,
      Ptr<Ptr<?>> priv) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("loff_t") long vfs_setpos(Ptr<file> file,
      @OriginalName("loff_t") long offset, @OriginalName("loff_t") long maxsize) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long vfs_splice_read(Ptr<file> in,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int vfs_statx(int dfd, Ptr<filename> filename, int flags, Ptr<kstat> stat,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int vfs_test_lock(Ptr<file> filp, Ptr<file_lock> fl) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int vfs_unlink(Ptr<mnt_idmap> idmap, Ptr<inode> dir, Ptr<dentry> dentry,
      Ptr<Ptr<inode>> delegated_inode) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct { unsigned int permitted; unsigned int inheritable; }"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct renamedata"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class renamedata extends Struct {
    public Ptr<mnt_idmap> old_mnt_idmap;

    public Ptr<dentry> old_parent;

    public Ptr<dentry> old_dentry;

    public Ptr<mnt_idmap> new_mnt_idmap;

    public Ptr<dentry> new_parent;

    public Ptr<dentry> new_dentry;

    public Ptr<Ptr<inode>> delegated_inode;

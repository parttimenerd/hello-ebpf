...
/**
 * Generated class for BPF runtime types that start with wireless
 */
@java.lang.SuppressWarnings("unused")
public final class WirelessDefinitions {
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<?> wireless_dev_seq_next(Ptr<seq_file> seq, Ptr<?> v,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int wireless_dev_seq_show(Ptr<seq_file> seq, Ptr<?> v) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<?> wireless_dev_seq_start(Ptr<seq_file> seq,
      Ptr<java.lang. @OriginalName("loff_t") Long> pos) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void wireless_dev_seq_stop(Ptr<seq_file> seq, Ptr<?> v) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void wireless_nlevent_process(Ptr<work_struct> work) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long wireless_status_show(Ptr<device> dev,
  ...
  @Type(
      ...
      cType = "struct wireless_dev"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class wireless_dev extends Struct {
    ...
    public list_head mgmt_registrations;
    ...
    public char @Size(6) [] address;

    public @OriginalName("cfg80211_conn") Ptr<?> conn;

    public @OriginalName("cfg80211_cached_keys") Ptr<?> connect_keys;

    public ieee80211_bss_type conn_bss_type;

    public @Unsigned int conn_owner_nlportid;

    public work_struct disconnect_wk;

    public char @Size(6) [] disconnect_bssid;
    ...
    public wext_of_wireless_dev wext;

    public wiphy_work cqm_rssi_work;

    public @OriginalName("cfg80211_cqm_config") Ptr<?> cqm_config;

    public list_head pmsr_list;

    public @OriginalName("spinlock_t") spinlock pmsr_lock;

    public work_struct pmsr_free_wk;
    ...
    public @Unsigned int radio_mask;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct { u8 addr[6]; union { struct { unsigned int beacon_interval; struct cfg80211_chan_def chandef; } ap; struct { cfg80211_internal_bss *current_bss; } client; }; _Bool cac_started; long unsigned int cac_start_time; unsigned int cac_time_ms; }"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "union { struct { unsigned int beacon_interval; struct cfg80211_chan_def chandef; } ap; struct { cfg80211_internal_bss *current_bss; } client; }"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava

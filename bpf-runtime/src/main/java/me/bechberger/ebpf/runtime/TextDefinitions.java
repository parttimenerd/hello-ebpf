...
/**
 * Generated class for BPF runtime types that start with text
 */
...
public final class TextDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction("text_poke_apply_relocation($arg1, (const const u8*)$arg2, $arg3, $arg4, $arg5)")
  public static void text_poke_apply_relocation(Ptr<java.lang.Character> buf,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<?> text_poke_set(Ptr<?> addr, int c, @Unsigned long len) {
    throw new MethodIsBPFRelatedFunction();
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct { short unsigned int font_height; short unsigned int cursor_x; short unsigned int cursor_y; short unsigned int rows; short unsigned int columns; }"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class text_mode_3_of_u_of_dom0_vga_console_info extends Struct {
    public @Unsigned @OriginalName("uint16_t") short font_height;

    public @Unsigned @OriginalName("uint16_t") short cursor_x;

    public @Unsigned @OriginalName("uint16_t") short cursor_y;

    public @Unsigned @OriginalName("uint16_t") short rows;

    public @Unsigned @OriginalName("uint16_t") short columns;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "union text_poke_insn"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class text_poke_insn extends Union {
    public char @Size(5) [] text;

    public anon_member_of_text_poke_insn anon1;
  }
}

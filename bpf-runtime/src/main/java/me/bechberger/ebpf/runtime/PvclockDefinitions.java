...
/**
 * Generated class for BPF runtime types that start with pvclock
 */
...
public final class PvclockDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int pvclock_gtod_register_notifier(Ptr<notifier_block> nb) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int pvclock_gtod_unregister_notifier(Ptr<notifier_block> nb) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void pvclock_read_wallclock(Ptr<pvclock_wall_clock> wall_clock,
      Ptr<pvclock_vcpu_time_info> vcpu_time, Ptr<timespec64> ts) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @Type(
      ...
      cType = "struct pvclock_vcpu_time_info"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class pvclock_vcpu_time_info extends Struct {
    ...
    public @OriginalName("s8") byte tsc_shift;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct pvclock_vsyscall_time_info"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class pvclock_vsyscall_time_info extends Struct {
    public pvclock_vcpu_time_info pvti;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct pvclock_wall_clock"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class pvclock_wall_clock extends Struct {
    public @Unsigned int version;

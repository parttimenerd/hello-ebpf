...
/**
 * Generated class for BPF runtime types that start with platform
 */
...
public final class PlatformDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction("__platform_driver_probe($arg1, (int (*)(struct platform_device*))$arg2, $arg3)")
  public static int __platform_driver_probe(Ptr<platform_driver> drv, Ptr<?> probe,
      Ptr<module> module) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int __platform_driver_register(Ptr<platform_driver> drv, Ptr<module> owner) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction("__platform_register_drivers((struct platform_driver**)$arg1, $arg2, $arg3)")
  public static int __platform_register_drivers(Ptr<Ptr<platform_driver>> drivers,
      @Unsigned int count, Ptr<module> owner) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @Unsigned @OriginalName("umode_t") short platform_dev_attrs_visible(
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void platform_device_msi_free_irqs_all(Ptr<device> dev) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int platform_device_msi_init_and_alloc_irqs(Ptr<device> dev, @Unsigned int nvec,
      @OriginalName("irq_write_msi_msg_t") Ptr<?> write_msi_msg) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void platform_device_release(Ptr<device> dev) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void platform_dma_cleanup(Ptr<device> dev) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int platform_dma_configure(Ptr<device> dev) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int platform_get_ethdev_address(Ptr<device> dev, Ptr<net_device> netdev) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<resource> platform_get_mem_or_io(Ptr<platform_device> dev, @Unsigned int num) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<resource> platform_get_resource(Ptr<platform_device> dev, @Unsigned int type,
      @Unsigned int num) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void platform_msi_set_desc(
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void platform_msi_write_msi_msg(Ptr<irq_data> d, Ptr<msi_msg> msg) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int platform_pci_resume(Ptr<device> dev) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int platform_pm_freeze(Ptr<device> dev) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int platform_pm_poweroff(Ptr<device> dev) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int platform_pm_restore(Ptr<device> dev) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int platform_pm_resume(Ptr<device> dev) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int platform_pm_suspend(Ptr<device> dev) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int platform_pm_thaw(Ptr<device> dev) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int platform_power_off_notify(Ptr<sys_off_data> data) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int platform_probe(Ptr<device> _dev) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void platform_remove(Ptr<device> _dev) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void platform_shutdown(Ptr<device> _dev) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction("platform_unregister_drivers((struct platform_driver**)$arg1, $arg2)")
  public static void platform_unregister_drivers(Ptr<Ptr<platform_driver>> drivers,
      @Unsigned int count) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @Type(
      ...
      cType = "struct platform_device"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class platform_device extends Struct {
    public String name;
    ...
    public Ptr<resource> resource;

    public Ptr<platform_device_id> id_entry;

    public String driver_override;

    public Ptr<mfd_cell> mfd_cell;

    public pdev_archdata archdata;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct platform_device_id"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class platform_device_id extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct platform_device_info"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class platform_device_info extends Struct {
    ...
    public Ptr<property_entry> properties;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct platform_suspend_ops"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class platform_suspend_ops extends Struct {
    public Ptr<?> valid;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct platform_s2idle_ops"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class platform_s2idle_ops extends Struct {
    public Ptr<?> begin;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct platform_hibernation_ops"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class platform_hibernation_ops extends Struct {
    public Ptr<?> begin;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct platform_driver"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class platform_driver extends Struct {
    public Ptr<?> probe;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct platform_object"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class platform_object extends Struct {

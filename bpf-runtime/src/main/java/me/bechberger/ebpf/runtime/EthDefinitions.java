...
/**
 * Generated class for BPF runtime types that start with eth
 */
@java.lang.SuppressWarnings("unused")
public final class EthDefinitions {
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void eth_commit_mac_addr_change(Ptr<net_device> dev, Ptr<?> p) {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int eth_gro_complete(Ptr<sk_buff> skb, int nhoff) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<sk_buff> eth_gro_receive(Ptr<list_head> head, Ptr<sk_buff> skb) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int eth_mac_addr(Ptr<net_device> dev, Ptr<?> p) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int eth_platform_get_mac_address(Ptr<device> dev,
      Ptr<java.lang.Character> mac_addr) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int eth_prepare_mac_addr_change(Ptr<net_device> dev, Ptr<?> p) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static @Unsigned @OriginalName("__be16") short eth_type_trans(Ptr<sk_buff> skb,
      Ptr<net_device> dev) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int eth_validate_addr(Ptr<net_device> dev) {
    throw new MethodIsBPFRelatedFunction();
  }
}

...
/**
 * Generated class for BPF runtime types that start with rt6
 */
...
public final class Rt6Definitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int __rt6_nh_dev_match(Ptr<fib6_nh> nh, Ptr<?> _arg) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void rt6_age_examine_exception(Ptr<rt6_exception_bucket> bucket,
      Ptr<rt6_exception> rt6_ex, Ptr<fib6_gc_args> gc_args, @Unsigned long now) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void rt6_age_exceptions(Ptr<fib6_info> f6i, Ptr<fib6_gc_args> gc_args,
      @Unsigned long now) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void rt6_clean_tohost(Ptr<net> net, Ptr<in6_addr> gateway) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void rt6_disable_ip(Ptr<net_device> dev, @Unsigned long event) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void rt6_do_redirect(Ptr<dst_entry> dst, Ptr<sock> sk, Ptr<sk_buff> skb) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int rt6_dump_route(Ptr<fib6_info> rt, Ptr<?> p_arg, @Unsigned int skip) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int rt6_fill_node(Ptr<net> net, Ptr<sk_buff> skb, Ptr<fib6_info> rt,
      Ptr<dst_entry> dst, Ptr<in6_addr> dest, Ptr<in6_addr> src, int iif, int type,
      @Unsigned int portid, @Unsigned int seq, @Unsigned int flags) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void rt6_flush_exceptions(Ptr<fib6_info> f6i) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void rt6_mtu_change(Ptr<net_device> dev, @Unsigned int mtu) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int rt6_mtu_change_route(Ptr<fib6_info> f6i, Ptr<?> p_arg) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void rt6_multipath_rebalance(Ptr<fib6_info> rt) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int rt6_nh_age_exceptions(Ptr<fib6_nh> nh, Ptr<?> _arg) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int rt6_nh_dump_exceptions(Ptr<fib6_nh> nh, Ptr<?> arg) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int rt6_nh_find_match(Ptr<fib6_nh> nh, Ptr<?> _arg) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int rt6_nh_flush_exceptions(Ptr<fib6_nh> nh, Ptr<?> arg) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int rt6_nh_nlmsg_size(Ptr<fib6_nh> nh, Ptr<?> arg) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int rt6_nh_remove_exception_rt(Ptr<fib6_nh> nh, Ptr<?> _arg) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static @Unsigned long rt6_nlmsg_size(Ptr<fib6_info> f6i) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void rt6_probe(Ptr<fib6_nh> fib6_nh) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void rt6_probe_deferred(Ptr<work_struct> w) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void rt6_purge_dflt_routers(Ptr<net> net) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void rt6_remove_exception(Ptr<rt6_exception_bucket> bucket,
      Ptr<rt6_exception> rt6_ex) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void rt6_remove_prefsrc(Ptr<inet6_ifaddr> ifp) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int rt6_stats_seq_show(Ptr<seq_file> seq, Ptr<?> v) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void rt6_sync_down_dev(Ptr<net_device> dev, @Unsigned long event) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void rt6_sync_up(Ptr<net_device> dev, char nh_flags) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void rt6_uncached_list_flush_dev(Ptr<net_device> dev) {
    throw new MethodIsBPFRelatedFunction();
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct rt6_info"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class rt6_info extends Struct {
    ...
    public rt6key rt6i_dst;

    public rt6key rt6i_src;

    public in6_addr rt6i_gateway;

    public Ptr<inet6_dev> rt6i_idev;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct rt6_statistics"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class rt6_statistics extends Struct {
    ...
    public atomic_t fib_rt_alloc;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct rt6_exception_bucket"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class rt6_exception_bucket extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct rt6_exception"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class rt6_exception extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct rt6_rtnl_dump_arg"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class rt6_rtnl_dump_arg extends Struct {
    ...
    public fib_dump_filter filter;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "enum rt6_nud_state"
  )
  public enum rt6_nud_state implements Enum<rt6_nud_state>, TypedEnum<rt6_nud_state, java.lang.Integer> {
    /**
     * {@code RT6_NUD_FAIL_HARD = -3}
     */
    @EnumMember(
        value = -3L,
        name = "RT6_NUD_FAIL_HARD"
    )
    RT6_NUD_FAIL_HARD,

    /**
     * {@code RT6_NUD_FAIL_PROBE = -2}
     */
    @EnumMember(
        value = -2L,
        name = "RT6_NUD_FAIL_PROBE"
    )
    RT6_NUD_FAIL_PROBE,

    /**
     * {@code RT6_NUD_FAIL_DO_RR = -1}
     */
    @EnumMember(
        value = -1L,
        name = "RT6_NUD_FAIL_DO_RR"
    )
    RT6_NUD_FAIL_DO_RR,

    /**
     * {@code RT6_NUD_SUCCEED = 1}
     */
    @EnumMember(
        value = 1L,
        name = "RT6_NUD_SUCCEED"
    )
    RT6_NUD_SUCCEED
  }
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct __rt6_probe_work"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class __rt6_probe_work extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct rt6_mtu_change_arg"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class rt6_mtu_change_arg extends Struct {
    public Ptr<net_device> dev;
  ...
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class rt6_nh extends Struct {
    public Ptr<fib6_info> fib6_info;

    public fib6_config r_cfg;

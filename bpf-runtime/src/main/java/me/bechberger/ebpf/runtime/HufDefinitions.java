...
/**
 * Generated class for BPF runtime types that start with huf
 */
@java.lang.SuppressWarnings("unused")
public final class HufDefinitions {
  public static final @Unsigned int HUF_flags_bmi2 = 1;

  public static final @Unsigned int HUF_flags_optimalDepth = 2;

  public static final @Unsigned int HUF_flags_preferRepeat = 4;

  public static final @Unsigned int HUF_flags_suspectUncompressible = 8;

  public static final @Unsigned int HUF_flags_disableAsm = 16;
  ...
  public static @Unsigned long HUF_buildCTable_wksp(
      ...
      @Unsigned int maxNbBits, Ptr<?> workSpace, @Unsigned long wkspSize) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int HUF_buildTree(Ptr<nodeElt_s> huffNode, @Unsigned int maxSymbolValue) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @Unsigned long HUF_closeCStream(Ptr<HUF_CStream_t> bitC) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  public static @Unsigned long HUF_compress1X_repeat(Ptr<?> dst, @Unsigned long dstSize, Ptr<?> src,
      ...
      Ptr<@OriginalName("HUF_repeat") repeatMode_of_ZSTD_hufCTables_t> repeat, int flags) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  public static @Unsigned long HUF_compressCTable_internal(
      ...
      Ptr<java.lang. @OriginalName("BYTE") Character> oend, Ptr<?> src, @Unsigned long srcSize,
      @OriginalName("HUF_nbStreams_e") HUF nbStreams,
      Ptr<java.lang. @Unsigned @OriginalName("HUF_CElt") Long> CTable, int flags) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  public static @Unsigned long HUF_compress_internal(Ptr<?> dst, @Unsigned long dstSize, Ptr<?> src,
      ...
      Ptr<java.lang. @Unsigned @OriginalName("HUF_CElt") Long> oldHufTable,
      Ptr<@OriginalName("HUF_repeat") repeatMode_of_ZSTD_hufCTables_t> repeat, int flags) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  public static @Unsigned long HUF_decompress1X1_DCtx_wksp(
      ...
      @Unsigned long wkspSize, int flags) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  public static @Unsigned long HUF_decompress4X1_usingDTable_internal_fast(Ptr<?> dst,
      @Unsigned long dstSize, Ptr<?> cSrc, @Unsigned long cSrcSize,
      Ptr<java.lang. @Unsigned @OriginalName("HUF_DTable") Integer> DTable,
      @OriginalName("HUF_DecompressFastLoopFn") Ptr<?> loopFn) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void HUF_decompress4X1_usingDTable_internal_fast_c_loop(
      Ptr<HUF_DecompressFastArgs> args) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void HUF_decompress4X2_usingDTable_internal_fast_c_loop(
      Ptr<HUF_DecompressFastArgs> args) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  public static void HUF_fillDTableX2(Ptr<HUF_DEltX2> DTable, @Unsigned int targetLog,
      ...
      @Unsigned int maxWeight, @Unsigned int nbBitsBaseline) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction("((const u8*)HUF_getErrorName($arg1))")
  public static String HUF_getErrorName(@Unsigned long code) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @Unsigned int HUF_isError(@Unsigned long code) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static @Unsigned int HUF_minTableLog(@Unsigned int symbolCardinality) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  public static @Unsigned int HUF_optimalTableLog(@Unsigned int maxTableLog, @Unsigned long srcSize,
      ...
      Ptr<java.lang. @Unsigned Integer> count, int flags) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  public static @Unsigned long HUF_readCTable(
      ...
      Ptr<java.lang. @Unsigned Integer> hasZeroWeights) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  public static @Unsigned long HUF_readStats(
      ...
      Ptr<java.lang. @Unsigned Integer> tableLogPtr, Ptr<?> src, @Unsigned long srcSize) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  public static @Unsigned long HUF_readStats_wksp(
      ...
      Ptr<java.lang. @Unsigned Integer> rankStats, Ptr<java.lang. @Unsigned Integer> nbSymbolsPtr,
      Ptr<java.lang. @Unsigned Integer> tableLogPtr, Ptr<?> src, @Unsigned long srcSize,
      Ptr<?> workSpace, @Unsigned long wkspSize, int flags) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @Unsigned int HUF_setMaxHeight(Ptr<nodeElt_s> huffNode, @Unsigned int lastNonNull,
      @Unsigned int targetNbBits) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void HUF_simpleQuickSort(Ptr<nodeElt_s> arr, int low, int high) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @Type(
      ...
      cType = "enum HUF_flags"
  )
  public enum HUF_flags implements Enum<HUF_flags>, TypedEnum<HUF_flags, java.lang. @Unsigned Integer> {
    /**
     * {@code HUF_flags_bmi2 = 1}
     */
    @EnumMember(
        value = 1L,
        name = "HUF_flags_bmi2"
    ...
    /**
     * {@code HUF_flags_optimalDepth = 2}
     */
    @EnumMember(
        value = 2L,
        name = "HUF_flags_optimalDepth"
    )
    HUF_flags_optimalDepth,

    /**
     * {@code HUF_flags_preferRepeat = 4}
     */
    @EnumMember(
        value = 4L,
        name = "HUF_flags_preferRepeat"
    )
    HUF_flags_preferRepeat,

    /**
     * {@code HUF_flags_suspectUncompressible = 8}
     */
    @EnumMember(
        value = 8L,
        name = "HUF_flags_suspectUncompressible"
    )
    HUF_flags_suspectUncompressible,

    /**
     * {@code HUF_flags_disableAsm = 16}
     */
    @EnumMember(
        value = 16L,
        name = "HUF_flags_disableAsm"
    )
    HUF_flags_disableAsm,

    /**
     * {@code HUF_flags_disableFast = 32}
     */
    @EnumMember(
        value = 32L,
        name = "HUF_flags_disableFast"
    )
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct { nodeElt_s huffNodeTbl[512]; struct { short unsigned int base; short unsigned int curr; } rankPosition[192]; }"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class HUF_buildCTable_wksp_tables extends Struct {
    public nodeElt_s @Size(512) @OriginalName("huffNodeTable") [] huffNodeTbl;

    public rankPos @Size(192) [] rankPosition;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct { unsigned int count[256]; long unsigned int CTable[257]; union { struct { nodeElt_s huffNodeTbl[512]; struct { short unsigned int base; short unsigned int curr; } rankPosition[192]; } buildCTable_wksp; struct { struct { unsigned int CTable[59]; unsigned int scratchBuffer[41]; unsigned int count[13]; short int norm[13]; } wksp; u8 bitsToWeight[13]; u8 huffWeight[255]; } writeCTable_wksp; unsigned int hist_wksp[1024]; }; }"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class HUF_compress_tables_t extends Struct {
    public @Unsigned int @Size(256) [] count;

    public @Unsigned @OriginalName("HUF_CElt") long @Size(257) [] CTable;

    public wksps_of_HUF_compress_tables_t wksps;
  }
}

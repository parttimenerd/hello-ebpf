...
/**
 * Generated class for BPF runtime types that start with firmware
 */
...
public final class FirmwareDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int firmware_fallback_platform(Ptr<fw_priv> fw_priv) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long firmware_id_show(Ptr<device> dev,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long firmware_loading_show(Ptr<device> dev,
      Ptr<device_attribute> attr, String buf) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void firmware_rw(Ptr<fw_priv> fw_priv, String buffer,
      @OriginalName("loff_t") long offset, @Unsigned long count, boolean read) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void firmware_rw_data(Ptr<fw_priv> fw_priv, String buffer,
      @OriginalName("loff_t") long offset, @Unsigned long count, boolean read) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long firmware_show(Ptr<device> dev,
      Ptr<device_attribute> attr, String buf) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long firmware_start_show(Ptr<kobject> kobj,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void firmware_upload_unregister(Ptr<fw_upload> fw_upload) {
    throw new MethodIsBPFRelatedFunction();
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct firmware_fallback_config"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class firmware_fallback_config extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct firmware_cache"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class firmware_cache extends Struct {
    ...
    public list_head fw_names;

    public delayed_work work;

    public notifier_block pm_notify;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct firmware_work"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class firmware_work extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct firmware_map_entry"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class firmware_map_entry extends Struct {

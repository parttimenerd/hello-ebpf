...
/**
 * Generated class for BPF runtime types that start with bh
 */
@java.lang.SuppressWarnings("unused")
public final class BhDefinitions {
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int __bh_read(Ptr<buffer_head> bh,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void __bh_read_batch(int nr, Ptr<Ptr<buffer_head>> bhs,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void bh_lru_install(Ptr<buffer_head> bh) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void bh_pool_kick_highpri(Ptr<irq_work> irq_work) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void bh_pool_kick_normal(Ptr<irq_work> irq_work) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int bh_uptodate_or_lock(Ptr<buffer_head> bh) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void bh_worker(Ptr<worker> worker) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  public enum bh_state_bits implements Enum<bh_state_bits>, TypedEnum<bh_state_bits, java.lang. @Unsigned Integer> {
    /**
     * {@code BH_Uptodate = 0}
     */
    @EnumMember(
  ...
  public static class bh_lru extends Struct {
    public Ptr<buffer_head> @Size(16) [] bhs;
  }

...
/**
 * Generated class for BPF runtime types that start with dsa
 */
@java.lang.SuppressWarnings("unused")
public final class DsaDefinitions {
  @Type(
      noCCodeGeneration = true,
      cType = "struct { int port; short unsigned int proto; }"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class dsa_of_anon_member_of_net_device_path extends Struct {
    public int port;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct dsa_port"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class dsa_port extends Struct {
    @InlineUnion(57669)
    ...
    public Ptr<device_node> dn;

    public @Unsigned int ageing_time;

    public Ptr<dsa_bridge> bridge;

    public devlink_port devlink_port;

    public @OriginalName("phylink") Ptr<?> pl;

    public phylink_config pl_config;

    public @OriginalName("netdevice_tracker") lockdep_map_p conduit_tracker;

    public Ptr<dsa_lag> lag;

    public Ptr<net_device> hsr_dev;

    public list_head list;

    public Ptr<ethtool_ops> orig_ethtool_ops;

    public mutex addr_lists_lock;

    public list_head fdbs;

    public list_head mdbs;

    public mutex vlans_lock;

    @InlineUnion(57671)
    public list_head vlans;

    @InlineUnion(57671)
    public list_head user_vlans;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct dsa_chip_data"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class dsa_chip_data extends Struct {
    public Ptr<device> host_dev;

    public int sw_addr;

    public Ptr<device> @Size(12) [] netdev;

    public int eeprom_len;

    public Ptr<device_node> of_node;

    public String @Size(12) [] port_names;

    public Ptr<device_node> @Size(12) [] port_dn;

    public @OriginalName("s8") byte @Size(4) [] rtable;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct dsa_platform_data"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class dsa_platform_data extends Struct {
    public Ptr<device> netdev;

    public Ptr<net_device> of_netdev;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "enum dsa_tag_protocol"
  )
  public enum dsa_tag_protocol implements Enum<dsa_tag_protocol>, TypedEnum<dsa_tag_protocol, java.lang. @Unsigned Integer> {
    /**
     * {@code DSA_TAG_PROTO_NONE = 0}
     */
    @EnumMember(
        value = 0L,
        name = "DSA_TAG_PROTO_NONE"
    )
    DSA_TAG_PROTO_NONE,

    /**
     * {@code DSA_TAG_PROTO_BRCM = 1}
     */
    @EnumMember(
        value = 1L,
        name = "DSA_TAG_PROTO_BRCM"
    )
    DSA_TAG_PROTO_BRCM,

    /**
     * {@code DSA_TAG_PROTO_BRCM_LEGACY = 22}
     */
    @EnumMember(
        value = 22L,
        name = "DSA_TAG_PROTO_BRCM_LEGACY"
    )
    DSA_TAG_PROTO_BRCM_LEGACY,

    /**
     * {@code DSA_TAG_PROTO_BRCM_LEGACY_FCS = 29}
     */
    @EnumMember(
        value = 29L,
        name = "DSA_TAG_PROTO_BRCM_LEGACY_FCS"
    )
    DSA_TAG_PROTO_BRCM_LEGACY_FCS,

    /**
     * {@code DSA_TAG_PROTO_BRCM_PREPEND = 2}
     */
    @EnumMember(
        value = 2L,
        name = "DSA_TAG_PROTO_BRCM_PREPEND"
    )
    DSA_TAG_PROTO_BRCM_PREPEND,

    /**
     * {@code DSA_TAG_PROTO_DSA = 3}
     */
    @EnumMember(
        value = 3L,
        name = "DSA_TAG_PROTO_DSA"
    )
    DSA_TAG_PROTO_DSA,

    /**
     * {@code DSA_TAG_PROTO_EDSA = 4}
     */
    @EnumMember(
        value = 4L,
        name = "DSA_TAG_PROTO_EDSA"
    )
    DSA_TAG_PROTO_EDSA,

    /**
     * {@code DSA_TAG_PROTO_GSWIP = 5}
     */
    @EnumMember(
        value = 5L,
        name = "DSA_TAG_PROTO_GSWIP"
    )
    DSA_TAG_PROTO_GSWIP,

    /**
     * {@code DSA_TAG_PROTO_KSZ9477 = 6}
     */
    @EnumMember(
        value = 6L,
        name = "DSA_TAG_PROTO_KSZ9477"
    )
    DSA_TAG_PROTO_KSZ9477,

    /**
     * {@code DSA_TAG_PROTO_KSZ9893 = 7}
     */
    @EnumMember(
        value = 7L,
        name = "DSA_TAG_PROTO_KSZ9893"
    )
    DSA_TAG_PROTO_KSZ9893,

    /**
     * {@code DSA_TAG_PROTO_LAN9303 = 8}
     */
    @EnumMember(
        value = 8L,
        name = "DSA_TAG_PROTO_LAN9303"
    )
    DSA_TAG_PROTO_LAN9303,

    /**
     * {@code DSA_TAG_PROTO_MTK = 9}
     */
    @EnumMember(
        value = 9L,
        name = "DSA_TAG_PROTO_MTK"
    )
    DSA_TAG_PROTO_MTK,

    /**
     * {@code DSA_TAG_PROTO_QCA = 10}
     */
    @EnumMember(
        value = 10L,
        name = "DSA_TAG_PROTO_QCA"
    )
    DSA_TAG_PROTO_QCA,

    /**
     * {@code DSA_TAG_PROTO_TRAILER = 11}
     */
    @EnumMember(
        value = 11L,
        name = "DSA_TAG_PROTO_TRAILER"
    )
    DSA_TAG_PROTO_TRAILER,

    /**
     * {@code DSA_TAG_PROTO_8021Q = 12}
     */
    @EnumMember(
        value = 12L,
        name = "DSA_TAG_PROTO_8021Q"
    )
    DSA_TAG_PROTO_8021Q,

    /**
     * {@code DSA_TAG_PROTO_SJA1105 = 13}
     */
    @EnumMember(
        value = 13L,
        name = "DSA_TAG_PROTO_SJA1105"
    )
    DSA_TAG_PROTO_SJA1105,

    /**
     * {@code DSA_TAG_PROTO_KSZ8795 = 14}
     */
    @EnumMember(
        value = 14L,
        name = "DSA_TAG_PROTO_KSZ8795"
    )
    DSA_TAG_PROTO_KSZ8795,

    /**
     * {@code DSA_TAG_PROTO_OCELOT = 15}
     */
    @EnumMember(
        value = 15L,
        name = "DSA_TAG_PROTO_OCELOT"
    )
    DSA_TAG_PROTO_OCELOT,

    /**
     * {@code DSA_TAG_PROTO_AR9331 = 16}
     */
    @EnumMember(
        value = 16L,
        name = "DSA_TAG_PROTO_AR9331"
    )
    DSA_TAG_PROTO_AR9331,

    /**
     * {@code DSA_TAG_PROTO_RTL4_A = 17}
     */
    @EnumMember(
        value = 17L,
        name = "DSA_TAG_PROTO_RTL4_A"
    )
    DSA_TAG_PROTO_RTL4_A,

    /**
     * {@code DSA_TAG_PROTO_HELLCREEK = 18}
     */
    @EnumMember(
        value = 18L,
        name = "DSA_TAG_PROTO_HELLCREEK"
    )
    DSA_TAG_PROTO_HELLCREEK,

    /**
     * {@code DSA_TAG_PROTO_XRS700X = 19}
     */
    @EnumMember(
        value = 19L,
        name = "DSA_TAG_PROTO_XRS700X"
    )
    DSA_TAG_PROTO_XRS700X,

    /**
     * {@code DSA_TAG_PROTO_OCELOT_8021Q = 20}
     */
    @EnumMember(
        value = 20L,
        name = "DSA_TAG_PROTO_OCELOT_8021Q"
    )
    DSA_TAG_PROTO_OCELOT_8021Q,

    /**
     * {@code DSA_TAG_PROTO_SEVILLE = 21}
     */
    @EnumMember(
        value = 21L,
        name = "DSA_TAG_PROTO_SEVILLE"
    )
    DSA_TAG_PROTO_SEVILLE,

    /**
     * {@code DSA_TAG_PROTO_SJA1110 = 23}
     */
    @EnumMember(
        value = 23L,
        name = "DSA_TAG_PROTO_SJA1110"
    )
    DSA_TAG_PROTO_SJA1110,

    /**
     * {@code DSA_TAG_PROTO_RTL8_4 = 24}
     */
    @EnumMember(
        value = 24L,
        name = "DSA_TAG_PROTO_RTL8_4"
    )
    DSA_TAG_PROTO_RTL8_4,

    /**
     * {@code DSA_TAG_PROTO_RTL8_4T = 25}
     */
    @EnumMember(
        value = 25L,
        name = "DSA_TAG_PROTO_RTL8_4T"
    )
    DSA_TAG_PROTO_RTL8_4T,

    /**
     * {@code DSA_TAG_PROTO_RZN1_A5PSW = 26}
     */
    @EnumMember(
        value = 26L,
        name = "DSA_TAG_PROTO_RZN1_A5PSW"
    )
    DSA_TAG_PROTO_RZN1_A5PSW,

    /**
     * {@code DSA_TAG_PROTO_LAN937X = 27}
     */
    @EnumMember(
        value = 27L,
        name = "DSA_TAG_PROTO_LAN937X"
    )
    DSA_TAG_PROTO_LAN937X,

    /**
     * {@code DSA_TAG_PROTO_VSC73XX_8021Q = 28}
     */
    @EnumMember(
        value = 28L,
        name = "DSA_TAG_PROTO_VSC73XX_8021Q"
    )
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct dsa_device_ops"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class dsa_device_ops extends Struct {
    public Ptr<?> xmit;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct dsa_switch"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class dsa_switch extends Struct {
    ...
    public Ptr<phylink_mac_ops> phylink_mac_ops;

    public @Unsigned int phys_mii_mask;

    public Ptr<mii_bus> user_mii_bus;

    public @Unsigned int ageing_time_min;

    public @Unsigned int ageing_time_max;

    public @OriginalName("dsa_8021q_context") Ptr<?> tag_8021q_ctx;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct dsa_lag"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class dsa_lag extends Struct {
    public Ptr<net_device> dev;

    public @Unsigned int id;

    public mutex fdb_lock;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct dsa_switch_tree"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class dsa_switch_tree extends Struct {
    public list_head list;

    public list_head ports;

    public raw_notifier_head nh;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct dsa_mall_mirror_tc_entry"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class dsa_mall_mirror_tc_entry extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct dsa_mall_policer_tc_entry"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class dsa_mall_policer_tc_entry extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct dsa_bridge"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class dsa_bridge extends Struct {
    public Ptr<net_device> dev;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "enum dsa_db_type"
  )
  public enum dsa_db_type implements Enum<dsa_db_type>, TypedEnum<dsa_db_type, java.lang. @Unsigned Integer> {
    /**
     * {@code DSA_DB_PORT = 0}
     */
    @EnumMember(
  ...
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class dsa_db extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct dsa_switch_ops"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class dsa_switch_ops extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct dsa_stubs"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class dsa_stubs extends Struct {

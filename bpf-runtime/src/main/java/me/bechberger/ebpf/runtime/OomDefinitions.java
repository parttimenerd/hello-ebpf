...
/**
 * Generated class for BPF runtime types that start with oom
 */
...
public final class OomDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static boolean __oom_reap_task_mm(Ptr<mm_struct> mm) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long oom_adj_read(Ptr<file> file, String buf,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static long oom_badness(Ptr<task_struct> p, @Unsigned long totalpages) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static boolean oom_cpuset_eligible(Ptr<task_struct> start, Ptr<oom_control> oc) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int oom_evaluate_task(Ptr<task_struct> task, Ptr<?> arg) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int oom_kill_memcg_member(Ptr<task_struct> task, Ptr<?> message) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long oom_score_adj_read(Ptr<file> file, String buf,
      @Unsigned long count, Ptr<java.lang. @OriginalName("loff_t") Long> ppos) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @Type(
      ...
      cType = "enum oom_constraint"
  )
  public enum oom_constraint implements Enum<oom_constraint>, TypedEnum<oom_constraint, java.lang. @Unsigned Integer> {
    /**
     * {@code CONSTRAINT_NONE = 0}
     */
    @EnumMember(
        value = 0L,
    ...
    /**
     * {@code CONSTRAINT_MEMORY_POLICY = 2}
     */
    @EnumMember(
        value = 2L,
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct oom_control"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class oom_control extends Struct {

...
/**
 * Generated class for BPF runtime types that start with klp
 */
...
public final class KlpDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<?> __klp_shadow_get_or_alloc(Ptr<?> obj, @Unsigned long id, @Unsigned long size,
      @Unsigned @OriginalName("gfp_t") int gfp_flags,
      @OriginalName("klp_shadow_ctor_t") Ptr<?> ctor, Ptr<?> ctor_data, boolean warn_on_exist) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int klp_check_and_switch_task(Ptr<task_struct> task, Ptr<?> arg) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void klp_cleanup_module_patches_limited(Ptr<module> mod, Ptr<klp_patch> limit) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void klp_copy_process(Ptr<task_struct> child) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void klp_free_patch_work_fn(Ptr<work_struct> work) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void klp_ftrace_handler(@Unsigned long ip, @Unsigned long parent_ip,
      Ptr<ftrace_ops> fops, Ptr<ftrace_regs> fregs) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void klp_init_transition(Ptr<klp_patch> patch, int state) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void klp_kobj_release_func(Ptr<kobject> kobj) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void klp_kobj_release_object(Ptr<kobject> kobj) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void klp_kobj_release_patch(Ptr<kobject> kobj) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int klp_match_callback(Ptr<?> data, @Unsigned long addr) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int klp_module_coming(Ptr<module> mod) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void klp_module_going(Ptr<module> mod) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<?> klp_shadow_alloc(Ptr<?> obj, @Unsigned long id, @Unsigned long size,
      @Unsigned @OriginalName("gfp_t") int gfp_flags,
      @OriginalName("klp_shadow_ctor_t") Ptr<?> ctor, Ptr<?> ctor_data) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void klp_shadow_free(Ptr<?> obj, @Unsigned long id,
      @OriginalName("klp_shadow_dtor_t") Ptr<?> dtor) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void klp_shadow_free_all(@Unsigned long id,
      @OriginalName("klp_shadow_dtor_t") Ptr<?> dtor) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void klp_shadow_free_struct(Ptr<klp_shadow> shadow,
      @OriginalName("klp_shadow_dtor_t") Ptr<?> dtor) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<?> klp_shadow_get_or_alloc(Ptr<?> obj, @Unsigned long id, @Unsigned long size,
      @Unsigned @OriginalName("gfp_t") int gfp_flags,
      @OriginalName("klp_shadow_ctor_t") Ptr<?> ctor, Ptr<?> ctor_data) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void klp_sync(Ptr<work_struct> work) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void klp_transition_work_fn(Ptr<work_struct> work) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static boolean klp_try_switch_task(Ptr<task_struct> task) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void klp_update_patch_state(Ptr<task_struct> task) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int klp_write_object_relocs(Ptr<klp_patch> patch, Ptr<klp_object> obj,
      boolean apply) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @Type(
      ...
      cType = "struct klp_modinfo"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class klp_modinfo extends Struct {
    public @OriginalName("Elf64_Ehdr") elf64_hdr hdr;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct klp_func"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class klp_func extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct klp_callbacks"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class klp_callbacks extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct klp_object"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class klp_object extends Struct {
    public String name;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct klp_state"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class klp_state extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct klp_patch"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class klp_patch extends Struct {
    public Ptr<module> mod;
    ...
    public completion finish;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct klp_find_arg"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class klp_find_arg extends Struct {
    public String name;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct klp_ops"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class klp_ops extends Struct {
    public list_head node;

    public list_head func_stack;

    public ftrace_ops fops;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct klp_shadow"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class klp_shadow extends Struct {

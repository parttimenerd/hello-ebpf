...
/**
 * Generated class for BPF runtime types that start with subflow
 */
@java.lang.SuppressWarnings("unused")
public final class SubflowDefinitions {
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int __subflow_push_pending(Ptr<sock> sk, Ptr<sock> ssk,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void subflow_add_reset_reason(Ptr<sk_buff> skb, char reason) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static boolean subflow_check_data_avail(Ptr<sock> ssk) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<mptcp_subflow_context> subflow_create_ctx(Ptr<sock> sk,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void subflow_data_ready(Ptr<sock> sk) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void subflow_error_report(Ptr<sock> ssk) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int subflow_get_info(Ptr<sock> sk, Ptr<sk_buff> skb, boolean net_admin) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int subflow_ops_init(Ptr<request_sock_ops> subflow_ops) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int subflow_rebuild_header(Ptr<sock> sk) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void subflow_req_destructor(Ptr<request_sock> req) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void subflow_sched_work_if_closed(Ptr<mptcp_sock> msk, Ptr<sock> ssk) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void subflow_state_change(Ptr<sock> sk) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int subflow_ulp_init(Ptr<sock> sk) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void subflow_ulp_release(Ptr<sock> ssk) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int subflow_v4_conn_request(Ptr<sock> sk, Ptr<sk_buff> skb) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void subflow_v4_req_destructor(Ptr<request_sock> req) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int subflow_v6_conn_request(Ptr<sock> sk, Ptr<sk_buff> skb) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int subflow_v6_rebuild_header(Ptr<sock> sk) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void subflow_v6_req_destructor(Ptr<request_sock> req) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void subflow_write_space(Ptr<sock> ssk) {
    throw new MethodIsBPFRelatedFunction();
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct subflow_send_info"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class subflow_send_info extends Struct {
    public Ptr<sock> ssk;

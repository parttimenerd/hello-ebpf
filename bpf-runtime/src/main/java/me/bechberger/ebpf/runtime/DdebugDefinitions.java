...
/**
 * Generated class for BPF runtime types that start with ddebug
 */
...
public final class DdebugDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int ddebug_module_notify(Ptr<notifier_block> self, @Unsigned long val,
      Ptr<?> data) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<?> ddebug_proc_next(Ptr<seq_file> m, Ptr<?> p,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int ddebug_proc_open(Ptr<inode> inode, Ptr<file> file) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int ddebug_proc_show(Ptr<seq_file> m, Ptr<?> p) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<?> ddebug_proc_start(Ptr<seq_file> m,
      Ptr<java.lang. @OriginalName("loff_t") Long> pos) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void ddebug_proc_stop(Ptr<seq_file> m, Ptr<?> p) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @Type(
      ...
      cType = "struct ddebug_class_map"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class ddebug_class_map extends Struct {
    ...
    public class_map_type map_type;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct _ddebug_info"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class _ddebug_info extends Struct {
    public Ptr<_ddebug> descs;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct ddebug_class_param"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class ddebug_class_param extends Struct {
    @InlineUnion(34384)
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct ddebug_table"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class ddebug_table extends Struct {
    public list_head link;
    ...
    public Ptr<_ddebug> ddebugs;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct ddebug_query"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class ddebug_query extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct ddebug_iter"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class ddebug_iter extends Struct {

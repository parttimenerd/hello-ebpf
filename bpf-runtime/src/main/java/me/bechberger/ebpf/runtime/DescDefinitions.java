...
/**
 * Generated class for BPF runtime types that start with desc
 */
@java.lang.SuppressWarnings("unused")
public final class DescDefinitions {
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void desc_free_label(Ptr<callback_head> rh) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static desc_state desc_read(Ptr<prb_desc_ring> desc_ring, @Unsigned long id,
      Ptr<prb_desc> desc_out, Ptr<java.lang. @Unsigned Long> seq_out,
      Ptr<java.lang. @Unsigned Integer> caller_id_out) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int desc_read_finalized_seq(Ptr<prb_desc_ring> desc_ring, @Unsigned long id,
      @Unsigned long seq, Ptr<prb_desc> desc_out) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static boolean desc_reserve(Ptr<printk_ringbuffer> rb,
      Ptr<java.lang. @Unsigned Long> id_out) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void desc_update_last_finalized(Ptr<printk_ringbuffer> rb) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  public enum desc_state implements Enum<desc_state>, TypedEnum<desc_state, java.lang.Integer> {
    /**
     * {@code desc_miss = -1}
     */
    @EnumMember(

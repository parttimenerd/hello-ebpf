...
/**
 * Generated class for BPF runtime types that start with faux
 */
@java.lang.SuppressWarnings("unused")
public final class FauxDefinitions {
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int faux_bus_init() {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void faux_device_destroy(Ptr<faux_device> faux_dev) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void faux_device_release(Ptr<device> dev) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int faux_probe(Ptr<device> dev) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void faux_remove(Ptr<device> dev) {
    throw new MethodIsBPFRelatedFunction();
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct faux_device"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class faux_device extends Struct {
    public device dev;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct faux_device_ops"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class faux_device_ops extends Struct {
    public Ptr<?> probe;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct faux_object"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class faux_object extends Struct {
    public faux_device faux_dev;

    public Ptr<faux_device_ops> faux_ops;

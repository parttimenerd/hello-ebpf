...
/**
 * Generated class for BPF runtime types that start with synth
 */
...
public final class SynthDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int __synth_event_show(Ptr<seq_file> m, Ptr<synth_event> event) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int synth_event_add_fields(Ptr<dynevent_cmd> cmd, Ptr<synth_field_desc> fields,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int synth_event_add_next_val(@Unsigned long val,
      Ptr<synth_event_trace_state> trace_state) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void synth_event_cmd_init(Ptr<dynevent_cmd> cmd, String buf, int maxlen) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int synth_event_define_fields(Ptr<trace_event_call> call) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static boolean synth_event_is_busy(Ptr<dyn_event> ev) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int synth_event_reg(Ptr<trace_event_call> call, trace_reg type, Ptr<?> data) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int synth_event_release(Ptr<dyn_event> ev) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int synth_event_run_command(Ptr<dynevent_cmd> cmd) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int synth_event_show(Ptr<seq_file> m, Ptr<dyn_event> ev) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int synth_event_trace(Ptr<trace_event_file> file, @Unsigned int n_vals,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int synth_event_trace_array(Ptr<trace_event_file> file,
      Ptr<java.lang. @Unsigned Long> vals, @Unsigned int n_vals) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int synth_event_trace_start(Ptr<trace_event_file> file,
      Ptr<synth_event_trace_state> trace_state) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int synth_events_open(Ptr<inode> inode, Ptr<file> file) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int synth_events_seq_show(Ptr<seq_file> m, Ptr<?> v) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction("((const u8*)synth_field_fmt($arg1))")
  public static String synth_field_fmt(String type) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int synth_field_size(String type) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int synth_field_string_size(String type) {
    throw new MethodIsBPFRelatedFunction();
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct synth_field_desc"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class synth_field_desc extends Struct {
    public String type;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct synth_event_trace_state"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class synth_event_trace_state extends Struct {
    public trace_event_buffer fbuffer;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct synth_trace_event"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class synth_trace_event extends Struct {
    public trace_entry ent;

    public trace_synth_field @Size(0) [] fields;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct synth_event"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class synth_event extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct synth_field"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class synth_field extends Struct {
    public String type;

...
/**
 * Generated class for BPF runtime types that start with asymmetric
 */
...
public final class AsymmetricDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void asymmetric_key_destroy(Ptr<key> key) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void asymmetric_key_free_preparse(Ptr<key_preparsed_payload> prep) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void asymmetric_key_match_free(Ptr<key_match_data> match_data) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int asymmetric_key_match_preparse(Ptr<key_match_data> match_data) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int asymmetric_key_preparse(Ptr<key_preparsed_payload> prep) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @Type(
      ...
      cType = "struct asymmetric_key_id"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class asymmetric_key_id extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "enum asymmetric_payload_bits"
  )
  public enum asymmetric_payload_bits implements Enum<asymmetric_payload_bits>, TypedEnum<asymmetric_payload_bits, java.lang. @Unsigned Integer> {
    /**
     * {@code asym_crypto = 0}
     */
    @EnumMember(
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct asymmetric_key_ids"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class asymmetric_key_ids extends Struct {
    public Ptr<?> @Size(3) [] id;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct asymmetric_key_subtype"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class asymmetric_key_subtype extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct asymmetric_key_parser"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class asymmetric_key_parser extends Struct {

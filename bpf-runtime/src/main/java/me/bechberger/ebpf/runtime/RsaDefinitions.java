...
/**
 * Generated class for BPF runtime types that start with rsa
 */
@java.lang.SuppressWarnings("unused")
public final class RsaDefinitions {
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int __rsa_enable(Ptr<uart_8250_port> up) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void rsa_autoconfig(Ptr<uart_8250_port> up) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int rsa_check_payload(@OriginalName("MPI") Ptr<gcry_mpi> x,
      @OriginalName("MPI") Ptr<gcry_mpi> n) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int rsa_dec(Ptr<akcipher_request> req) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void rsa_disable(Ptr<uart_8250_port> up) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void rsa_enable(Ptr<uart_8250_port> up) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int rsa_enc(Ptr<akcipher_request> req) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void rsa_exit_tfm(Ptr<crypto_akcipher> tfm) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void rsa_free_mpi_key(Ptr<rsa_mpi_key> key) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @Unsigned int rsa_max_size(Ptr<crypto_akcipher> tfm) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void rsa_reset(Ptr<uart_8250_port> up) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @Type(
      ...
      cType = "struct rsa_key"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class rsa_key extends Struct {
    public Ptr<java.lang.Character> n;

    public Ptr<java.lang.Character> e;

    public Ptr<java.lang.Character> d;

    public Ptr<java.lang.Character> p;

    public Ptr<java.lang.Character> q;

    public Ptr<java.lang.Character> dp;

    public Ptr<java.lang.Character> dq;

    public Ptr<java.lang.Character> qinv;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct rsa_mpi_key"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class rsa_mpi_key extends Struct {
    public @OriginalName("MPI") Ptr<gcry_mpi> n;

    public @OriginalName("MPI") Ptr<gcry_mpi> e;

    public @OriginalName("MPI") Ptr<gcry_mpi> d;

    public @OriginalName("MPI") Ptr<gcry_mpi> p;

    public @OriginalName("MPI") Ptr<gcry_mpi> q;

    public @OriginalName("MPI") Ptr<gcry_mpi> dp;

    public @OriginalName("MPI") Ptr<gcry_mpi> dq;

    public @OriginalName("MPI") Ptr<gcry_mpi> qinv;
  }
}

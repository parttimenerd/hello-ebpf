...
/**
 * Generated class for BPF runtime types that start with sfp
 */
@java.lang.SuppressWarnings("unused")
public final class SfpDefinitions {
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int sfp_add_phy(Ptr<sfp_bus> bus, Ptr<phy_device> phydev) {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int sfp_get_module_eeprom(Ptr<sfp_bus> bus, Ptr<ethtool_eeprom> ee,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int sfp_get_module_info(Ptr<sfp_bus> bus, Ptr<ethtool_modinfo> modinfo) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction("((const u8*)sfp_get_name($arg1))")
  ...
  @Type(
      ...
      cType = "struct sfp_eeprom_base"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class sfp_eeprom_base extends Struct {
    public char phys_id;
    ...
    public char @Size(6) [] link_len;

    public char @Size(16) [] vendor_name;

    public char extended_cc;

    public char @Size(3) [] vendor_oui;

    public char @Size(16) [] vendor_pn;

    public char @Size(4) [] vendor_rev;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct sfp_eeprom_ext"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class sfp_eeprom_ext extends Struct {
    public @Unsigned @OriginalName("__be16") short options;

    public char br_max;

    public char br_min;

    public char @Size(16) [] vendor_sn;

    public char @Size(8) [] datecode;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct sfp_eeprom_id"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class sfp_eeprom_id extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct sfp_upstream_ops"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class sfp_upstream_ops extends Struct {
    public Ptr<?> attach;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct sfp_bus"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class sfp_bus extends Struct {
    public kref kref;
    ...
    public Ptr<device> sfp_dev;

    public @OriginalName("sfp") Ptr<?> sfp;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct sfp_quirk"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class sfp_quirk extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct sfp_socket_ops"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class sfp_socket_ops extends Struct {
    public Ptr<?> attach;

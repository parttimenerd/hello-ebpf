...
/**
 * Generated class for BPF runtime types that start with bsg
 */
@java.lang.SuppressWarnings("unused")
public final class BsgDefinitions {
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void bsg_complete(Ptr<request> rq) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void bsg_device_release(Ptr<device> dev) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void bsg_exit_rq(Ptr<blk_mq_tag_set> set, Ptr<request> req,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int bsg_init_rq(Ptr<blk_mq_tag_set> set, Ptr<request> req, @Unsigned int hctx_idx,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static long bsg_ioctl(Ptr<file> file, @Unsigned int cmd, @Unsigned long arg) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void bsg_job_done(Ptr<bsg_job> job, int result,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int bsg_map_buffer(Ptr<bsg_buffer> buf, Ptr<request> req) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int bsg_open(Ptr<inode> inode, Ptr<file> file) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int bsg_release(Ptr<inode> inode, Ptr<file> file) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void bsg_remove_queue(Ptr<request_queue> q) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int bsg_transport_sg_io_fn(Ptr<request_queue> q, Ptr<sg_io_v4> hdr,
  ...
  @Type(
      ...
      cType = "struct bsg_device"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class bsg_device extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct bsg_job"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class bsg_job extends Struct {
    ...
    public Ptr<request> bidi_rq;

    public Ptr<bio> bidi_bio;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct bsg_buffer"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class bsg_buffer extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct bsg_set"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class bsg_set extends Struct {

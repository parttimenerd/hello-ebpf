...
/**
 * Generated class for BPF runtime types that start with config
 */
...
public final class ConfigDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void config_intr(Ptr<virtio_device> vdev) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long config_key_description_show(Ptr<config_item> item,
      String page) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void config_key_release(Ptr<config_item> item) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long config_keys_count_show(Ptr<config_item> item,
      String page) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long config_keys_restore_show(Ptr<config_item> item,
      String page) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long config_keys_reuse_show(Ptr<config_item> item,
      String page) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long config_table_show(Ptr<kobject> kobj,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void config_work_handler(Ptr<work_struct> work) {
    throw new MethodIsBPFRelatedFunction();
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct config_item"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class config_item extends Struct {
    public String ci_name;

    public char @Size(20) [] ci_namebuf;

    public kref ci_kref;

    public list_head ci_entry;
    ...
    public Ptr<dentry> ci_dentry;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct config_group"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class config_group extends Struct {
    public config_item cg_item;

    public list_head cg_children;

    public Ptr<configfs_subsystem> cg_subsys;

    public list_head default_groups;

    public list_head group_entry;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct config_item_type"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class config_item_type extends Struct {
    public Ptr<module> ct_owner;

    public Ptr<configfs_item_operations> ct_item_ops;

    public Ptr<configfs_group_operations> ct_group_ops;

    public Ptr<Ptr<configfs_attribute>> ct_attrs;

    public Ptr<Ptr<configfs_bin_attribute>> ct_bin_attrs;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct config_key"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class config_key extends Struct {
    public config_item item;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct config_s"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class config_s extends Struct {
    public @Unsigned @OriginalName("ush") short good_length;

    public @Unsigned @OriginalName("ush") short max_lazy;

    public @Unsigned @OriginalName("ush") short nice_length;

    public @Unsigned @OriginalName("ush") short max_chain;

    public @OriginalName("compress_func") Ptr<?> func;
  }
}

...
/**
 * Generated class for BPF runtime types that start with utf8
 */
...
public final class Utf8Definitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<unicode_map> utf8_load(@Unsigned int version) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int utf8_parse_version(String version) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void utf8_unload(Ptr<unicode_map> um) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @Type(
      ...
      cType = "enum utf8_normalization"
  )
  public enum utf8_normalization implements Enum<utf8_normalization>, TypedEnum<utf8_normalization, java.lang. @Unsigned Integer> {
    /**
     * {@code UTF8_NFDI = 0}
     */
    @EnumMember(
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct utf8_table"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class utf8_table extends Struct {
    public int cmask;

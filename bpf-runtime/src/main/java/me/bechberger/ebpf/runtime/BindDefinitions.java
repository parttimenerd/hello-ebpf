...
/**
 * Generated class for BPF runtime types that start with bind
 */
@java.lang.SuppressWarnings("unused")
public final class BindDefinitions {
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void bind_evtchn_to_cpu(Ptr<irq_info> info, @Unsigned int cpu,
      boolean force_affinity) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int bind_evtchn_to_irq(@Unsigned @OriginalName("evtchn_port_t") int evtchn) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int bind_evtchn_to_irq_chip(@Unsigned @OriginalName("evtchn_port_t") int evtchn,
      Ptr<irq_chip> chip, Ptr<xenbus_device> dev, boolean shared) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int bind_evtchn_to_irq_lateeoi(
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int bind_interdomain_evtchn_to_irq_lateeoi(Ptr<xenbus_device> dev,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long bind_mode_show(Ptr<device_driver> drv, String buf) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int bind_rdev_to_array(Ptr<md_rdev> rdev, Ptr<mddev> mddev) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int bind_virq_to_irq(@Unsigned int virq, @Unsigned int cpu, boolean percpu) {
    throw new MethodIsBPFRelatedFunction();
  }

...
/**
 * Generated class for BPF runtime types that start with radix
 */
@java.lang.SuppressWarnings("unused")
public final class RadixDefinitions {
  @NotUsableInJava
  @BuiltinBPFFunction
  public static boolean __radix_tree_delete(Ptr<xarray> root, Ptr<xa_node> node, Ptr<Ptr<?>> slot) {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int __radix_tree_preload(@Unsigned @OriginalName("gfp_t") int gfp_mask,
      @Unsigned int nr) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void __radix_tree_replace(Ptr<xarray> root, Ptr<xa_node> node, Ptr<Ptr<?>> slot,
      Ptr<?> item) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int radix_tree_cpu_dead(@Unsigned int cpu) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<?> radix_tree_delete(Ptr<xarray> root, @Unsigned long index) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<?> radix_tree_delete_item(Ptr<xarray> root, @Unsigned long index, Ptr<?> item) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int radix_tree_extend(Ptr<xarray> root, @Unsigned @OriginalName("gfp_t") int gfp,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int radix_tree_insert(Ptr<xarray> root, @Unsigned long index, Ptr<?> item) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void radix_tree_iter_delete(Ptr<xarray> root, Ptr<radix_tree_iter> iter,
      Ptr<Ptr<?>> slot) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<Ptr<?>> radix_tree_iter_resume(Ptr<Ptr<?>> slot, Ptr<radix_tree_iter> iter) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int radix_tree_maybe_preload(@Unsigned @OriginalName("gfp_t") int gfp_mask) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<xa_node> radix_tree_node_alloc(@Unsigned @OriginalName("gfp_t") int gfp_mask,
      Ptr<xa_node> parent, Ptr<xarray> root, @Unsigned int shift, @Unsigned int offset,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void radix_tree_node_ctor(Ptr<?> arg) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void radix_tree_node_rcu_free(Ptr<callback_head> head) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void radix_tree_replace_slot(Ptr<xarray> root, Ptr<Ptr<?>> slot, Ptr<?> item) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<?> radix_tree_tag_clear(Ptr<xarray> root, @Unsigned long index,
      @Unsigned int tag) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<?> radix_tree_tag_set(Ptr<xarray> root, @Unsigned long index,
      @Unsigned int tag) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @Type(
      ...
      cType = "struct radix_tree_preload"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class radix_tree_preload extends Struct {
    public @OriginalName("local_lock_t") lockdep_map_p lock;

    public @Unsigned int nr;

    public Ptr<xa_node> nodes;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct radix_tree_iter"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class radix_tree_iter extends Struct {

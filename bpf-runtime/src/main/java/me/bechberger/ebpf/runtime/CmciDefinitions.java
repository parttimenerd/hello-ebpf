...
/**
 * Generated class for BPF runtime types that start with cmci
 */
...
public final class CmciDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void cmci_rediscover_work_func(Ptr<?> arg) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static boolean cmci_supported(Ptr<java.lang.Integer> banks) {
    throw new MethodIsBPFRelatedFunction();
  }
}

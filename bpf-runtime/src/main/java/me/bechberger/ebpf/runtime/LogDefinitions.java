...
/**
 * Generated class for BPF runtime types that start with log
 */
@java.lang.SuppressWarnings("unused")
public final class LogDefinitions {
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void __log_error(@Unsigned int bank, @Unsigned long status, @Unsigned long addr,
      @Unsigned long misc) {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static boolean _log_error_deferred(@Unsigned int bank, @Unsigned int misc) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void log_and_reset_block(Ptr<threshold_block> block) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction("log_arm_hw_error($arg1, (const u8)$arg2)")
  public static void log_arm_hw_error(Ptr<cper_sec_proc_arm> err, char sev) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long log_entry_type_show(Ptr<device> ras_feat_dev,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long log_zero_flags_show(Ptr<device> dev,
      Ptr<device_attribute> attr, String buf) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @Type(
      ...
      cType = "struct { u8 level; u8 logflags; }"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class log_of_u_of_nf_loginfo extends Struct {
    public @OriginalName("u_int8_t") char level;

    public @OriginalName("u_int8_t") char logflags;
  }
}

...
/**
 * Generated class for BPF runtime types that start with cmp
 */
@java.lang.SuppressWarnings("unused")
public final class CmpDefinitions {
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void cmp_and_merge_page(Ptr<page> page, Ptr<ksm_rmap_item> rmap_item) {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int cmp_dev(Ptr<device> dev, Ptr<?> data) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int cmp_nla_bpf(Ptr<seg6_local_lwt> a, Ptr<seg6_local_lwt> b) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int cmp_nla_counters(Ptr<seg6_local_lwt> a, Ptr<seg6_local_lwt> b) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int cmp_nla_flavors(Ptr<seg6_local_lwt> a, Ptr<seg6_local_lwt> b) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int cmp_nla_iif(Ptr<seg6_local_lwt> a, Ptr<seg6_local_lwt> b) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int cmp_nla_nh4(Ptr<seg6_local_lwt> a, Ptr<seg6_local_lwt> b) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int cmp_nla_nh6(Ptr<seg6_local_lwt> a, Ptr<seg6_local_lwt> b) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int cmp_nla_oif(Ptr<seg6_local_lwt> a, Ptr<seg6_local_lwt> b) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int cmp_nla_srh(Ptr<seg6_local_lwt> a, Ptr<seg6_local_lwt> b) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int cmp_nla_table(Ptr<seg6_local_lwt> a, Ptr<seg6_local_lwt> b) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int cmp_nla_vrftable(Ptr<seg6_local_lwt> a, Ptr<seg6_local_lwt> b) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @Type(
      ...
      cType = "struct __cmp_key"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class __cmp_key extends Struct {
    public Ptr<cpumask> cpus;

    public Ptr<Ptr<Ptr<cpumask>>> masks;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct cmp_data"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class cmp_data extends Struct {
    public Ptr<task_struct> thr;

    public Ptr<crypto_acomp> cc;

    public Ptr<acomp_req> cr;

    public atomic_t ready;

    public atomic_t stop;

    public int ret;

    public @OriginalName("wait_queue_head_t") wait_queue_head go;

    public @OriginalName("wait_queue_head_t") wait_queue_head done;

    public @Unsigned long unc_len;

    public @Unsigned long cmp_len;

    public char @Size(131072) [] unc;

    public char @Size(143360) [] cmp;
  }
}

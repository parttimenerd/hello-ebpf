...
/**
 * Generated class for BPF runtime types that start with pwm
 */
...
public final class PwmDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void __pwm_put(Ptr<pwm_device> pwm) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int __pwm_read_waveform(Ptr<pwm_chip> chip, Ptr<pwm_device> pwm, Ptr<?> wfhw) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static long pwm_cdev_ioctl(Ptr<file> file, @Unsigned int cmd, @Unsigned long arg) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int pwm_cdev_open(Ptr<inode> inode, Ptr<file> file) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int pwm_cdev_release(Ptr<inode> inode, Ptr<file> file) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<pwm_export> pwm_class_get_state(Ptr<device> pwmchip_dev, Ptr<pwm_device> pwm,
      Ptr<pwm_state> state) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int pwm_class_resume(Ptr<device> pwmchip_dev) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int pwm_class_resume_npwm(Ptr<device> pwmchip_dev, @Unsigned int npwm) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int pwm_class_suspend(Ptr<device> pwmchip_dev) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void pwm_dbg_show(Ptr<pwm_chip> chip, Ptr<seq_file> s) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int pwm_debugfs_open(Ptr<inode> inode, Ptr<file> file) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void pwm_export_release(Ptr<device> pwm_dev) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int pwm_get_state_hw(Ptr<pwm_device> pwm, Ptr<pwm_state> state) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int pwm_get_waveform_might_sleep(Ptr<pwm_device> pwm, Ptr<pwm_waveform> wf) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int pwm_lpss_get_state(Ptr<pwm_chip> chip, Ptr<pwm_device> pwm,
      Ptr<pwm_state> state) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int pwm_lpss_probe_platform(Ptr<platform_device> pdev) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void pwm_lpss_remove_pci(Ptr<pci_dev> pdev) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int pwm_round_waveform_might_sleep(Ptr<pwm_device> pwm, Ptr<pwm_waveform> wf) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<?> pwm_seq_next(Ptr<seq_file> s, Ptr<?> v,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int pwm_seq_show(Ptr<seq_file> s, Ptr<?> v) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<?> pwm_seq_start(Ptr<seq_file> s,
      Ptr<java.lang. @OriginalName("loff_t") Long> pos) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void pwm_seq_stop(Ptr<seq_file> s, Ptr<?> v) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int pwm_unexport_child(Ptr<device> pwmchip_dev, Ptr<pwm_device> pwm) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @Type(
      ...
      cType = "struct pwm_lpss_boardinfo"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class pwm_lpss_boardinfo extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "enum pwm_polarity"
  )
  public enum pwm_polarity implements Enum<pwm_polarity>, TypedEnum<pwm_polarity, java.lang. @Unsigned Integer> {
    /**
     * {@code PWM_POLARITY_NORMAL = 0}
     */
    @EnumMember(
        value = 0L,
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct pwm_args"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class pwm_args extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct pwm_waveform"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class pwm_waveform extends Struct {
    public @Unsigned long period_length_ns;

    public @Unsigned long duty_length_ns;

    public @Unsigned long duty_offset_ns;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct pwm_state"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class pwm_state extends Struct {
    public @Unsigned long period;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct pwm_device"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class pwm_device extends Struct {
    public String label;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct pwm_chip"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class pwm_chip extends Struct {
    public device dev;
    ...
    public pwm_device @Size(0) [] pwms;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct pwm_capture"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class pwm_capture extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct pwm_ops"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class pwm_ops extends Struct {
    public Ptr<?> request;
    ...
    public @Unsigned long sizeof_wfhw;

    public Ptr<?> round_waveform_tohw;

    public Ptr<?> round_waveform_fromhw;

    public Ptr<?> read_waveform;

    public Ptr<?> write_waveform;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct pwm_lookup"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class pwm_lookup extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct pwm_export"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class pwm_export extends Struct {
    public device pwm_dev;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct pwm_cdev_data"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class pwm_cdev_data extends Struct {
    public Ptr<pwm_chip> chip;

    public Ptr<pwm_device> @Size(0) [] pwm;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct pwm_lpss_chip"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class pwm_lpss_chip extends Struct {
    public Ptr<?> regs;

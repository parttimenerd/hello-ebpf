...
/**
 * Generated class for BPF runtime types that start with nvmem
 */
@java.lang.SuppressWarnings("unused")
public final class NvmemDefinitions {
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int __nvmem_cell_entry_write(Ptr<nvmem_cell_entry> cell, Ptr<?> buf,
      @Unsigned long len) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction("__nvmem_device_get($arg1, (int (*)(struct device*, const void*))$arg2)")
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int nvmem_access_with_keepouts(Ptr<nvmem_device> nvmem, @Unsigned int offset,
      Ptr<?> val, @Unsigned long bytes, int write) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void nvmem_add_cell_lookups(Ptr<nvmem_cell_lookup> entries,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @Unsigned @OriginalName("umode_t") short nvmem_attr_is_visible(Ptr<kobject> kobj,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @Unsigned @OriginalName("umode_t") short nvmem_bin_attr_get_umode(
      Ptr<nvmem_device> nvmem) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<?> nvmem_cell_prepare_write_buffer(Ptr<nvmem_cell_entry> cell,
      Ptr<java.lang.Character> _buf, int len) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<?> nvmem_cell_read(Ptr<nvmem_cell> cell, Ptr<java.lang. @Unsigned Long> len) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void nvmem_del_cell_lookups(Ptr<nvmem_cell_lookup> entries,
      @Unsigned long nentries) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction("((const u8*)nvmem_dev_name($arg1))")
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long nvmem_device_cell_read(Ptr<nvmem_device> nvmem,
      Ptr<nvmem_cell_info> info, Ptr<?> buf) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int nvmem_device_cell_write(Ptr<nvmem_device> nvmem, Ptr<nvmem_cell_info> info,
      Ptr<?> buf) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction("nvmem_device_find($arg1, (int (*)(struct device*, const void*))$arg2)")
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int nvmem_device_read(Ptr<nvmem_device> nvmem, @Unsigned int offset,
      @Unsigned long bytes, Ptr<?> buf) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int nvmem_device_write(Ptr<nvmem_device> nvmem, @Unsigned int offset,
      @Unsigned long bytes, Ptr<?> buf) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int nvmem_get_mac_address(Ptr<device> dev, Ptr<?> addrbuf) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int nvmem_reg_read(Ptr<nvmem_device> nvmem, @Unsigned int offset, Ptr<?> val,
      @Unsigned long bytes) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int nvmem_register_notifier(Ptr<notifier_block> nb) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void nvmem_release(Ptr<device> dev) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int nvmem_unregister_notifier(Ptr<notifier_block> nb) {
    throw new MethodIsBPFRelatedFunction();
  }

  @Type(
      noCCodeGeneration = true,
      cType = "enum nvmem_type"
  )
  public enum nvmem_type implements Enum<nvmem_type>, TypedEnum<nvmem_type, java.lang. @Unsigned Integer> {
    /**
     * {@code NVMEM_TYPE_UNKNOWN = 0}
     */
    @EnumMember(
        value = 0L,
    ...
    /**
     * {@code NVMEM_TYPE_BATTERY_BACKED = 3}
     */
    @EnumMember(
        value = 3L,
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct nvmem_keepout"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class nvmem_keepout extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct nvmem_cell_info"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class nvmem_cell_info extends Struct {
    public String name;
    ...
    public @OriginalName("nvmem_cell_post_process_t") Ptr<?> read_post_process;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct nvmem_config"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class nvmem_config extends Struct {
    ...
    public @OriginalName("nvmem_reg_read_t") Ptr<?> reg_read;

    public @OriginalName("nvmem_reg_write_t") Ptr<?> reg_write;
    ...
    public Ptr<device> base_dev;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct nvmem_layout"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class nvmem_layout extends Struct {
    public device dev;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct nvmem_cell_lookup"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class nvmem_cell_lookup extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct nvmem_device"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class nvmem_device extends Struct {
    public Ptr<module> owner;
    ...
    public bin_attribute eeprom;

    public Ptr<device> base_dev;

    public list_head cells;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct nvmem_cell_entry"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class nvmem_cell_entry extends Struct {
    public String name;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct nvmem_cell"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class nvmem_cell extends Struct {

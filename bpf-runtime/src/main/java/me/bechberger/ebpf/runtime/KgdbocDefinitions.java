...
/**
 * Generated class for BPF runtime types that start with kgdboc
 */
...
public final class KgdbocDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int kgdboc_earlycon_deferred_exit(Ptr<console> con) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int kgdboc_probe(Ptr<platform_device> pdev) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void kgdboc_queue_restore_input_helper(Ptr<irq_work> unused) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void kgdboc_reset_disconnect(Ptr<input_handle> handle) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void kgdboc_restore_input_helper(Ptr<work_struct> dummy) {
    throw new MethodIsBPFRelatedFunction();
  }

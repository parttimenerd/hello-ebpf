...
/**
 * Generated class for BPF runtime types that start with dax
 */
...
public final class DaxDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int __dax_invalidate_entry(Ptr<address_space> mapping, @Unsigned long index,
      boolean trunc) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int dax_add_host(Ptr<dax_device> dax_dev, Ptr<gendisk> disk) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<inode> dax_alloc_inode(Ptr<super_block> sb) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction("dax_break_layout($arg1, $arg2, $arg3, (void (*)(struct inode*))$arg4)")
  public static int dax_break_layout(Ptr<inode> inode, @OriginalName("loff_t") long start,
      @OriginalName("loff_t") long end, Ptr<?> cb) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void dax_break_layout_final(Ptr<inode> inode) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int dax_bus_probe(Ptr<device> dev) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void dax_bus_remove(Ptr<device> dev) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @Unsigned long dax_copy_from_iter(Ptr<dax_device> dax_dev, @Unsigned long pgoff,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @Unsigned long dax_copy_to_iter(Ptr<dax_device> dax_dev, @Unsigned long pgoff,
      Ptr<?> addr, @Unsigned long bytes, Ptr<iov_iter> i) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int dax_delete_mapping_entry(Ptr<address_space> mapping, @Unsigned long index) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void dax_delete_mapping_range(Ptr<address_space> mapping,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void dax_destroy_inode(Ptr<inode> inode) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static long dax_direct_access(Ptr<dax_device> dax_dev, @Unsigned long pgoff, long nr_pages,
      dax_access_mode mode, Ptr<Ptr<?>> kaddr, Ptr<java.lang. @Unsigned Long> pfn) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @Unsigned @OriginalName("vm_fault_t") int dax_finish_sync_fault(Ptr<vm_fault> vmf,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void dax_flush(Ptr<dax_device> dax_dev, Ptr<?> addr, @Unsigned long size) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static @Unsigned long dax_folio_put(Ptr<folio> folio) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void dax_free_inode(Ptr<inode> inode) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int dax_holder_notify_failure(Ptr<dax_device> dax_dev, @Unsigned long off,
      @Unsigned long len, int mf_flags) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int dax_init_fs_context(Ptr<fs_context> fc) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<inode> dax_inode(Ptr<dax_device> dax_dev) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @Unsigned @OriginalName("vm_fault_t") int dax_insert_pfn_mkwrite(Ptr<vm_fault> vmf,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int dax_invalidate_mapping_entry_sync(Ptr<address_space> mapping,
      @Unsigned long index) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int dax_iomap_iter(Ptr<iomap_iter> iomi, Ptr<iov_iter> iter) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<page> dax_layout_busy_page(Ptr<address_space> mapping) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<page> dax_layout_busy_page_range(Ptr<address_space> mapping,
      @OriginalName("loff_t") long start, @OriginalName("loff_t") long end) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @Unsigned @OriginalName("dax_entry_t") long dax_lock_folio(Ptr<folio> folio) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static @Unsigned @OriginalName("dax_entry_t") long dax_lock_mapping_entry(
      Ptr<address_space> mapping, @Unsigned long index, Ptr<Ptr<page>> page) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void dax_mapping_release(Ptr<device> dev) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int dax_range_compare_iter(Ptr<iomap_iter> it_src, Ptr<iomap_iter> it_dest,
      @Unsigned long len, Ptr<java.lang. @OriginalName("bool") Boolean> same) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @Unsigned long dax_recovery_write(Ptr<dax_device> dax_dev, @Unsigned long pgoff,
      Ptr<?> addr, @Unsigned long bytes, Ptr<iov_iter> iter) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void dax_region_unregister(Ptr<?> region) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static @Unsigned @OriginalName("umode_t") short dax_region_visible(Ptr<kobject> kobj,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void dax_remove_host(Ptr<gendisk> disk) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long dax_seed_show(Ptr<device> dev,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int dax_set(Ptr<inode> inode, Ptr<?> data) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int dax_test(Ptr<inode> inode, Ptr<?> data) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<folio> dax_to_folio(Ptr<?> entry) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void dax_unlock_entry(Ptr<xa_state> xas, Ptr<?> entry) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void dax_unlock_folio(Ptr<folio> folio,
      @Unsigned @OriginalName("dax_entry_t") long cookie) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void dax_unlock_mapping_entry(Ptr<address_space> mapping, @Unsigned long index,
      @Unsigned @OriginalName("dax_entry_t") long cookie) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int dax_unshare_iter(Ptr<iomap_iter> iter) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void dax_wake_entry(Ptr<xa_state> xas, Ptr<?> entry, dax_wake_mode mode) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int dax_writeback_mapping_range(Ptr<address_space> mapping, Ptr<dax_device> dax_dev,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int dax_writeback_one(Ptr<xa_state> xas, Ptr<dax_device> dax_dev,
      Ptr<address_space> mapping, Ptr<?> entry) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int dax_zero_page_range(Ptr<dax_device> dax_dev, @Unsigned long pgoff,
  ...
  @Type(
      ...
      cType = "enum dax_access_mode"
  )
  public enum dax_access_mode implements Enum<dax_access_mode>, TypedEnum<dax_access_mode, java.lang. @Unsigned Integer> {
    /**
     * {@code DAX_ACCESS = 0}
     */
    @EnumMember(
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "enum dax_wake_mode"
  )
  public enum dax_wake_mode implements Enum<dax_wake_mode>, TypedEnum<dax_wake_mode, java.lang. @Unsigned Integer> {
    /**
     * {@code WAKE_ALL = 0}
     */
    @EnumMember(
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct dax_holder_operations"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class dax_holder_operations extends Struct {
    public Ptr<?> notify_failure;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct dax_operations"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class dax_operations extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct dax_device"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class dax_device extends Struct {
    public inode inode;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "enum dax_device_flags"
  )
  public enum dax_device_flags implements Enum<dax_device_flags>, TypedEnum<dax_device_flags, java.lang. @Unsigned Integer> {
    /**
     * {@code DAXDEV_ALIVE = 0}
     */
    @EnumMember(
    ...
    /**
     * {@code DAXDEV_WRITE_CACHE = 1}
     */
    @EnumMember(
        value = 1L,
        name = "DAXDEV_WRITE_CACHE"
    )
    DAXDEV_WRITE_CACHE,
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct dax_region"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class dax_region extends Struct {
    public int id;
    ...
    public Ptr<device> seed;

    public Ptr<device> youngest;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct dax_mapping"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class dax_mapping extends Struct {
    public device dev;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "enum dax_driver_type"
  )
  public enum dax_driver_type implements Enum<dax_driver_type>, TypedEnum<dax_driver_type, java.lang. @Unsigned Integer> {
    /**
     * {@code DAXDRV_KMEM_TYPE = 0}
     */
    @EnumMember(
        value = 0L,
        name = "DAXDRV_KMEM_TYPE"
    )
    DAXDRV_KMEM_TYPE,

    /**
     * {@code DAXDRV_DEVICE_TYPE = 1}
     */
    @EnumMember(
        value = 1L,
        name = "DAXDRV_DEVICE_TYPE"
    )
    DAXDRV_DEVICE_TYPE
  }
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct dax_device_driver"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class dax_device_driver extends Struct {
  ...
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class dax_id extends Struct {
    public list_head list;

    public char @Size(30) [] dev_name;
  }
}

...
/**
 * Generated class for BPF runtime types that start with tpacket
 */
@java.lang.SuppressWarnings("unused")
public final class TpacketDefinitions {
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void tpacket_destruct_skb(Ptr<sk_buff> skb) {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @Unsigned int tpacket_get_timestamp(Ptr<sk_buff> skb, Ptr<timespec64> ts,
      @Unsigned int flags) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int tpacket_rcv(Ptr<sk_buff> skb, Ptr<net_device> dev, Ptr<packet_type> pt,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int tpacket_snd(Ptr<packet_sock> po, Ptr<msghdr> msg) {
    throw new MethodIsBPFRelatedFunction();
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct tpacket_stats"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class tpacket_stats extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct tpacket_stats_v3"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class tpacket_stats_v3 extends Struct {
    public @Unsigned int tp_packets;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct tpacket_rollover_stats"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class tpacket_rollover_stats extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "union tpacket_stats_u"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class tpacket_stats_u extends Union {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct tpacket_auxdata"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class tpacket_auxdata extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct tpacket_hdr"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class tpacket_hdr extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct tpacket_hdr_variant1"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class tpacket_hdr_variant1 extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct tpacket_bd_ts"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class tpacket_bd_ts extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct tpacket_hdr_v1"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class tpacket_hdr_v1 extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "union tpacket_bd_header_u"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class tpacket_bd_header_u extends Union {
    public tpacket_hdr_v1 bh1;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct tpacket_block_desc"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class tpacket_block_desc extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "enum tpacket_versions"
  )
  public enum tpacket_versions implements Enum<tpacket_versions>, TypedEnum<tpacket_versions, java.lang. @Unsigned Integer> {
    /**
     * {@code TPACKET_V1 = 0}
     */
    @EnumMember(
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct tpacket_req"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class tpacket_req extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct tpacket_req3"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class tpacket_req3 extends Struct {
    public @Unsigned int tp_block_size;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "union tpacket_req_u"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class tpacket_req_u extends Union {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct tpacket_kbdq_core"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class tpacket_kbdq_core extends Struct {
    public Ptr<pgv> pkbdq;
    ...
    public @Unsigned @OriginalName("uint64_t") long knxt_seq_num;
    ...
    public rwlock_t blk_fill_in_prog_lock;
    ...
    public timer_list retire_blk_timer;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "union tpacket_uhdr"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class tpacket_uhdr extends Union {
    public Ptr<tpacket_hdr> h1;

    public Ptr<tpacket2_hdr> h2;

    public Ptr<tpacket3_hdr> h3;

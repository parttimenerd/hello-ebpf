...
/**
 * Generated class for BPF runtime types that start with memcpy
 */
...
public final class MemcpyDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long memcpy_count_show(Ptr<device> dev,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @Unsigned long memcpy_from_file_folio(String to, Ptr<folio> folio,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void memcpy_from_scatterwalk(Ptr<?> buf, Ptr<scatter_walk> walk,
      @Unsigned int nbytes) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void memcpy_from_sglist(Ptr<?> buf, Ptr<scatterlist> sg, @Unsigned int start,
      @Unsigned int nbytes) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void memcpy_sglist(Ptr<scatterlist> dst, Ptr<scatterlist> src,
      @Unsigned int nbytes) {
    throw new MethodIsBPFRelatedFunction();
  }

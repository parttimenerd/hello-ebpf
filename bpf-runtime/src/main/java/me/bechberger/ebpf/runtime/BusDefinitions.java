...
/**
 * Generated class for BPF runtime types that start with bus
 */
@java.lang.SuppressWarnings("unused")
public final class BusDefinitions {
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int bus_add_device(Ptr<device> dev) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int bus_add_driver(Ptr<device_driver> drv) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long bus_attr_show(Ptr<kobject> kobj, Ptr<attribute> attr,
      String buf) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static long bus_ioctl(Ptr<file> file, @Unsigned int cmd, @Unsigned long arg) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void bus_lock_init() {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void bus_notify(Ptr<device> dev, bus_notifier_event value) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void bus_probe_device(Ptr<device> dev) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void bus_release(Ptr<kobject> kobj) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void bus_remove_device(Ptr<device> dev) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void bus_remove_driver(Ptr<device_driver> drv) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int bus_rescan_devices_helper(Ptr<device> dev, Ptr<?> data) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @Type(
      ...
      cType = "struct bus_type"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class bus_type extends Struct {
    public String name;

    public String dev_name;

    public Ptr<Ptr<attribute_group>> bus_groups;

    public Ptr<Ptr<attribute_group>> dev_groups;

    public Ptr<Ptr<attribute_group>> drv_groups;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct bus_dma_region"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class bus_dma_region extends Struct {
    public @Unsigned @OriginalName("phys_addr_t") long cpu_start;

    public @Unsigned @OriginalName("dma_addr_t") long dma_start;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "enum bus_notifier_event"
  )
  public enum bus_notifier_event implements Enum<bus_notifier_event>, TypedEnum<bus_notifier_event, java.lang. @Unsigned Integer> {
    /**
     * {@code BUS_NOTIFY_ADD_DEVICE = 0}
     */
    @EnumMember(
        value = 0L,
        name = "BUS_NOTIFY_ADD_DEVICE"
    )
    BUS_NOTIFY_ADD_DEVICE,

    /**
     * {@code BUS_NOTIFY_DEL_DEVICE = 1}
     */
    @EnumMember(
        value = 1L,
        name = "BUS_NOTIFY_DEL_DEVICE"
    )
    BUS_NOTIFY_DEL_DEVICE,

    /**
     * {@code BUS_NOTIFY_REMOVED_DEVICE = 2}
     */
    @EnumMember(
        value = 2L,
        name = "BUS_NOTIFY_REMOVED_DEVICE"
    )
    BUS_NOTIFY_REMOVED_DEVICE,

    /**
     * {@code BUS_NOTIFY_BIND_DRIVER = 3}
     */
    @EnumMember(
        value = 3L,
        name = "BUS_NOTIFY_BIND_DRIVER"
    )
    BUS_NOTIFY_BIND_DRIVER,

    /**
     * {@code BUS_NOTIFY_BOUND_DRIVER = 4}
     */
    @EnumMember(
        value = 4L,
        name = "BUS_NOTIFY_BOUND_DRIVER"
    )
    BUS_NOTIFY_BOUND_DRIVER,

    /**
     * {@code BUS_NOTIFY_UNBIND_DRIVER = 5}
     */
    @EnumMember(
        value = 5L,
        name = "BUS_NOTIFY_UNBIND_DRIVER"
    )
    BUS_NOTIFY_UNBIND_DRIVER,

    /**
     * {@code BUS_NOTIFY_UNBOUND_DRIVER = 6}
     */
    @EnumMember(
        value = 6L,
        name = "BUS_NOTIFY_UNBOUND_DRIVER"
    )
    BUS_NOTIFY_UNBOUND_DRIVER,

    /**
     * {@code BUS_NOTIFY_DRIVER_NOT_BOUND = 7}
     */
    @EnumMember(
        value = 7L,
        name = "BUS_NOTIFY_DRIVER_NOT_BOUND"
    )
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct bus_attribute"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class bus_attribute extends Struct {

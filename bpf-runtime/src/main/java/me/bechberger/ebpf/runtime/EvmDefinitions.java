...
/**
 * Generated class for BPF runtime types that start with evm
 */
...
public final class EvmDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void evm_file_release(Ptr<file> file) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int evm_inode_alloc_security(Ptr<inode> inode) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void evm_inode_post_setattr(Ptr<mnt_idmap> idmap, Ptr<dentry> dentry,
      int ia_valid) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int evm_inode_setattr(Ptr<mnt_idmap> idmap, Ptr<dentry> dentry, Ptr<iattr> attr) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static boolean evm_metadata_changed(Ptr<inode> inode, Ptr<inode> metadata_inode) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void evm_post_path_mknod(Ptr<mnt_idmap> idmap, Ptr<dentry> dentry) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long evm_read_key(Ptr<file> filp, String buf,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int evm_read_protected_xattrs(Ptr<dentry> dentry, Ptr<java.lang.Character> buffer,
      int buffer_size, char type, boolean canonical_fmt) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int evm_set_key(Ptr<?> key, @Unsigned long keylen) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static integrity_status evm_verify_current_integrity(Ptr<dentry> dentry) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @Type(
      ...
      cType = "struct evm_ima_xattr_data_hdr"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class evm_ima_xattr_data_hdr extends Struct {
    public char type;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct evm_ima_xattr_data"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class evm_ima_xattr_data extends Struct {
    @InlineUnion(29111)
    public anon_member_of_anon_member_of_evm_ima_xattr_data anon0$0;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "enum evm_ima_xattr_type"
  )
  public enum evm_ima_xattr_type implements Enum<evm_ima_xattr_type>, TypedEnum<evm_ima_xattr_type, java.lang. @Unsigned Integer> {
    /**
     * {@code IMA_XATTR_DIGEST = 1}
     */
    @EnumMember(
        value = 1L,
        name = "IMA_XATTR_DIGEST"
    )
    IMA_XATTR_DIGEST,

    /**
     * {@code EVM_XATTR_HMAC = 2}
     */
    @EnumMember(
        value = 2L,
        name = "EVM_XATTR_HMAC"
    ...
    /**
     * {@code EVM_IMA_XATTR_DIGSIG = 3}
     */
    @EnumMember(
        value = 3L,
        name = "EVM_IMA_XATTR_DIGSIG"
    )
    EVM_IMA_XATTR_DIGSIG,

    /**
     * {@code IMA_XATTR_DIGEST_NG = 4}
     */
    @EnumMember(
        value = 4L,
        name = "IMA_XATTR_DIGEST_NG"
    )
    IMA_XATTR_DIGEST_NG,

    /**
     * {@code EVM_XATTR_PORTABLE_DIGSIG = 5}
     */
    @EnumMember(
        value = 5L,
        name = "EVM_XATTR_PORTABLE_DIGSIG"
    )
    EVM_XATTR_PORTABLE_DIGSIG,

    /**
     * {@code IMA_VERITY_DIGSIG = 6}
     */
    @EnumMember(
        value = 6L,
        name = "IMA_VERITY_DIGSIG"
    )
    IMA_VERITY_DIGSIG,

    /**
     * {@code IMA_XATTR_LAST = 7}
     */
    @EnumMember(
        value = 7L,
        name = "IMA_XATTR_LAST"
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct evm_xattr"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class evm_xattr extends Struct {
    public evm_ima_xattr_data_hdr data;

    public char @Size(20) [] digest;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct evm_iint_cache"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class evm_iint_cache extends Struct {
    public @Unsigned long flags;

    public integrity_status evm_status;

    public integrity_inode_attributes metadata_inode;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct evm_digest"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class evm_digest extends Struct {

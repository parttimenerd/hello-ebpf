...
/**
 * Generated class for BPF runtime types that start with vring
 */
...
public final class VringDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<?> vring_alloc_queue(Ptr<virtio_device> vdev, @Unsigned long size,
      Ptr<java.lang. @Unsigned @OriginalName("dma_addr_t") Long> dma_handle,
      @Unsigned @OriginalName("gfp_t") int flag, Ptr<device> dma_dev) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int vring_alloc_queue_packed(Ptr<vring_virtqueue_packed> vring_packed,
      Ptr<virtio_device> vdev, @Unsigned int num, Ptr<device> dma_dev) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int vring_alloc_queue_split(Ptr<vring_virtqueue_split> vring_split,
      Ptr<virtio_device> vdev, @Unsigned int num, @Unsigned int vring_align, boolean may_reduce_num,
      Ptr<device> dma_dev) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void vring_del_virtqueue(Ptr<virtqueue> _vq) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void vring_free(Ptr<virtqueue> _vq) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void vring_free_packed(Ptr<vring_virtqueue_packed> vring_packed,
      Ptr<virtio_device> vdev, Ptr<device> dma_dev) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void vring_free_queue(Ptr<virtio_device> vdev, @Unsigned long size, Ptr<?> queue,
      @Unsigned @OriginalName("dma_addr_t") long dma_handle, Ptr<device> dma_dev) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("irqreturn_t") irqreturn vring_interrupt(int irq, Ptr<?> _vq) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @Unsigned int vring_notification_data(Ptr<virtqueue> _vq) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void vring_transport_features(Ptr<virtio_device> vdev) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @Type(
      ...
      cType = "struct vring_desc"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class vring_desc extends Struct {
    public @Unsigned @OriginalName("__virtio64") long addr;

    public @Unsigned @OriginalName("__virtio32") int len;

    public @Unsigned @OriginalName("__virtio16") short flags;

    public @Unsigned @OriginalName("__virtio16") short next;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct vring_avail"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class vring_avail extends Struct {
    public @Unsigned @OriginalName("__virtio16") short flags;

    public @Unsigned @OriginalName("__virtio16") short idx;

    public @Unsigned @OriginalName("__virtio16") short @Size(0) [] ring;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct vring_used_elem"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class vring_used_elem extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct vring_used"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class vring_used extends Struct {
    public @Unsigned @OriginalName("__virtio16") short flags;

    public @Unsigned @OriginalName("__virtio16") short idx;

    public @OriginalName("vring_used_elem_t") vring_used_elem @Size(0) [] ring;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct vring_packed_desc_event"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class vring_packed_desc_event extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct vring_packed_desc"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class vring_packed_desc extends Struct {
    public @Unsigned @OriginalName("__le64") long addr;

    public @Unsigned @OriginalName("__le32") int len;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct vring_desc_state_split"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class vring_desc_state_split extends Struct {
    public Ptr<?> data;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct vring_desc_state_packed"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class vring_desc_state_packed extends Struct {
    public Ptr<?> data;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct vring_desc_extra"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class vring_desc_extra extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct vring_virtqueue_split"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class vring_virtqueue_split extends Struct {
    public vring vring;
    ...
    public @Unsigned @OriginalName("dma_addr_t") long queue_dma_addr;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct { unsigned int num; struct vring_packed_desc *desc; struct vring_packed_desc_event *driver; struct vring_packed_desc_event *device; }"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class vring_of_vring_virtqueue_packed extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct vring_virtqueue_packed"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class vring_virtqueue_packed extends Struct {
    ...
    public @Unsigned @OriginalName("dma_addr_t") long ring_dma_addr;

    public @Unsigned @OriginalName("dma_addr_t") long driver_event_dma_addr;

    public @Unsigned @OriginalName("dma_addr_t") long device_event_dma_addr;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct vring_virtqueue"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class vring_virtqueue extends Struct {
    public virtqueue vq;

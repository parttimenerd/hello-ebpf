...
/**
 * Generated class for BPF runtime types that start with udp4
 */
@java.lang.SuppressWarnings("unused")
public final class Udp4Definitions {
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int __udp4_lib_err(Ptr<sk_buff> skb, @Unsigned int info, Ptr<udp_table> udptable) {
  ...
  public static Ptr<sock> __udp4_lib_lookup(Ptr<net> net,
      ...
      int dif, int sdif, Ptr<udp_table> udptable, Ptr<sk_buff> skb) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int __udp4_lib_mcast_deliver(Ptr<net> net, Ptr<sk_buff> skb, Ptr<udphdr> uh,
      @Unsigned @OriginalName("__be32") int saddr, @Unsigned @OriginalName("__be32") int daddr,
      Ptr<udp_table> udptable, int proto) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int __udp4_lib_rcv(Ptr<sk_buff> skb, Ptr<udp_table> udptable, int proto) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int udp4_csum_init(Ptr<sk_buff> skb, Ptr<udphdr> uh, int proto) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int udp4_gro_complete(Ptr<sk_buff> skb, int nhoff) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<sk_buff> udp4_gro_receive(Ptr<list_head> head, Ptr<sk_buff> skb) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void udp4_hash4(Ptr<sock> sk) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void udp4_hwcsum(Ptr<sk_buff> skb, @Unsigned @OriginalName("__be32") int src,
      @Unsigned @OriginalName("__be32") int dst) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  public static Ptr<sock> udp4_lib_lookup2(Ptr<net> net,
      ...
      Ptr<udp_hslot> hslot2, Ptr<sk_buff> skb) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void udp4_proc_exit_net(Ptr<net> net) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int udp4_proc_init_net(Ptr<net> net) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int udp4_seq_show(Ptr<seq_file> seq, Ptr<?> v) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<sk_buff> udp4_ufo_fragment(Ptr<sk_buff> skb,

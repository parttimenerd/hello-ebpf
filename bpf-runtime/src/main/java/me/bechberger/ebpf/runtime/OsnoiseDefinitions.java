...
/**
 * Generated class for BPF runtime types that start with osnoise
 */
...
public final class OsnoiseDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int osnoise_cpu_die(@Unsigned int cpu) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int osnoise_cpu_init(@Unsigned int cpu) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long osnoise_cpus_read(Ptr<file> filp, String ubuf,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void osnoise_hotplug_workfn(Ptr<work_struct> dummy) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int osnoise_options_open(Ptr<inode> inode, Ptr<file> file) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int osnoise_register_instance(Ptr<trace_array> tr) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int osnoise_tracer_init(Ptr<trace_array> tr) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void osnoise_tracer_reset(Ptr<trace_array> tr) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void osnoise_tracer_start(Ptr<trace_array> tr) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void osnoise_tracer_stop(Ptr<trace_array> tr) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void osnoise_unregister_instance(Ptr<trace_array> tr) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @Type(
      ...
      cType = "struct osnoise_entry"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class osnoise_entry extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct osnoise_sample"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class osnoise_sample extends Struct {
    public @Unsigned long runtime;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "enum osnoise_options_index"
  )
  public enum osnoise_options_index implements Enum<osnoise_options_index>, TypedEnum<osnoise_options_index, java.lang. @Unsigned Integer> {
    /**
     * {@code OSN_DEFAULTS = 0}
     */
    @EnumMember(
    ...
    /**
     * {@code OSN_PANIC_ON_STOP = 2}
     */
    @EnumMember(
        value = 2L,
        name = "OSN_PANIC_ON_STOP"
    )
    OSN_PANIC_ON_STOP,

    /**
     * {@code OSN_PREEMPT_DISABLE = 3}
     */
    @EnumMember(
        value = 3L,
        name = "OSN_PREEMPT_DISABLE"
    )
    OSN_PREEMPT_DISABLE,

    /**
     * {@code OSN_IRQ_DISABLE = 4}
     */
    @EnumMember(
        value = 4L,
        name = "OSN_IRQ_DISABLE"
    )
    OSN_IRQ_DISABLE,
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct osnoise_instance"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class osnoise_instance extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct osnoise_variables"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class osnoise_variables extends Struct {
    ...
    public osn_softirq softirq;

    public osn_thread thread;

    public local_t int_counter;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct osnoise_data"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class osnoise_data extends Struct {

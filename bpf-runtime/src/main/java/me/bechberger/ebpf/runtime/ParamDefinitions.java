...
/**
 * Generated class for BPF runtime types that start with param
 */
@java.lang.SuppressWarnings("unused")
public final class ParamDefinitions {
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void param_array_free(Ptr<?> arg) {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void param_free_charp(Ptr<?> arg) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int param_setup_earlycon_console_alias(String buf) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @Type(
      ...
      cType = "struct param_attribute"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class param_attribute extends Struct {
    public module_attribute mattr;

    public Ptr<kernel_param> param;
  }
  ...
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class param_of_tomoyo_request_info extends Union {
    public path_of_param_of_tomoyo_request_info path;

    public path2_of_param_of_tomoyo_request_info path2;

    public mkdev_of_param_of_tomoyo_request_info mkdev;

    public path_number_of_param_of_tomoyo_request_info path_number;

    public environ_of_param_of_tomoyo_request_info environ;

    public inet_network_of_param_of_tomoyo_request_info inet_network;

    public unix_network_of_param_of_tomoyo_request_info unix_network;

    public mount_of_param_of_tomoyo_request_info mount;

    public task_of_param_of_tomoyo_request_info task;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "union { enum nl80211_band band_pref; struct cfg80211_bss_select_adjust adjust; }"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class param_of_cfg80211_bss_selection extends Union {
    public nl80211_band band_pref;

    public cfg80211_bss_select_adjust adjust;
  }
}

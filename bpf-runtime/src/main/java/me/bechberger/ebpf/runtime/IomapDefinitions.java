...
/**
 * Generated class for BPF runtime types that start with iomap
 */
...
public final class IomapDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long iomap_add_to_ioend(Ptr<iomap_writepage_ctx> wpc,
      Ptr<folio> folio, @OriginalName("loff_t") long pos, @OriginalName("loff_t") long end_pos,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void iomap_adjust_read_range(Ptr<inode> inode, Ptr<folio> folio,
      Ptr<java.lang. @OriginalName("loff_t") Long> pos, @OriginalName("loff_t") long length,
      Ptr<java.lang. @Unsigned Long> offp, Ptr<java.lang. @Unsigned Long> lenp) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @Unsigned long iomap_bytes_to_truncate(@OriginalName("loff_t") long end_pos,
      @Unsigned int block_bits, @Unsigned int blocks_truncated) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void iomap_dio_bio_end_io(Ptr<bio> bio) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int iomap_dio_bio_iter(Ptr<iomap_iter> iter, Ptr<iomap_dio> dio) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long iomap_dio_complete(Ptr<iomap_dio> dio) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void iomap_dio_complete_work(Ptr<work_struct> work) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long iomap_dio_deferred_complete(Ptr<?> data) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void iomap_dio_done(Ptr<iomap_dio> dio) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int iomap_dio_hole_iter(Ptr<iomap_iter> iter, Ptr<iomap_dio> dio) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int iomap_dio_inline_iter(Ptr<iomap_iter> iomi, Ptr<iomap_dio> dio) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static boolean iomap_dirty_folio(Ptr<address_space> mapping, Ptr<folio> folio) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void iomap_finish_folio_write(Ptr<inode> inode, Ptr<folio> folio,
      @Unsigned long len) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @Unsigned int iomap_finish_ioend_buffered(Ptr<iomap_ioend> ioend) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static @Unsigned int iomap_finish_ioend_direct(Ptr<iomap_ioend> ioend) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<folio> iomap_get_folio(Ptr<iomap_iter> iter, @OriginalName("loff_t") long pos,
      @Unsigned long len) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<iomap_ioend> iomap_init_ioend(Ptr<inode> inode, Ptr<bio> bio,
      @OriginalName("loff_t") long file_offset, @Unsigned short ioend_flags) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void iomap_invalidate_folio(Ptr<folio> folio, @Unsigned long offset,
      @Unsigned long len) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int iomap_ioend_init() {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void iomap_ioend_try_merge(Ptr<iomap_ioend> ioend, Ptr<list_head> more_ioends) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int iomap_ioend_writeback_submit(Ptr<iomap_writepage_ctx> wpc, int error) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static boolean iomap_is_partially_uptodate(Ptr<folio> folio, @Unsigned long from,
      @Unsigned long count) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int iomap_iter_advance(Ptr<iomap_iter> iter, Ptr<java.lang. @Unsigned Long> count) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void iomap_iter_done(Ptr<iomap_iter> iter) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void iomap_read_end_io(Ptr<bio> bio) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int iomap_readpage_iter(Ptr<iomap_iter> iter, Ptr<iomap_readpage_ctx> ctx) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static boolean iomap_release_folio(Ptr<folio> folio,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void iomap_set_range_uptodate(Ptr<folio> folio, @Unsigned long off,
      @Unsigned long len) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void iomap_sort_ioends(Ptr<list_head> ioend_list) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<iomap_ioend> iomap_split_ioend(Ptr<iomap_ioend> ioend, @Unsigned int max_len,
      boolean is_append) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void iomap_start_folio_write(Ptr<inode> inode, Ptr<folio> folio,
      @Unsigned long len) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int iomap_swapfile_iter(Ptr<iomap_iter> iter, Ptr<iomap> iomap,
      Ptr<iomap_swapfile_info> isi) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void iomap_write_delalloc_release(Ptr<inode> inode,
      @OriginalName("loff_t") long start_byte, @OriginalName("loff_t") long end_byte,
      @Unsigned int flags, Ptr<iomap> iomap, @OriginalName("iomap_punch_t") Ptr<?> punch) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void iomap_write_delalloc_scan(Ptr<inode> inode,
      Ptr<java.lang. @OriginalName("loff_t") Long> punch_start_byte,
      @OriginalName("loff_t") long start_byte, @OriginalName("loff_t") long end_byte,
      Ptr<iomap> iomap, @OriginalName("iomap_punch_t") Ptr<?> punch) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static boolean iomap_write_end(Ptr<iomap_iter> iter, @Unsigned long len,
      @Unsigned long copied, Ptr<folio> folio) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int iomap_writeback_folio(Ptr<iomap_writepage_ctx> wpc, Ptr<folio> folio) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int iomap_writepages(Ptr<iomap_writepage_ctx> wpc) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @Type(
      ...
      cType = "struct iomap_ops"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class iomap_ops extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct iomap_iter"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class iomap_iter extends Struct {
    ...
    public @OriginalName("loff_t") long iter_start_pos;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct iomap_write_ops"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class iomap_write_ops extends Struct {
    ...
    public Ptr<?> read_folio_range;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct iomap_writeback_ops"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class iomap_writeback_ops extends Struct {
    public Ptr<?> writeback_range;

    public Ptr<?> writeback_submit;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct iomap_writepage_ctx"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class iomap_writepage_ctx extends Struct {
    public iomap iomap;

    public Ptr<inode> inode;

    public Ptr<writeback_control> wbc;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct iomap_folio_state"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class iomap_folio_state extends Struct {
    public @OriginalName("spinlock_t") spinlock state_lock;

    public @Unsigned int read_bytes_pending;

    public atomic_t write_bytes_pending;

    public @Unsigned long @Size(0) [] state;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct iomap_readpage_ctx"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class iomap_readpage_ctx extends Struct {
    public Ptr<folio> cur_folio;

    public boolean cur_folio_in_bio;

    public Ptr<bio> bio;

    public Ptr<readahead_control> rac;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct iomap_ioend"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class iomap_ioend extends Struct {
    public list_head io_list;

    public @Unsigned short io_flags;

    public Ptr<inode> io_inode;

    public @Unsigned long io_size;

    public atomic_t io_remaining;

    public int io_error;

    public Ptr<iomap_ioend> io_parent;

    public @OriginalName("loff_t") long io_offset;

    public @Unsigned @OriginalName("sector_t") long io_sector;

    public Ptr<?> io_private;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct iomap_dio_ops"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class iomap_dio_ops extends Struct {
    public Ptr<?> end_io;

    public Ptr<?> submit_io;

    public Ptr<bio_set> bio_set;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct iomap_dio"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class iomap_dio extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct iomap_swapfile_info"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class iomap_swapfile_info extends Struct {
    public iomap iomap;

    public Ptr<swap_info_struct> sis;

    public @Unsigned @OriginalName("uint64_t") long lowest_ppage;

    public @Unsigned @OriginalName("uint64_t") long highest_ppage;

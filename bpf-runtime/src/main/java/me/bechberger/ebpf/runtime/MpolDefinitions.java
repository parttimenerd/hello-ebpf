...
/**
 * Generated class for BPF runtime types that start with mpol
 */
@java.lang.SuppressWarnings("unused")
public final class MpolDefinitions {
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<mempolicy> __mpol_dup(Ptr<mempolicy> old) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static boolean __mpol_equal(Ptr<mempolicy> a, Ptr<mempolicy> b) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void __mpol_put(Ptr<mempolicy> pol) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void mpol_free_shared_policy(Ptr<shared_policy> sp) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int mpol_misplaced(Ptr<folio> folio, Ptr<vm_fault> vmf, @Unsigned long addr) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<mempolicy> mpol_new(@Unsigned short mode, @Unsigned short flags,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int mpol_parse_str(String str, Ptr<Ptr<mempolicy>> mpol) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void mpol_put_task_policy(Ptr<task_struct> task) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void mpol_rebind_mm(Ptr<mm_struct> mm, Ptr<nodemask_t> _new) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int mpol_set_shared_policy(Ptr<shared_policy> sp, Ptr<vm_area_struct> vma,
      Ptr<mempolicy> pol) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void mpol_shared_policy_init(Ptr<shared_policy> sp, Ptr<mempolicy> mpol) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<mempolicy> mpol_shared_policy_lookup(Ptr<shared_policy> sp,
      @Unsigned long idx) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void mpol_to_str(String buffer, int maxlen, Ptr<mempolicy> pol) {
    throw new MethodIsBPFRelatedFunction();
  }
}

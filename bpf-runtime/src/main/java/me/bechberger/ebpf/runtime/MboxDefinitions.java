...
/**
 * Generated class for BPF runtime types that start with mbox
 */
...
public final class MboxDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<mbox_chan> mbox_request_channel(Ptr<mbox_client> cl, int index) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction("mbox_request_channel_byname($arg1, (const u8 *)$arg2)")
  ...
  @Type(
      ...
      cType = "struct mbox_chan_ops"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class mbox_chan_ops extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct mbox_chan"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class mbox_chan extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct mbox_controller"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class mbox_controller extends Struct {
    ...
    public hrtimer poll_hrt;

    public @OriginalName("spinlock_t") spinlock poll_hrt_lock;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct mbox_client"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class mbox_client extends Struct {
    public Ptr<device> dev;

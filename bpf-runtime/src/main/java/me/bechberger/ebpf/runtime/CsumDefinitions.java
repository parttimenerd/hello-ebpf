...
/**
 * Generated class for BPF runtime types that start with csum
 */
@java.lang.SuppressWarnings("unused")
public final class CsumDefinitions {
  @NotUsableInJava
  @BuiltinBPFFunction
  public static boolean csum_and_copy_from_iter_full(Ptr<?> addr, @Unsigned long bytes,
      Ptr<java.lang. @Unsigned @OriginalName("__wsum") Integer> csum, Ptr<iov_iter> i) {
  ...
  @Type(
      ...
      cType = "struct { short unsigned int start; short unsigned int offset; }"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class csum_of_anon_member_of_virtio_net_hdr_v1 extends Struct {
    public @Unsigned @OriginalName("__virtio16") short start;

    public @Unsigned @OriginalName("__virtio16") short offset;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct csum_state"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class csum_state extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct csum_pseudo_header"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class csum_pseudo_header extends Struct {
    public @Unsigned @OriginalName("__be64") long data_seq;

    public @Unsigned @OriginalName("__be32") int subflow_seq;

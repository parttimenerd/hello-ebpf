...
/**
 * Generated class for BPF runtime types that start with cpus
 */
@java.lang.SuppressWarnings("unused")
public final class CpusDefinitions {
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int cpus_ctrl_write(Ptr<rdtgroup> rdtgrp,
      @OriginalName("cpumask_var_t") Ptr<cpumask> newmask,
      @OriginalName("cpumask_var_t") Ptr<cpumask> tmpmask,
      @OriginalName("cpumask_var_t") Ptr<cpumask> tmpmask1) {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int cpus_mon_write(Ptr<rdtgroup> rdtgrp,
      @OriginalName("cpumask_var_t") Ptr<cpumask> newmask,
      @OriginalName("cpumask_var_t") Ptr<cpumask> tmpmask) {
    throw new MethodIsBPFRelatedFunction();
  }

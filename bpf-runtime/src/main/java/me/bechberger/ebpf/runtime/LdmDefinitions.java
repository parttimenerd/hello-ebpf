...
/**
 * Generated class for BPF runtime types that start with ldm
 */
...
public final class LdmDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static boolean ldm_get_vblks(Ptr<parsed_partitions> state, @Unsigned long base,
      Ptr<ldmdb> ldb) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static boolean ldm_ldmdb_add(Ptr<java.lang.Character> data, int len, Ptr<ldmdb> ldb) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int ldm_partition(Ptr<parsed_partitions> state) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static boolean ldm_validate_privheads(Ptr<parsed_partitions> state, Ptr<privhead> ph1) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static boolean ldm_validate_tocblocks(Ptr<parsed_partitions> state, @Unsigned long base,
      Ptr<ldmdb> ldb) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static boolean ldm_validate_vmdb(Ptr<parsed_partitions> state, @Unsigned long base,
      Ptr<ldmdb> ldb) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @Type(
      ...
      cType = "struct tocblock"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class tocblock extends Struct {
    public char @Size(16) [] bitmap1_name;

    public @Unsigned long bitmap1_start;

    public @Unsigned long bitmap1_size;

    public char @Size(16) [] bitmap2_name;
  ...
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class vblk extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct privhead"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class privhead extends Struct {
  ...
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class vmdb extends Struct {
    public @Unsigned short ver_major;
  ...
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class ldmdb extends Struct {
    public privhead ph;
    ...
    public list_head v_dgrp;

    public list_head v_disk;

    public list_head v_volu;

    public list_head v_comp;

    public list_head v_part;
  }
}

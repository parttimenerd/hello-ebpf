...
/**
 * Generated class for BPF runtime types that start with memmap
 */
...
public final class MemmapDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long memmap_attr_show(Ptr<kobject> kobj,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int memmap_entry_callback(Ptr<resource> res, Ptr<?> arg) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void memmap_init_kho_scratch_pages() {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  public static void memmap_init_range(@Unsigned long size, int nid, @Unsigned long zone,
      ...
      Ptr<vmem_altmap> altmap, int migratetype, boolean isolate_pageblock) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void memmap_init_zone_device(Ptr<zone> zone, @Unsigned long start_pfn,
      @Unsigned long nr_pages, Ptr<dev_pagemap> pgmap) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long memmap_on_memory_show(Ptr<device> dev,
      Ptr<device_attribute> attr, String buf) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction("memmap_on_memory_store($arg1, $arg2, (const u8*)$arg3, $arg4)")
  public static @OriginalName("ssize_t") long memmap_on_memory_store(Ptr<device> dev,

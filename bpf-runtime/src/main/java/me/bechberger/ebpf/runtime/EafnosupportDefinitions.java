...
/**
 * Generated class for BPF runtime types that start with eafnosupport
 */
@java.lang.SuppressWarnings("unused")
public final class EafnosupportDefinitions {
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<fib6_table> eafnosupport_fib6_get_table(Ptr<net> net, @Unsigned int id) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int eafnosupport_fib6_lookup(Ptr<net> net, int oif, Ptr<flowi6> fl6,
      Ptr<fib6_result> res, int flags) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int eafnosupport_fib6_nh_init(Ptr<net> net, Ptr<fib6_nh> fib6_nh,
      Ptr<fib6_config> cfg, @Unsigned @OriginalName("gfp_t") int gfp_flags,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int eafnosupport_fib6_table_lookup(Ptr<net> net, Ptr<fib6_table> table, int oif,
      Ptr<flowi6> fl6, Ptr<fib6_result> res, int flags) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int eafnosupport_ip6_del_rt(Ptr<net> net, Ptr<fib6_info> rt, boolean skip_notify) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction("eafnosupport_ipv6_fragment($arg1, $arg2, $arg3, (int (*)(struct net*, struct sock*, struct sk_buff*))$arg4)")
  public static int eafnosupport_ipv6_fragment(Ptr<net> net, Ptr<sock> sk, Ptr<sk_buff> skb,
      Ptr<?> output) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int eafnosupport_ipv6_route_input(Ptr<sk_buff> skb) {
    throw new MethodIsBPFRelatedFunction();
  }
}

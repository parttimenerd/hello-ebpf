...
/**
 * Generated class for BPF runtime types that start with fault
 */
@java.lang.SuppressWarnings("unused")
public final class FaultDefinitions {
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int fault_around_bytes_fops_open(Ptr<inode> inode, Ptr<file> file) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int fault_around_bytes_get(Ptr<?> data, Ptr<java.lang. @Unsigned Long> val) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @Unsigned @OriginalName("vm_fault_t") int fault_dirty_shared_page(
      Ptr<vm_fault> vmf) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int fault_in_user_writeable(Ptr<java.lang. @Unsigned Integer> uaddr) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @Type(
      ...
      cType = "enum fault_flag"
  )
  public enum fault_flag implements Enum<fault_flag>, TypedEnum<fault_flag, java.lang. @Unsigned Integer> {
    /**
     * {@code FAULT_FLAG_WRITE = 1}
     */
    @EnumMember(
        value = 1L,
    ...
    /**
     * {@code FAULT_FLAG_RETRY_NOWAIT = 8}
     */
    @EnumMember(
        value = 8L,
    ...
    /**
     * {@code FAULT_FLAG_INSTRUCTION = 256}
     */
    @EnumMember(
        value = 256L,
    ...
    /**
     * {@code FAULT_FLAG_INTERRUPTIBLE = 512}
     */
    @EnumMember(
        value = 512L,
    ...
    /**
     * {@code FAULT_FLAG_ORIG_PTE_VALID = 2048}
     */
    @EnumMember(
        value = 2048L,

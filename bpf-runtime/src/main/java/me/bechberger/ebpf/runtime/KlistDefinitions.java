...
/**
 * Generated class for BPF runtime types that start with klist
 */
...
public final class KlistDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void klist_add_head(Ptr<klist_node> n, Ptr<klist> k) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void klist_add_tail(Ptr<klist_node> n, Ptr<klist> k) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction("klist_init($arg1, (void (*)(struct klist_node*))$arg2, (void (*)(struct klist_node*))$arg3)")
  public static void klist_init(Ptr<klist> k, Ptr<?> get, Ptr<?> put) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void klist_iter_init(Ptr<klist> k, Ptr<klist_iter> i) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void klist_iter_init_node(Ptr<klist> k, Ptr<klist_iter> i, Ptr<klist_node> n) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void klist_release(Ptr<kref> kref) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @Type(
      ...
      cType = "struct klist_node"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class klist_node extends Struct {
    public Ptr<?> n_klist;

    public list_head n_node;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct klist_iter"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class klist_iter extends Struct {
    public Ptr<klist> i_klist;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct klist_waiter"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class klist_waiter extends Struct {
    public list_head list;

    public Ptr<klist_node> node;

    public Ptr<task_struct> process;

...
/**
 * Generated class for BPF runtime types that start with module
 */
@java.lang.SuppressWarnings("unused")
public final class ModuleDefinitions {
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<module> __module_address(@Unsigned long addr) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void __module_get(Ptr<module> module) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void __module_put_and_kthread_exit(Ptr<module> mod, long code) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<module> __module_text_address(@Unsigned long addr) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int module_add_modinfo_attrs(Ptr<module> mod) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction("module_address_lookup($arg1, $arg2, $arg3, $arg4, (const u8**)$arg5, $arg6)")
  public static int module_address_lookup(@Unsigned long addr, Ptr<java.lang. @Unsigned Long> size,
      Ptr<java.lang. @Unsigned Long> offset, Ptr<String> modname, Ptr<String> modbuildid,
      String namebuf) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void module_arch_cleanup(Ptr<module> mod) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void module_arch_freeing_init(Ptr<module> mod) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long module_attr_show(Ptr<kobject> kobj,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void module_augment_kernel_taints(Ptr<module> mod, Ptr<load_info> info) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void module_bug_cleanup(Ptr<module> mod) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void module_decompress_cleanup(Ptr<load_info> info) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static boolean module_elf_check_arch(Ptr<@OriginalName("Elf64_Ehdr") elf64_hdr> hdr) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int module_event(Ptr<notifier_block> self, @Unsigned long val, Ptr<?> data) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int module_extend_max_pages(Ptr<load_info> info, @Unsigned int extent) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static String module_flags(Ptr<module> mod, String buf, boolean show_state) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void module_flash_fw_work(Ptr<work_struct> work) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction("module_for_each_mod((int (*)(struct module*, void*))$arg1, $arg2)")
  public static void module_for_each_mod(Ptr<?> func, Ptr<?> data) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int module_frob_arch_sections(Ptr<@OriginalName("Elf64_Ehdr") elf64_hdr> hdr,
      Ptr<@OriginalName("Elf64_Shdr") elf64_shdr> sechdrs, String secstrings, Ptr<module> mod) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int module_get_kallsym(@Unsigned int symnum, Ptr<java.lang. @Unsigned Long> value,
      String type, String name, String module_name, Ptr<java.lang.Integer> exported) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static long module_get_offset_and_type(Ptr<module> mod, mod_mem_type type,
      Ptr<@OriginalName("Elf64_Shdr") elf64_shdr> sechdr, @Unsigned int section) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void module_kobj_release(Ptr<kobject> kobj) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction("module_layout($arg1, $arg2, $arg3, $arg4, (struct tracepoint**)$arg5)")
  public static void module_layout(Ptr<module> mod, Ptr<modversion_info> ver, Ptr<kernel_param> kp,
      Ptr<kernel_symbol> ks, Ptr<Ptr<tracepoint>> tp) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void module_memory_restore_rox(Ptr<module> mod) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static String module_next_tag_pair(String string, Ptr<java.lang. @Unsigned Long> secsize) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void module_param_sysfs_remove(Ptr<module> mod) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void module_put(Ptr<module> module) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int module_refcount(Ptr<module> mod) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void module_remove_modinfo_attrs(Ptr<module> mod, int end) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int module_sig_check(Ptr<load_info> info, int flags) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int module_trace_bprintk_format_notify(Ptr<notifier_block> self, @Unsigned long val,
      Ptr<?> data) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void module_unload_free(Ptr<module> mod) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @Type(
      ...
      cType = "struct module_kobject"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class module_kobject extends Struct {
    public kobject kobj;

    public Ptr<module> mod;

    public Ptr<kobject> drivers_dir;

    public Ptr<module_param_attrs> mp;

    public Ptr<completion> kobj_completion;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct module_attribute"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class module_attribute extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "enum module_state"
  )
  public enum module_state implements Enum<module_state>, TypedEnum<module_state, java.lang. @Unsigned Integer> {
    /**
     * {@code MODULE_STATE_LIVE = 0}
     */
    @EnumMember(
        value = 0L,
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct module_memory"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class module_memory extends Struct {
    public Ptr<?> base;

    public boolean is_rox;

    public @Unsigned int size;

    public mod_tree_node mtn;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct module_param_attrs"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class module_param_attrs extends Struct {
    public @Unsigned int num;

    public attribute_group grp;

    public param_attribute @Size(0) [] attrs;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct module_version_attribute"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class module_version_attribute extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct module_use"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class module_use extends Struct {
    public list_head source_list;

    public list_head target_list;

    public Ptr<module> source;

    public Ptr<module> target;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct module_signature"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class module_signature extends Struct {
    public char algo;
    ...
    public char @Size(3) [] __pad;

    public @Unsigned @OriginalName("__be32") int sig_len;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct module_sect_attrs"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class module_sect_attrs extends Struct {
    public attribute_group grp;

    public bin_attribute @Size(0) [] attrs;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct module_notes_attrs"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class module_notes_attrs extends Struct {
    public attribute_group grp;
  ...
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class module_of_anon_member_of_audit_context extends Struct {
    public String name;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct module_string"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class module_string extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct module_reply_data"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class module_reply_data extends Struct {
    public ethnl_reply_data base;

    public ethtool_module_power_mode_params power;
  }
}

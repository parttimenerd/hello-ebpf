...
/**
 * Generated class for BPF runtime types that start with x509
 */
...
public final class X509Definitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int x509_key_preparse(Ptr<key_preparsed_payload> prep) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @Type(
      ...
      cType = "enum x509_actions"
  )
  public enum x509_actions implements Enum<x509_actions>, TypedEnum<x509_actions, java.lang. @Unsigned Integer> {
    /**
     * {@code ACT_x509_extract_key_data = 0}
     */
    @EnumMember(
        value = 0L,
        name = "ACT_x509_extract_key_data"
    )
    ACT_x509_extract_key_data,

    /**
     * {@code ACT_x509_extract_name_segment = 1}
     */
    @EnumMember(
        value = 1L,
        name = "ACT_x509_extract_name_segment"
    )
    ACT_x509_extract_name_segment,

    /**
     * {@code ACT_x509_note_OID = 2}
     */
    @EnumMember(
        value = 2L,
        name = "ACT_x509_note_OID"
    )
    ACT_x509_note_OID,

    /**
     * {@code ACT_x509_note_issuer = 3}
     */
    @EnumMember(
        value = 3L,
        name = "ACT_x509_note_issuer"
    )
    ACT_x509_note_issuer,

    /**
     * {@code ACT_x509_note_not_after = 4}
     */
    @EnumMember(
        value = 4L,
        name = "ACT_x509_note_not_after"
    )
    ACT_x509_note_not_after,

    /**
     * {@code ACT_x509_note_not_before = 5}
     */
    @EnumMember(
        value = 5L,
        name = "ACT_x509_note_not_before"
    )
    ACT_x509_note_not_before,

    /**
     * {@code ACT_x509_note_params = 6}
     */
    @EnumMember(
        value = 6L,
        name = "ACT_x509_note_params"
    )
    ACT_x509_note_params,

    /**
     * {@code ACT_x509_note_serial = 7}
     */
    @EnumMember(
        value = 7L,
        name = "ACT_x509_note_serial"
    )
    ACT_x509_note_serial,

    /**
     * {@code ACT_x509_note_sig_algo = 8}
     */
    @EnumMember(
        value = 8L,
        name = "ACT_x509_note_sig_algo"
    )
    ACT_x509_note_sig_algo,

    /**
     * {@code ACT_x509_note_signature = 9}
     */
    @EnumMember(
        value = 9L,
        name = "ACT_x509_note_signature"
    )
    ACT_x509_note_signature,

    /**
     * {@code ACT_x509_note_subject = 10}
     */
    @EnumMember(
        value = 10L,
        name = "ACT_x509_note_subject"
    )
    ACT_x509_note_subject,

    /**
     * {@code ACT_x509_note_tbs_certificate = 11}
     */
    @EnumMember(
        value = 11L,
        name = "ACT_x509_note_tbs_certificate"
    )
    ACT_x509_note_tbs_certificate,

    /**
     * {@code ACT_x509_process_extension = 12}
     */
    @EnumMember(
        value = 12L,
        name = "ACT_x509_process_extension"
    )
    ACT_x509_process_extension,

    /**
     * {@code NR__x509_actions = 13}
     */
    @EnumMember(
        value = 13L,
        name = "NR__x509_actions"
    )
    NR__x509_actions
  }
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "enum x509_akid_actions"
  )
  public enum x509_akid_actions implements Enum<x509_akid_actions>, TypedEnum<x509_akid_actions, java.lang. @Unsigned Integer> {
    /**
     * {@code ACT_x509_akid_note_kid = 0}
     */
    @EnumMember(
        value = 0L,
        name = "ACT_x509_akid_note_kid"
    )
    ACT_x509_akid_note_kid,

    /**
     * {@code ACT_x509_akid_note_name = 1}
     */
    @EnumMember(
        value = 1L,
        name = "ACT_x509_akid_note_name"
    )
    ACT_x509_akid_note_name,

    /**
     * {@code ACT_x509_akid_note_serial = 2}
     */
    @EnumMember(
        value = 2L,
        name = "ACT_x509_akid_note_serial"
    )
    ACT_x509_akid_note_serial,

    /**
     * {@code ACT_x509_extract_name_segment = 3}
     */
    @EnumMember(
        value = 3L,
        name = "ACT_x509_extract_name_segment"
    ...
    /**
     * {@code NR__x509_akid_actions = 5}
     */
    @EnumMember(
        value = 5L,
        name = "NR__x509_akid_actions"
    )
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct x509_certificate"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class x509_certificate extends Struct {
    public Ptr<x509_certificate> next;

    public Ptr<x509_certificate> signer;

    public Ptr<public_key> pub;
    ...
    public Ptr<asymmetric_key_id> id;

    public Ptr<asymmetric_key_id> skid;

    public @OriginalName("time64_t") long valid_from;

    public @OriginalName("time64_t") long valid_to;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct x509_parse_context"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class x509_parse_context extends Struct {

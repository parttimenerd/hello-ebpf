...
/**
 * Generated class for BPF runtime types that start with elf
 */
@java.lang.SuppressWarnings("unused")
public final class ElfDefinitions {
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int elf_core_dump(Ptr<coredump_params> cprm) {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int elf_coredump_extra_notes_write(Ptr<coredump_params> cprm) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction("elf_strtbl_add((const u8*)$arg1, $arg2, $arg3, $arg4)")
  public static @Unsigned int elf_strtbl_add(String name, Ptr<?> ehdr, char _class,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int elf_validity_cache_copy(Ptr<load_info> info, int flags) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int elf_validity_cache_index(Ptr<load_info> info, int flags) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int elf_validity_cache_index_versions(Ptr<load_info> info, int flags) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int elf_validity_cache_sechdrs(Ptr<load_info> info) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  public static class elf_note_info extends Struct {
    ...
    public @OriginalName("siginfo_t") siginfo csigdata;

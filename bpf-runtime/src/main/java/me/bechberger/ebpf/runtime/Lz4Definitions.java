...
/**
 * Generated class for BPF runtime types that start with lz4
 */
...
public final class Lz4Definitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<?> lz4_init(Ptr<squashfs_sb_info> msblk, Ptr<?> buff) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int lz4_uncompress(Ptr<squashfs_sb_info> msblk, Ptr<?> strm, Ptr<bio> bio,
  ...
  @Type(
      ...
      cType = "struct lz4_comp_opts"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class lz4_comp_opts extends Struct {
  ...
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class LZ4_streamDecode_t_internal extends Struct {
    public Ptr<java.lang. @OriginalName("uint8_t") Character> externalDict;

    public @Unsigned long extDictSize;

    public Ptr<java.lang. @OriginalName("uint8_t") Character> prefixEnd;
  ...
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class LZ4_streamDecode_t extends Union {
    public @Unsigned long @Size(4) [] table;

...
/**
 * Generated class for BPF runtime types that start with nh
 */
...
public final class NhDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int nh_check_attr_group_rtnl(Ptr<net> net, Ptr<Ptr<nlattr>> tb,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int nh_comp(Ptr<fib_info> fi, Ptr<fib_info> ofi) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int nh_create_ipv4(Ptr<net> net, Ptr<nexthop> nh, Ptr<nh_info> nhi,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int nh_create_ipv6(Ptr<net> net, Ptr<nexthop> nh, Ptr<nh_info> nhi,
      Ptr<nh_config> cfg, Ptr<netlink_ext_ack> extack) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static boolean nh_dump_filtered(Ptr<nexthop> nh, Ptr<nh_dump_filter> filter, char family) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int nh_fill_node(Ptr<sk_buff> skb, Ptr<nexthop> nh, int event, @Unsigned int portid,
      @Unsigned int seq, @Unsigned int nlflags, @Unsigned int op_flags) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void nh_grp_hw_stats_report_delta(Ptr<nh_notifier_grp_hw_stats_info> info,
      @Unsigned int nh_idx, @Unsigned long delta_packets) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int nh_grp_hw_stats_update(Ptr<nexthop> nh,
      Ptr<java.lang. @OriginalName("bool") Boolean> hw_stats_used) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int nh_netdev_event(Ptr<notifier_block> _this, @Unsigned long event, Ptr<?> ptr) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int nh_notifier_mpath_info_init(Ptr<nh_notifier_info> info, Ptr<nh_group> nhg) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static boolean nh_res_bucket_migrate(Ptr<nh_res_table> res_table,
      @Unsigned short bucket_index, boolean notify, boolean notify_nl, boolean force) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void nh_res_table_upkeep(Ptr<nh_res_table> res_table, boolean notify,
      boolean notify_nl) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void nh_res_table_upkeep_dw(Ptr<work_struct> work) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @Type(
      ...
      cType = "struct nh_info"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class nh_info extends Struct {
    public hlist_node dev_hash;

    public Ptr<nexthop> nh_parent;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct nh_res_bucket"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class nh_res_bucket extends Struct {
    public Ptr<nh_grp_entry> nh_entry;

    public @OriginalName("atomic_long_t") atomic64_t used_time;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct nh_grp_entry"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class nh_grp_entry extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct nh_res_table"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class nh_res_table extends Struct {
    public Ptr<net> net;

    public @Unsigned int nhg_id;

    public delayed_work upkeep_dw;

    public list_head uw_nh_entries;
    ...
    public nh_res_bucket @Size(0) [] nh_buckets;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct nh_grp_entry_stats"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class nh_grp_entry_stats extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct nh_group"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class nh_group extends Struct {
    ...
    public nh_grp_entry @Size(0) [] nh_entries;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct nh_config"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class nh_config extends Struct {
    ...
    public addr_of_netnode_security_struct_and_anon_member_of_nh_notifier_single_info_and_gw_of_nh_config gw;

    public Ptr<nlattr> nh_grp;
    ...
    public Ptr<nlattr> nh_encap;

    public @Unsigned short nh_encap_type;

    public @Unsigned int nlflags;

    public nl_info nlinfo;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "enum nh_notifier_info_type"
  )
  public enum nh_notifier_info_type implements Enum<nh_notifier_info_type>, TypedEnum<nh_notifier_info_type, java.lang. @Unsigned Integer> {
    /**
     * {@code NH_NOTIFIER_INFO_TYPE_SINGLE = 0}
     */
    @EnumMember(
        value = 0L,
        name = "NH_NOTIFIER_INFO_TYPE_SINGLE"
    )
    NH_NOTIFIER_INFO_TYPE_SINGLE,

    /**
     * {@code NH_NOTIFIER_INFO_TYPE_GRP = 1}
     */
    @EnumMember(
        value = 1L,
        name = "NH_NOTIFIER_INFO_TYPE_GRP"
    )
    NH_NOTIFIER_INFO_TYPE_GRP,

    /**
     * {@code NH_NOTIFIER_INFO_TYPE_RES_TABLE = 2}
     */
    @EnumMember(
        value = 2L,
        name = "NH_NOTIFIER_INFO_TYPE_RES_TABLE"
    )
    NH_NOTIFIER_INFO_TYPE_RES_TABLE,

    /**
     * {@code NH_NOTIFIER_INFO_TYPE_RES_BUCKET = 3}
     */
    @EnumMember(
        value = 3L,
        name = "NH_NOTIFIER_INFO_TYPE_RES_BUCKET"
    )
    NH_NOTIFIER_INFO_TYPE_RES_BUCKET,

    /**
     * {@code NH_NOTIFIER_INFO_TYPE_GRP_HW_STATS = 4}
     */
    @EnumMember(
        value = 4L,
        name = "NH_NOTIFIER_INFO_TYPE_GRP_HW_STATS"
    )
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct nh_notifier_single_info"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class nh_notifier_single_info extends Struct {
    public Ptr<net_device> dev;

    public char gw_family;

    @InlineUnion(17535)
    public @Unsigned @OriginalName("__be32") int ipv4;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct nh_notifier_grp_entry_info"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class nh_notifier_grp_entry_info extends Struct {
    public @Unsigned short weight;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct nh_notifier_grp_info"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class nh_notifier_grp_info extends Struct {
    public @Unsigned short num_nh;
    ...
    public nh_notifier_grp_entry_info @Size(0) [] nh_entries;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct nh_notifier_res_bucket_info"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class nh_notifier_res_bucket_info extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct nh_notifier_res_table_info"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class nh_notifier_res_table_info extends Struct {
    public @Unsigned short num_nh_buckets;

    public boolean hw_stats;

    public nh_notifier_single_info @Size(0) [] nhs;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct nh_notifier_grp_hw_stats_entry_info"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class nh_notifier_grp_hw_stats_entry_info extends Struct {
    public @Unsigned int id;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct nh_notifier_grp_hw_stats_info"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class nh_notifier_grp_hw_stats_info extends Struct {
    public @Unsigned short num_nh;

    public boolean hw_stats_used;

    public nh_notifier_grp_hw_stats_entry_info @Size(0) [] stats;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct nh_notifier_info"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class nh_notifier_info extends Struct {
    public Ptr<net> net;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct nh_dump_filter"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class nh_dump_filter extends Struct {
    public @Unsigned int nh_id;

...
/**
 * Generated class for BPF runtime types that start with synchronize
 */
@java.lang.SuppressWarnings("unused")
public final class SynchronizeDefinitions {
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void __synchronize_hardirq(Ptr<irq_desc> desc, boolean sync_chip) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void __synchronize_irq(Ptr<irq_desc> desc) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void __synchronize_srcu(Ptr<srcu_struct> ssp, boolean do_norm) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void synchronize_rcu_expedited_stall(@Unsigned long jiffies_start,
      @Unsigned long j) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void synchronize_rcu_tasks_generic(Ptr<rcu_tasks> rtp) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void synchronize_srcu(Ptr<srcu_struct> ssp) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void synchronize_srcu_expedited(Ptr<srcu_struct> ssp) {
    throw new MethodIsBPFRelatedFunction();
  }
}

...
/**
 * Generated class for BPF runtime types that start with xattr
 */
...
public final class XattrDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction("((const struct xattr_handler*)xattr_resolve_name($arg1, (const u8**)$arg2))")
  public static Ptr<xattr_handler> xattr_resolve_name(Ptr<inode> inode, Ptr<String> name) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int xattr_supports_user_prefix(Ptr<inode> inode) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction("xattr_verify($arg1, $arg2, $arg3, $arg4, $arg5, (const u8**)$arg6)")
  public static int xattr_verify(ima_hooks func, Ptr<ima_iint_cache> iint,
      Ptr<evm_ima_xattr_data> xattr_value, int xattr_len, Ptr<integrity_status> status,
      Ptr<String> cause) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @Type(
      ...
      cType = "struct xattr_handler"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class xattr_handler extends Struct {
    public String name;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct xattr_args"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class xattr_args extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct xattr_name"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class xattr_name extends Struct {
    public char @Size(256) [] name;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "union { struct { u8 unused; u8 type; } sha1; struct { u8 type; u8 algo; } ng; u8 data[2]; }"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class xattr_of_anon_member_of_anon_member_of_ima_digest_data_and_xattr_of_ima_digest_data_hdr extends Union {
    public sha1_of_xattr_of_anon_member_of_anon_member_of_ima_digest_data_and_xattr_of_ima_digest_data_hdr sha1;

    public ng_of_xattr_of_anon_member_of_anon_member_of_ima_digest_data_and_xattr_of_ima_digest_data_hdr ng;

    public char @Size(2) [] data;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct xattr_list"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class xattr_list extends Struct {

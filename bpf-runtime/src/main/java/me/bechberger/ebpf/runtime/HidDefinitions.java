...
/**
 * Generated class for BPF runtime types that start with hid
 */
@java.lang.SuppressWarnings("unused")
public final class HidDefinitions {
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int __hid_bpf_allocate_data(Ptr<hid_device> hdev,
      Ptr<Ptr<java.lang.Character>> data, Ptr<java.lang. @Unsigned Integer> size) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int __hid_bpf_device_event(Ptr<hid_bpf_ctx> ctx, hid_report_type type,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int __hid_bpf_hw_check_params(Ptr<hid_bpf_ctx> ctx, Ptr<java.lang.Character> buf,
      Ptr<java.lang. @Unsigned Long> buf__sz, hid_report_type rtype) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int __hid_bpf_hw_request(Ptr<hid_bpf_ctx> ctx, char reportnum,
      hid_report_type rtype, hid_class_request reqtype, @Unsigned long source) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int __hid_bpf_input_report(Ptr<hid_bpf_ctx> ctx, hid_report_type type,
      Ptr<java.lang.Character> buf, @Unsigned long size, boolean lock_already_taken) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int hid_bpf_ops_init(Ptr<btf> btf) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int hid_bpf_reg(Ptr<?> kdata, Ptr<bpf_link> link) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void hid_bpf_unreg(Ptr<?> kdata, Ptr<bpf_link> link) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long hid_show(Ptr<device> dev, Ptr<device_attribute> attr,
      String buf) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @Type(
      ...
      cType = "struct hid_uid"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class hid_uid extends Struct {
    public String hid;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct hid_device_id"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class hid_device_id extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "enum hid_report_type"
  )
  public enum hid_report_type implements Enum<hid_report_type>, TypedEnum<hid_report_type, java.lang. @Unsigned Integer> {
    /**
     * {@code HID_INPUT_REPORT = 0}
     */
    @EnumMember(
        value = 0L,
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "enum hid_class_request"
  )
  public enum hid_class_request implements Enum<hid_class_request>, TypedEnum<hid_class_request, java.lang. @Unsigned Integer> {
    /**
     * {@code HID_REQ_GET_REPORT = 1}
     */
    @EnumMember(
        value = 1L,
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct hid_bpf_ctx"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class hid_bpf_ctx extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct hid_device"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class hid_device extends Struct {
    public Ptr<java.lang.Character> dev_rdesc;

    public Ptr<java.lang.Character> bpf_rdesc;

    public Ptr<java.lang.Character> rdesc;

    public @Unsigned int dev_rsize;

    public @Unsigned int bpf_rsize;
    ...
    public hid_report_enum @Size(3) [] report_enum;

    public work_struct led_work;

    public semaphore driver_input_lock;
    ...
    public mutex ll_open_lock;

    public @Unsigned int ll_open_count;

    public Ptr<power_supply> battery;
    ...
    public @OriginalName("ktime_t") long battery_ratelimit_time;
    ...
    public char @Size(64) [] phys;

    public char @Size(64) [] uniq;
    ...
    public Ptr<dentry> debug_rdesc;

    public Ptr<dentry> debug_events;

    public list_head debug_list;

    public @OriginalName("spinlock_t") spinlock debug_list_lock;

    public @OriginalName("wait_queue_head_t") wait_queue_head debug_wait;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct hid_ops"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class hid_ops extends Struct {
    ...
    public Ptr<bus_type> bus_type;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct hid_report"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class hid_report extends Struct {
    public list_head list;

    public list_head hidinput_list;

    public list_head field_entry_list;
    ...
    public Ptr<hid_field> @Size(256) [] field;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct hid_report_enum"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class hid_report_enum extends Struct {
    public @Unsigned int numbered;

    public list_head report_list;

    public Ptr<hid_report> @Size(256) [] report_id_hash;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct hid_bpf_ops"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class hid_bpf_ops extends Struct {
    public int hid_id;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct hid_bpf"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class hid_bpf extends Struct {
    public Ptr<java.lang.Character> device_data;
    ...
    public list_head prog_list;

    public mutex prog_list_lock;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct hid_collection"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class hid_collection extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct hid_usage"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class hid_usage extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct hid_field"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class hid_field extends Struct {
    ...
    public Ptr<java.lang.Integer> value;

    public Ptr<java.lang.Integer> new_value;

    public Ptr<java.lang.Integer> usages_priorities;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct hid_input"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class hid_input extends Struct {
    public list_head list;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct hid_field_entry"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class hid_field_entry extends Struct {
    public list_head list;
  ...
  public enum hid_type implements Enum<hid_type>, TypedEnum<hid_type, java.lang. @Unsigned Integer> {
    /**
     * {@code HID_TYPE_OTHER = 0}
     */
    @EnumMember(
        value = 0L,
        name = "HID_TYPE_OTHER"
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "enum hid_battery_status"
  )
  public enum hid_battery_status implements Enum<hid_battery_status>, TypedEnum<hid_battery_status, java.lang. @Unsigned Integer> {
    /**
     * {@code HID_BATTERY_UNKNOWN = 0}
     */
    @EnumMember(
        value = 0L,
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct hid_driver"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class hid_driver extends Struct {
    public String name;

    public Ptr<hid_device_id> id_table;

    public list_head dyn_list;

    public @OriginalName("spinlock_t") spinlock dyn_lock;
    ...
    public Ptr<?> on_hid_hw_open;

    public Ptr<?> on_hid_hw_close;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct hid_ll_driver"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class hid_ll_driver extends Struct {
    public Ptr<?> start;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct hid_report_id"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class hid_report_id extends Struct {
    public @Unsigned int report_type;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct hid_usage_id"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class hid_usage_id extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct hid_bpf_ctx_kern"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class hid_bpf_ctx_kern extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct hid_bpf_offset_write_range"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class hid_bpf_offset_write_range extends Struct {

...
/**
 * Generated class for BPF runtime types that start with calipso
 */
...
public final class CalipsoDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int calipso_doi_add(Ptr<calipso_doi> doi_def, Ptr<netlbl_audit> audit_info) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void calipso_doi_free_rcu(Ptr<callback_head> entry) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int calipso_doi_remove(@Unsigned int doi, Ptr<netlbl_audit> audit_info) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction("calipso_doi_walk($arg1, (int (*)(struct calipso_doi*, void*))$arg2, $arg3)")
  public static int calipso_doi_walk(Ptr<java.lang. @Unsigned Integer> skip_cnt, Ptr<?> callback,
      Ptr<?> cb_arg) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int calipso_opt_del(Ptr<ipv6_opt_hdr> hop, Ptr<Ptr<ipv6_opt_hdr>> _new) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int calipso_opt_find(Ptr<ipv6_opt_hdr> hop, Ptr<java.lang. @Unsigned Integer> start,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int calipso_opt_update(Ptr<sock> sk, Ptr<ipv6_opt_hdr> hop) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void calipso_req_delattr(Ptr<request_sock> req) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int calipso_skbuff_delattr(Ptr<sk_buff> skb) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void calipso_sock_delattr(Ptr<sock> sk) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int calipso_sock_getattr(Ptr<sock> sk, Ptr<netlbl_lsm_secattr> secattr) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int calipso_tlv_len(Ptr<ipv6_opt_hdr> opt, @Unsigned int offset) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @Type(
      ...
      cType = "struct calipso_doi"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class calipso_doi extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct calipso_map_cache_bkt"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class calipso_map_cache_bkt extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct calipso_map_cache_entry"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class calipso_map_cache_entry extends Struct {

...
/**
 * Generated class for BPF runtime types that start with cc
 */
...
public final class CcDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void cc_platform_clear(cc_attr attr) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void cc_platform_set(cc_attr attr) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  public enum cc_attr implements Enum<cc_attr>, TypedEnum<cc_attr, java.lang. @Unsigned Integer> {
    /**
    ...
    /**
     * {@code CC_ATTR_GUEST_SNP_SECURE_TSC = 6}
     */
    @EnumMember(
        value = 6L,
        name = "CC_ATTR_GUEST_SNP_SECURE_TSC"
    )
    CC_ATTR_GUEST_SNP_SECURE_TSC,

    /**
     * {@code CC_ATTR_HOST_SEV_SNP = 7}
     */
    @EnumMember(
        value = 7L,
        name = "CC_ATTR_HOST_SEV_SNP"
    )
  ...
  public enum cc_vendor implements Enum<cc_vendor>, TypedEnum<cc_vendor, java.lang. @Unsigned Integer> {
    /**
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct cc_attr_flags"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class cc_attr_flags extends Struct {

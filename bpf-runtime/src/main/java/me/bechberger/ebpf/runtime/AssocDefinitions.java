...
/**
 * Generated class for BPF runtime types that start with assoc
 */
...
public final class AssocDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void assoc_array_rcu_cleanup(Ptr<callback_head> head) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @Type(
      ...
      cType = "struct assoc_array"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class assoc_array extends Struct {
    public @OriginalName("assoc_array_ptr") Ptr<?> root;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct assoc_array_ops"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class assoc_array_ops extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct assoc_array_node"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class assoc_array_node extends Struct {
    public @OriginalName("assoc_array_ptr") Ptr<?> back_pointer;

    public char parent_slot;

    public @OriginalName("assoc_array_ptr") Ptr<?> @Size(16) [] slots;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct assoc_array_shortcut"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class assoc_array_shortcut extends Struct {
    public @OriginalName("assoc_array_ptr") Ptr<?> back_pointer;
    ...
    public @OriginalName("assoc_array_ptr") Ptr<?> next_node;

    public @Unsigned long @Size(0) [] index_key;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct assoc_array_edit"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class assoc_array_edit extends Struct {
    ...
    public @OriginalName("assoc_array_ptr") Ptr<?> leaf;

    public Ptr<@OriginalName("assoc_array_ptr") Ptr<?>> leaf_p;

    public @OriginalName("assoc_array_ptr") Ptr<?> dead_leaf;

    public @OriginalName("assoc_array_ptr") Ptr<?> @Size(3) [] new_meta;

    public @OriginalName("assoc_array_ptr") Ptr<?> @Size(1) [] excised_meta;

    public @OriginalName("assoc_array_ptr") Ptr<?> excised_subtree;

    public Ptr<@OriginalName("assoc_array_ptr") Ptr<?>> @Size(16) [] set_backpointers;

    public @OriginalName("assoc_array_ptr") Ptr<?> set_backpointers_to;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "enum assoc_array_walk_status"
  )
  public enum assoc_array_walk_status implements Enum<assoc_array_walk_status>, TypedEnum<assoc_array_walk_status, java.lang. @Unsigned Integer> {
    /**
     * {@code assoc_array_walk_tree_empty = 0}
     */
    @EnumMember(
        value = 0L,
        name = "assoc_array_walk_tree_empty"
    )
    assoc_array_walk_tree_empty,

    /**
     * {@code assoc_array_walk_found_terminal_node = 1}
     */
    @EnumMember(
        value = 1L,
        name = "assoc_array_walk_found_terminal_node"
    )
    assoc_array_walk_found_terminal_node,

    /**
     * {@code assoc_array_walk_found_wrong_shortcut = 2}
     */
    @EnumMember(
        value = 2L,
        name = "assoc_array_walk_found_wrong_shortcut"
    )
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct assoc_array_walk_result"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class assoc_array_walk_result extends Struct {
    public terminal_node_of_assoc_array_walk_result terminal_node;

    public wrong_shortcut_of_assoc_array_walk_result wrong_shortcut;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct assoc_array_delete_collapse_context"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class assoc_array_delete_collapse_context extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct { assoc_array_ptr **ptr; assoc_array_ptr *to; }"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava

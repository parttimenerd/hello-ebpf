...
/**
 * Generated class for BPF runtime types that start with hmac
 */
@java.lang.SuppressWarnings("unused")
public final class HmacDefinitions {
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int __hmac_create_shash(Ptr<crypto_template> tmpl, Ptr<Ptr<rtattr>> tb,
      @Unsigned int mask) {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void __hmac_sha256_final(Ptr<__hmac_sha256_ctx> ctx, Ptr<java.lang.Character> out,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void __hmac_sha512_final(Ptr<__hmac_sha512_ctx> ctx, Ptr<java.lang.Character> out,
      @Unsigned long digest_size) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void hmac_add_misc(Ptr<shash_desc> desc, Ptr<inode> inode, char type,
      String digest) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int hmac_clone_ahash_tfm(Ptr<crypto_ahash> dst, Ptr<crypto_ahash> src) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int hmac_clone_tfm(Ptr<crypto_shash> dst, Ptr<crypto_shash> src) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int hmac_create(Ptr<crypto_template> tmpl, Ptr<Ptr<rtattr>> tb) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int hmac_create_ahash(Ptr<crypto_template> tmpl, Ptr<Ptr<rtattr>> tb,
      @Unsigned int mask) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int hmac_create_shash(Ptr<crypto_template> tmpl, Ptr<Ptr<rtattr>> tb) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int hmac_digest_ahash(Ptr<ahash_request> preq) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void hmac_exit_ahash_tfm(Ptr<crypto_ahash> parent) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void hmac_exit_tfm(Ptr<crypto_shash> parent) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int hmac_export(Ptr<shash_desc> pdesc, Ptr<?> out) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int hmac_export_ahash(Ptr<ahash_request> preq, Ptr<?> out) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int hmac_export_core(Ptr<shash_desc> pdesc, Ptr<?> out) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int hmac_export_core_ahash(Ptr<ahash_request> preq, Ptr<?> out) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int hmac_finup_ahash(Ptr<ahash_request> preq) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void hmac_finup_done(Ptr<?> data, int err) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int hmac_finup_finish(Ptr<ahash_request> preq, @Unsigned int mask) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int hmac_init(Ptr<shash_desc> pdesc) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int hmac_init_ahash(Ptr<ahash_request> preq) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int hmac_init_ahash_tfm(Ptr<crypto_ahash> parent) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int hmac_init_tfm(Ptr<crypto_shash> parent) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void hmac_sha1_final(Ptr<hmac_sha1_ctx> ctx, Ptr<java.lang.Character> out) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void hmac_sha224_final(Ptr<hmac_sha224_ctx> ctx, Ptr<java.lang.Character> out) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void hmac_sha256_final(Ptr<hmac_sha256_ctx> ctx, Ptr<java.lang.Character> out) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void hmac_sha384_final(Ptr<hmac_sha384_ctx> ctx, Ptr<java.lang.Character> out) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void hmac_sha512_final(Ptr<hmac_sha512_ctx> ctx, Ptr<java.lang.Character> out) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int hmac_update_ahash(Ptr<ahash_request> preq) {
    throw new MethodIsBPFRelatedFunction();
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct hmac_ctx"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class hmac_ctx extends Struct {
    public Ptr<crypto_shash> hash;

    public char @Size(0) [] pads;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct hmac_sha1_key"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class hmac_sha1_key extends Struct {
    public sha1_block_state istate;

    public sha1_block_state ostate;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct hmac_sha1_ctx"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class hmac_sha1_ctx extends Struct {
    public sha1_ctx sha_ctx;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct __hmac_sha256_key"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class __hmac_sha256_key extends Struct {
    public sha256_block_state istate;

    public sha256_block_state ostate;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct __hmac_sha256_ctx"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class __hmac_sha256_ctx extends Struct {
    public __sha256_ctx sha_ctx;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct hmac_sha224_key"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class hmac_sha224_key extends Struct {
    public __hmac_sha256_key key;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct hmac_sha224_ctx"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class hmac_sha224_ctx extends Struct {
    public __hmac_sha256_ctx ctx;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct hmac_sha256_key"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class hmac_sha256_key extends Struct {
    public __hmac_sha256_key key;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct hmac_sha256_ctx"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class hmac_sha256_ctx extends Struct {
    public __hmac_sha256_ctx ctx;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct __hmac_sha512_key"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class __hmac_sha512_key extends Struct {
    public sha512_block_state istate;

    public sha512_block_state ostate;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct __hmac_sha512_ctx"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class __hmac_sha512_ctx extends Struct {
    public __sha512_ctx sha_ctx;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct hmac_sha384_key"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class hmac_sha384_key extends Struct {
    public __hmac_sha512_key key;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct hmac_sha384_ctx"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class hmac_sha384_ctx extends Struct {
    public __hmac_sha512_ctx ctx;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct hmac_sha512_key"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class hmac_sha512_key extends Struct {
    public __hmac_sha512_key key;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct hmac_sha512_ctx"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class hmac_sha512_ctx extends Struct {
    public __hmac_sha512_ctx ctx;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct hmac_storage"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class hmac_storage extends Struct {
    public @OriginalName("local_lock_t") lockdep_map_p bh_lock;

    public char @Size(256) [] hmac_ring;
  }
}

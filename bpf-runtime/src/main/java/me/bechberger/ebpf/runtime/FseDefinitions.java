...
/**
 * Generated class for BPF runtime types that start with fse
 */
@java.lang.SuppressWarnings("unused")
public final class FseDefinitions {
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @Unsigned long FSE_buildCTable_rle(
      Ptr<java.lang. @Unsigned @OriginalName("FSE_CTable") Integer> ct,
      @OriginalName("BYTE") char symbolValue) {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction("((const u8*)FSE_getErrorName($arg1))")
  public static String FSE_getErrorName(@Unsigned long code) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static @Unsigned int FSE_isError(@Unsigned long code) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @Unsigned int FSE_optimalTableLog(@Unsigned int maxTableLog, @Unsigned long srcSize,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @Unsigned int FSE_optimalTableLog_internal(@Unsigned int maxTableLog,
      @Unsigned long srcSize, @Unsigned int maxSymbolValue, @Unsigned int minus) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @Type(
      ...
      cType = "struct { int deltaFindState; unsigned int deltaNbBits; }"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class FSE_symbolCompressionTransform extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct { short unsigned int newState; u8 symbol; u8 nbBits; }"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class FSE_decode_t extends Struct {

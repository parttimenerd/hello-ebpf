...
/**
 * Generated class for BPF runtime types that start with nmi
 */
...
public final class NmiDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static boolean nmi_cpu_backtrace(Ptr<pt_regs> regs) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int nmi_cpu_backtrace_handler(@Unsigned int cmd, Ptr<pt_regs> regs) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int nmi_handle(@Unsigned int type, Ptr<pt_regs> regs) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void nmi_panic_self_stop(Ptr<pt_regs> regs) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void nmi_raise_cpu_backtrace(Ptr<@OriginalName("cpumask_t") cpumask> mask) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void nmi_shootdown_cpus(@OriginalName("nmi_shootdown_cb") Ptr<?> callback) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @Type(
      ...
      cType = "struct { u8 injected; u8 pending; u8 masked; u8 pad; }"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class nmi_of_kvm_vcpu_events extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct nmi_desc"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class nmi_desc extends Struct {
    public @OriginalName("raw_spinlock_t") raw_spinlock lock;

    public @OriginalName("nmi_handler_t") Ptr<?> emerg_handler;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct nmi_stats"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class nmi_stats extends Struct {
    ...
    public @OriginalName("atomic_long_t") atomic64_t idt_calls;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "enum nmi_states"
  )
  public enum nmi_states implements Enum<nmi_states>, TypedEnum<nmi_states, java.lang. @Unsigned Integer> {
    /**
     * {@code NMI_NOT_RUNNING = 0}
     */
    @EnumMember(
        value = 0L,
        name = "NMI_NOT_RUNNING"
    )
    NMI_NOT_RUNNING,

    /**
     * {@code NMI_EXECUTING = 1}
     */
    @EnumMember(
        value = 1L,
        name = "NMI_EXECUTING"

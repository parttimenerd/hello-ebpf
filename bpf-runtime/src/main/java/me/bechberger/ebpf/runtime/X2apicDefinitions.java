...
/**
 * Generated class for BPF runtime types that start with x2apic
 */
...
public final class X2apicDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @Unsigned int x2apic_calc_apicid(@Unsigned int cpu) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int x2apic_prepare_cpu(@Unsigned int cpu) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void x2apic_send_IPI(int cpu, int vector) {
    throw new MethodIsBPFRelatedFunction();
  }

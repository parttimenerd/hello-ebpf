...
/**
 * Generated class for BPF runtime types that start with keyring
 */
...
public final class KeyringDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int keyring_clear(Ptr<key> keyring) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void keyring_destroy(Ptr<key> keyring) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int keyring_detect_cycle(Ptr<key> A, Ptr<key> B) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void keyring_free_preparse(Ptr<key_preparsed_payload> prep) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void keyring_gc(Ptr<key> keyring, @OriginalName("time64_t") long limit) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int keyring_instantiate(Ptr<key> keyring, Ptr<key_preparsed_payload> prep) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int keyring_preparse(Ptr<key_preparsed_payload> prep) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void keyring_restriction_gc(Ptr<key> keyring, Ptr<key_type> dead_type) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void keyring_revoke(Ptr<key> keyring) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("__key_reference_with_attributes") @OriginalName("__key_reference_with_attributes") @OriginalName("key_ref_t") Ptr<?> keyring_search_rcu(
      @OriginalName("__key_reference_with_attributes") @OriginalName("__key_reference_with_attributes") @OriginalName("key_ref_t") Ptr<?> keyring_ref,
      Ptr<keyring_search_context> ctx) {
    throw new MethodIsBPFRelatedFunction();
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct keyring_index_key"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class keyring_index_key extends Struct {
    public @Unsigned long hash;

    @InlineUnion(1014)
    public anon_member_of_anon_member_of_keyring_index_key anon1$0;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct keyring_search_context"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class keyring_search_context extends Struct {
    public keyring_index_key index_key;

    public Ptr<cred> cred;

    public key_match_data match_data;
    ...
    public @OriginalName("__key_reference_with_attributes") @OriginalName("__key_reference_with_attributes") @OriginalName("key_ref_t") Ptr<?> result;

    public @OriginalName("time64_t") long now;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct keyring_read_iterator_context"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class keyring_read_iterator_context extends Struct {
    public @Unsigned long buflen;

    public @Unsigned long count;

    public Ptr<java.lang. @OriginalName("key_serial_t") Integer> buffer;
  }
}

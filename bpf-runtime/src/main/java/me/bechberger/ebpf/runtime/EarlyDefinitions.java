...
/**
 * Generated class for BPF runtime types that start with early
 */
@java.lang.SuppressWarnings("unused")
public final class EarlyDefinitions {
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<?> __early_ioremap(@Unsigned @OriginalName("resource_size_t") long phys_addr,
      @Unsigned long size, @OriginalName("pgprot_t") pgprot prot) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static boolean __early_make_pgtable(@Unsigned long address,
      @Unsigned @OriginalName("pmdval_t") long pmd) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void __early_set_fixmap(fixed_addresses idx,
      @Unsigned @OriginalName("phys_addr_t") long phys, @OriginalName("pgprot_t") pgprot flags) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int early_cache_level(@Unsigned int cpu) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int early_cma(String p) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int early_cma_pernuma(String p) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void early_console_register(Ptr<console> con, int keep_early) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int early_cpu_to_node(int cpu) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int early_dbgp_init(String s) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void early_dump_pci_device(Ptr<pci_dev> pdev) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void early_enable_events(Ptr<trace_array> tr, String buf, boolean disable_first) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void early_enable_iommu(Ptr<amd_iommu> iommu) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void early_fixup_exception(Ptr<pt_regs> regs, int trapnr) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int early_hostname(String arg) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void early_identify_cpu(Ptr<cpuinfo_x86> c) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void early_init_amd(Ptr<cpuinfo_x86> c) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void early_init_centaur(Ptr<cpuinfo_x86> c) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void early_init_hygon(Ptr<cpuinfo_x86> c) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void early_init_intel(Ptr<cpuinfo_x86> c) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @Unsigned @OriginalName("acpi_status") int early_init_pdc(
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void early_init_zhaoxin(Ptr<cpuinfo_x86> c) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<?> early_ioremap(@Unsigned @OriginalName("resource_size_t") long phys_addr,
      @Unsigned long size) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<pmd_t> early_ioremap_pmd(@Unsigned long addr) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void early_iounmap(Ptr<?> addr, @Unsigned long size) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static boolean early_is_amd_nb(@Unsigned int device) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<?> early_memremap(@Unsigned @OriginalName("resource_size_t") long phys_addr,
      @Unsigned long size) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<?> early_memremap_decrypted(
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<?> early_memremap_decrypted_wp(
      @Unsigned @OriginalName("resource_size_t") long phys_addr, @Unsigned long size) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<?> early_memremap_encrypted(
      @Unsigned @OriginalName("resource_size_t") long phys_addr, @Unsigned long size) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<?> early_memremap_encrypted_wp(
      @Unsigned @OriginalName("resource_size_t") long phys_addr, @Unsigned long size) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("pgprot_t") pgprot early_memremap_pgprot_adjust(
      @Unsigned @OriginalName("resource_size_t") long phys_addr, @Unsigned long size,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<?> early_memremap_prot(
      @Unsigned @OriginalName("resource_size_t") long phys_addr, @Unsigned long size,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<?> early_memremap_ro(@Unsigned @OriginalName("resource_size_t") long phys_addr,
      @Unsigned long size) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void early_memtest(@Unsigned @OriginalName("phys_addr_t") long start,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void early_memunmap(Ptr<?> addr, @Unsigned long size) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int early_mod_check(Ptr<load_info> info, int flags) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int early_numa_cma(String p) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void early_pci_clear_msi(int bus, int slot, int func) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void early_pci_serial_init(String s) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int early_serial8250_read(Ptr<console> console, String s, @Unsigned int count) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void early_serial_init(String s) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int early_serial_setup(Ptr<uart_port> port) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void early_set_mem_enc_dec_hypercall(@Unsigned long vaddr, @Unsigned long size,
      boolean enc) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int early_set_memory_enc_dec(@Unsigned long vaddr, @Unsigned long size,
      boolean enc) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void early_set_pages_state(@Unsigned long vaddr, @Unsigned long paddr,
      @Unsigned long npages, psc_op op) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void early_snp_set_memory_private(@Unsigned long vaddr, @Unsigned long paddr,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void early_snp_set_memory_shared(@Unsigned long vaddr, @Unsigned long paddr,
      @Unsigned long npages) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long early_stop_show(Ptr<device> dev,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int early_xdbc_parse_parameter(String s, int keep_early) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @Type(
      ...
      cType = "struct early_load_data"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class early_load_data extends Struct {

...
/**
 * Generated class for BPF runtime types that start with new
 */
@java.lang.SuppressWarnings("unused")
public final class NewDefinitions {
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<khoser_mem_chunk> new_chunk(Ptr<khoser_mem_chunk> cur_chunk,
      @Unsigned long order) {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<configfs_fragment> new_fragment() {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long new_id_show(Ptr<device_driver> driver, String buf) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<inode> new_inode(Ptr<super_block> sb) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void new_kmalloc_cache(int idx, kmalloc_cache_type type) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long new_level_show(Ptr<mddev> mddev, String page) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<ctl_table_header> new_links(Ptr<ctl_dir> dir, Ptr<ctl_table_header> head) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long new_offset_show(Ptr<md_rdev> rdev, String page) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<?> new_vmap_block(@Unsigned int order,
  ...
  @NotUsableInJava
  public static class new_utsname extends Struct {
    ...
    public char @Size(65) [] domainname;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct new_asid"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class new_asid extends Struct {
    public @Unsigned int asid;

    public @Unsigned int need_flush;
  }
}

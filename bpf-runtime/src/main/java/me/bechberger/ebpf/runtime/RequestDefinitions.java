...
/**
 * Generated class for BPF runtime types that start with request
 */
...
public final class RequestDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<resource> __request_resource(Ptr<resource> root, Ptr<resource> _new) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<key> request_asymmetric_key(Ptr<key> keyring,
      @Unsigned @OriginalName("uint32_t") int keyid) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void request_firmware_work_func(Ptr<work_struct> work) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void request_key_auth_destroy(Ptr<key> key) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void request_key_auth_free_preparse(Ptr<key_preparsed_payload> prep) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int request_key_auth_instantiate(Ptr<key> key, Ptr<key_preparsed_payload> prep) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int request_key_auth_preparse(Ptr<key_preparsed_payload> prep) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void request_key_auth_rcu_disposal(Ptr<callback_head> rcu) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void request_key_auth_revoke(Ptr<key> key) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction("request_master_key($arg1, (const u8**)$arg2, $arg3)")
  public static Ptr<key> request_master_key(Ptr<encrypted_key_payload> epayload,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static ucode_state request_microcode_amd(int cpu, Ptr<device> device) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static ucode_state request_microcode_fw(int cpu, Ptr<device> device) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int request_resource(Ptr<resource> root, Ptr<resource> _new) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<resource> request_resource_conflict(Ptr<resource> root, Ptr<resource> _new) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void request_wait_answer(Ptr<fuse_req> req) {
    throw new MethodIsBPFRelatedFunction();
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct request_queue"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class request_queue extends Struct {
    public Ptr<?> queuedata;

    public Ptr<elevator_queue> elevator;

    public Ptr<blk_mq_ops> mq_ops;
    ...
    public xarray hctx_table;

    public percpu_ref q_usage_counter;

    public lock_class_key io_lock_cls_key;

    public lockdep_map io_lockdep_map;

    public lock_class_key q_lock_cls_key;

    public lockdep_map q_lockdep_map;

    public Ptr<request> last_merge;
    ...
    public Ptr<kobject> mq_kobj;

    public queue_limits limits;

    public Ptr<device> dev;

    public rpm_status rpm_status;

    public atomic_t pm_only;

    public Ptr<blk_queue_stats> stats;

    public Ptr<rq_qos> rq_qos;

    public mutex rq_qos_mutex;
    ...
    public Ptr<kobject> crypto_kobject;

    public timer_list timeout;

    public work_struct timeout_work;

    public atomic_t nr_active_requests_shared_tags;

    public Ptr<blk_mq_tags> sched_shared_tags;

    public list_head icq_list;

    public @Unsigned long @Size(1) [] blkcg_pols;

    public Ptr<blkcg_gq> root_blkg;

    public list_head blkg_list;

    public mutex blkcg_mutex;

    public int node;

    public @OriginalName("spinlock_t") spinlock requeue_lock;

    public list_head requeue_list;

    public delayed_work requeue_work;

    public Ptr<blk_trace> blk_trace;

    public Ptr<blk_flush_queue> fq;

    public list_head flush_list;

    public mutex elevator_lock;

    public mutex sysfs_lock;

    public mutex limits_lock;

    public list_head unused_hctx_list;

    public @OriginalName("spinlock_t") spinlock unused_hctx_lock;
    ...
    public @OriginalName("wait_queue_head_t") wait_queue_head mq_freeze_wq;

    public mutex mq_freeze_lock;

    public Ptr<blk_mq_tag_set> tag_set;

    public list_head tag_set_list;

    public Ptr<dentry> debugfs_dir;

    public Ptr<dentry> sched_debugfs_dir;

    public Ptr<dentry> rqos_debugfs_dir;

    public mutex debugfs_mutex;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct request_sock_ops"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class request_sock_ops extends Struct {
    public int family;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct request_sock"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class request_sock extends Struct {
    public sock_common __req_common;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct request_sock__safe_rcu_or_null"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class request_sock__safe_rcu_or_null extends Struct {
    public Ptr<sock> sk;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct request_key_auth"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class request_key_auth extends Struct {
    public callback_head rcu;

    public Ptr<key> target_key;

    public Ptr<key> dest_keyring;
    ...
    public char @Size(8) [] op;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct request_sense"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class request_sense extends Struct {
    ...
    public char @Size(4) [] information;

    public char add_sense_len;

    public char @Size(4) [] command_info;
    ...
    public char @Size(3) [] sks;

    public char @Size(46) [] asb;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct request_sock_queue"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class request_sock_queue extends Struct {
    public @OriginalName("spinlock_t") spinlock rskq_lock;

    public char rskq_defer_accept;

    public @Unsigned int synflood_warned;

    public atomic_t qlen;

    public atomic_t young;

    public Ptr<request_sock> rskq_accept_head;

    public Ptr<request_sock> rskq_accept_tail;

    public fastopen_queue fastopenq;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct { short unsigned int csum_start; short unsigned int csum_offset; long long unsigned int launch_time; }"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class request_of_anon_member_of_xsk_tx_metadata extends Struct {
    public @Unsigned short csum_start;

    public @Unsigned short csum_offset;

    public @Unsigned long launch_time;
  }
}

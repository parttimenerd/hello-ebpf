...
/**
 * Generated class for BPF runtime types that start with simple
 */
@java.lang.SuppressWarnings("unused")
public final class SimpleDefinitions {
  @NotUsableInJava
  @BuiltinBPFFunction("__simple_recursive_removal($arg1, (void (*)(struct dentry*))$arg2, $arg3)")
  public static void __simple_recursive_removal(Ptr<dentry> dentry, Ptr<?> callback,
      boolean locked) {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int simple_acl_create(Ptr<inode> dir, Ptr<inode> inode) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long simple_attr_read(Ptr<file> file, String buf,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int simple_attr_release(Ptr<inode> inode, Ptr<file> file) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static String simple_dname(Ptr<dentry> dentry, String buffer, int buflen) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int simple_empty(Ptr<dentry> dentry) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction("((const u8*)simple_get_link($arg1, $arg2, $arg3))")
  public static String simple_get_link(Ptr<dentry> dentry, Ptr<inode> inode,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static timespec64 simple_inode_init_ts(Ptr<inode> inode) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int simple_link(Ptr<dentry> old_dentry, Ptr<inode> dir, Ptr<dentry> dentry) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<dentry> simple_lookup(Ptr<inode> dir, Ptr<dentry> dentry, @Unsigned int flags) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int simple_nosetlease(Ptr<file> filp, int arg, Ptr<Ptr<file_lease>> flp,
      Ptr<Ptr<?>> priv) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int simple_offset_add(Ptr<offset_ctx> octx, Ptr<dentry> dentry) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void simple_offset_destroy(Ptr<offset_ctx> octx) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void simple_offset_init(Ptr<offset_ctx> octx) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void simple_offset_remove(Ptr<offset_ctx> octx, Ptr<dentry> dentry) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void simple_offset_rename(Ptr<inode> old_dir, Ptr<dentry> old_dentry,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int simple_offset_rename_exchange(Ptr<inode> old_dir, Ptr<dentry> old_dentry,
      Ptr<inode> new_dir, Ptr<dentry> new_dentry) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int simple_open(Ptr<inode> inode, Ptr<file> file) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int simple_pin_fs(Ptr<file_system_type> type, Ptr<Ptr<vfsmount>> mount,
      Ptr<java.lang.Integer> count) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int simple_read_folio(Ptr<file> file, Ptr<folio> folio) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction("simple_recursive_removal($arg1, (void (*)(struct dentry*))$arg2)")
  public static void simple_recursive_removal(Ptr<dentry> dentry, Ptr<?> callback) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void simple_release_fs(Ptr<Ptr<vfsmount>> mount, Ptr<java.lang.Integer> count) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int simple_rename(Ptr<mnt_idmap> idmap, Ptr<inode> old_dir, Ptr<dentry> old_dentry,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int simple_rename_exchange(Ptr<inode> old_dir, Ptr<dentry> old_dentry,
      Ptr<inode> new_dir, Ptr<dentry> new_dentry) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void simple_rename_timestamp(Ptr<inode> old_dir, Ptr<dentry> old_dentry,
      Ptr<inode> new_dir, Ptr<dentry> new_dentry) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int simple_rmdir(Ptr<inode> dir, Ptr<dentry> dentry) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int simple_set_acl(Ptr<mnt_idmap> idmap, Ptr<dentry> dentry, Ptr<posix_acl> acl,
      int type) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int simple_setattr(Ptr<mnt_idmap> idmap, Ptr<dentry> dentry, Ptr<iattr> iattr) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int simple_statfs(Ptr<dentry> dentry, Ptr<kstatfs> buf) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long simple_transaction_read(Ptr<file> file, String buf,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int simple_transaction_release(Ptr<inode> inode, Ptr<file> file) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void simple_transaction_set(Ptr<file> file, @Unsigned long n) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int simple_unlink(Ptr<inode> dir, Ptr<dentry> dentry) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void simple_xattr_free(Ptr<simple_xattr> xattr) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long simple_xattr_list(Ptr<inode> inode,
      Ptr<simple_xattrs> xattrs, String buffer, @Unsigned long size) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void simple_xattrs_free(Ptr<simple_xattrs> xattrs,
      Ptr<java.lang. @Unsigned Long> freed_space) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @Type(
      ...
      cType = "struct simple_xattrs"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class simple_xattrs extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct simple_xattr"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class simple_xattr extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct simple_transaction_argresp"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class simple_transaction_argresp extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct simple_attr"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class simple_attr extends Struct {
    public Ptr<?> get;

    public Ptr<?> set;

    public char @Size(24) [] get_buf;

    public char @Size(24) [] set_buf;

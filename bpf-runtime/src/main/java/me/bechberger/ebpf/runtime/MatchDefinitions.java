...
/**
 * Generated class for BPF runtime types that start with match
 */
@java.lang.SuppressWarnings("unused")
public final class MatchDefinitions {
  @NotUsableInJava
  @BuiltinBPFFunction("match_addr_label($arg1, $arg2, $arg3, $arg4, $arg5, (const u8**)$arg6)")
  public static @Unsigned int match_addr_label(Ptr<aa_policydb> policy, @Unsigned int state,
      @Unsigned int request, Ptr<match_addr> maddr, Ptr<Ptr<aa_perms>> p, Ptr<String> info) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int match_any(Ptr<acpi_device> adev, Ptr<?> not_used) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int match_device_ids(Ptr<acpi_device> adev, Ptr<?> data) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static boolean match_endpoint(Ptr<usb_endpoint_descriptor> epd,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static boolean match_exception(Ptr<list_head> exceptions, short type, @Unsigned int major,
      @Unsigned int minor, short access) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static boolean match_exception_partial(Ptr<list_head> exceptions, short type,
      @Unsigned int major, @Unsigned int minor, short access) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static boolean match_fanout_group(Ptr<packet_type> ptype, Ptr<sock> sk) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int match_hex(Ptr<substring_t> s, Ptr<java.lang.Integer> result) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int match_int(Ptr<substring_t> s, Ptr<java.lang.Integer> result) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int match_location(Ptr<usb_device> peer_hdev, Ptr<?> p) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int match_number(Ptr<substring_t> s, Ptr<java.lang.Integer> result, int base) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int match_octal(Ptr<substring_t> s, Ptr<java.lang.Integer> result) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int match_records(Ptr<ftrace_hash> hash, String func, int len, String mod) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static boolean match_smt(Ptr<cpuinfo_x86> c, Ptr<cpuinfo_x86> o) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int match_u64(Ptr<substring_t> s, Ptr<java.lang. @Unsigned Long> result) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int match_uint(Ptr<substring_t> s, Ptr<java.lang. @Unsigned Integer> result) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @Type(
      ...
      cType = "struct match_token"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class match_token extends Struct {
    public int token;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct { u8 *event; u8 *event_system; }"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class match_data_of_anon_member_of_action_data extends Struct {
    public String event;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct match_workbuf"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class match_workbuf extends Struct {
    public @Unsigned int pos;

    public @Unsigned int len;

    public @Unsigned int @Size(32) [] history;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct match_addr"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class match_addr extends Struct {
    public String addrp;

    public addr_type addrtype;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct match_ids_walk_data"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class match_ids_walk_data extends Struct {

...
/**
 * Generated class for BPF runtime types that start with ebitmap
 */
...
public final class EbitmapDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void ebitmap_destroy(Ptr<ebitmap> e) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void ebitmap_init(Ptr<ebitmap> e) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int ebitmap_netlbl_export(Ptr<ebitmap> ebmap, Ptr<Ptr<netlbl_lsm_catmap>> catmap) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int ebitmap_netlbl_import(Ptr<ebitmap> ebmap, Ptr<netlbl_lsm_catmap> catmap) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int ebitmap_read(Ptr<ebitmap> e, Ptr<policy_file> fp) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int ebitmap_set_bit(Ptr<ebitmap> e, @Unsigned int bit, int value) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @Type(
      ...
      cType = "struct ebitmap_node"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class ebitmap_node extends Struct {
    public Ptr<ebitmap_node> next;

    public @Unsigned long @Size(6) [] maps;

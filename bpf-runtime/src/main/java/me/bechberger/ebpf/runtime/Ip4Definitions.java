...
/**
 * Generated class for BPF runtime types that start with ip4
 */
@java.lang.SuppressWarnings("unused")
public final class Ip4Definitions {
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int __ip4_datagram_connect(Ptr<sock> sk, Ptr<sockaddr> uaddr, int addr_len) {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int ip4_datagram_connect(Ptr<sock> sk, Ptr<sockaddr> uaddr, int addr_len) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void ip4_datagram_release_cb(Ptr<sock> sk) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void ip4_frag_free(Ptr<inet_frag_queue> q) {
    throw new MethodIsBPFRelatedFunction();
  }

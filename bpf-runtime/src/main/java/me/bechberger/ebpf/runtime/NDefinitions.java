...
/**
 * Generated class for BPF runtime types that start with n
 */
@java.lang.SuppressWarnings("unused")
public final class NDefinitions {
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long n_alarm_show(Ptr<device> dev,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long n_ext_ts_show(Ptr<device> dev,
      Ptr<device_attribute> attr, String page) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long n_null_read(Ptr<tty_struct> tty, Ptr<file> file,
      Ptr<java.lang.Character> buf, @Unsigned long nr, Ptr<Ptr<?>> cookie, @Unsigned long offset) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long n_per_out_show(Ptr<device> dev,
      Ptr<device_attribute> attr, String page) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long n_pins_show(Ptr<device> dev,
      Ptr<device_attribute> attr, String page) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void n_tty_check_unthrottle(Ptr<tty_struct> tty) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void n_tty_close(Ptr<tty_struct> tty) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void n_tty_flush_buffer(Ptr<tty_struct> tty) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void n_tty_inherit_ops(Ptr<tty_ldisc_ops> ops) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int n_tty_ioctl(Ptr<tty_struct> tty, @Unsigned int cmd, @Unsigned long arg) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int n_tty_ioctl_helper(Ptr<tty_struct> tty, @Unsigned int cmd, @Unsigned long arg) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int n_tty_open(Ptr<tty_struct> tty) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void n_tty_packet_mode_flush(Ptr<tty_struct> tty) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static @Unsigned @OriginalName("__poll_t") int n_tty_poll(Ptr<tty_struct> tty,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int n_tty_process_echo_ops(Ptr<tty_struct> tty, Ptr<java.lang. @Unsigned Long> tail,
      int space) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long n_tty_read(Ptr<tty_struct> tty, Ptr<file> file,
      Ptr<java.lang.Character> kbuf, @Unsigned long nr, Ptr<Ptr<?>> cookie, @Unsigned long offset) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void n_tty_receive_char(Ptr<tty_struct> tty, char c) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static boolean n_tty_receive_char_canon(Ptr<tty_struct> tty, char c) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void n_tty_receive_char_flagged(Ptr<tty_struct> tty, char c, char flag) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void n_tty_receive_char_special(Ptr<tty_struct> tty, char c,
      boolean lookahead_done) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void n_tty_receive_handle_newline(Ptr<tty_struct> tty, char c) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void n_tty_receive_signal_char(Ptr<tty_struct> tty, int signal, char c) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int n_tty_wait_for_input(Ptr<tty_struct> tty, Ptr<file> file,
      Ptr<wait_queue_entry> wait, Ptr<java.lang.Long> timeout) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void n_tty_write_wakeup(Ptr<tty_struct> tty) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long n_vclocks_show(Ptr<device> dev,
      Ptr<device_attribute> attr, String page) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @Type(
      ...
      cType = "struct n_tty_data"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class n_tty_data extends Struct {
    ...
    public @Unsigned long @Size(4) [] char_map;
    ...
    public char @Size(4096) [] read_buf;

    public @Unsigned long @Size(64) [] read_flags;

    public char @Size(4096) [] echo_buf;
    ...
    public mutex atomic_read_lock;

    public mutex output_lock;
  }
}

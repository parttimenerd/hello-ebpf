...
/**
 * Generated class for BPF runtime types that start with fs
 */
...
public final class FsDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int fs_add_slot(Ptr<hotplug_slot> slot, Ptr<pci_slot> pci_slot) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int fs_bdev_freeze(Ptr<block_device> bdev) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void fs_bdev_mark_dead(Ptr<block_device> bdev, boolean surprise) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void fs_bdev_sync(Ptr<block_device> bdev) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int fs_bdev_thaw(Ptr<block_device> bdev) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<fs_context> fs_context_for_mount(Ptr<file_system_type> fs_type,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<fs_context> fs_context_for_reconfigure(Ptr<dentry> dentry,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<fs_context> fs_context_for_submount(Ptr<file_system_type> type,
      Ptr<dentry> reference) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int fs_lookup_param(Ptr<fs_context> fc, Ptr<fs_parameter> param, boolean want_bdev,
      @Unsigned int flags, Ptr<path> _path) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int fs_name(@Unsigned int index, String buf) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @Unsigned @OriginalName("umode_t") short fs_nonleaf_hit_is_visible(
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @Unsigned @OriginalName("umode_t") short fs_nonleaf_lookup_is_visible(
      Ptr<kobject> kobj, Ptr<attribute> attr, int i) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void fs_put_dax(Ptr<dax_device> dax_dev, Ptr<?> holder) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static char fs_umode_to_dtype(@Unsigned @OriginalName("umode_t") short mode) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static char fs_umode_to_ftype(@Unsigned @OriginalName("umode_t") short mode) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @Type(
      ...
      cType = "struct fs_context"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class fs_context extends Struct {
    public Ptr<fs_context_operations> ops;

    public mutex uapi_mutex;

    public Ptr<file_system_type> fs_type;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct fs_parameter_spec"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class fs_parameter_spec extends Struct {
    public String name;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "enum fs_context_purpose"
  )
  public enum fs_context_purpose implements Enum<fs_context_purpose>, TypedEnum<fs_context_purpose, java.lang. @Unsigned Integer> {
    /**
     * {@code FS_CONTEXT_FOR_MOUNT = 0}
     */
    @EnumMember(
        value = 0L,
    ...
    /**
     * {@code FS_CONTEXT_FOR_SUBMOUNT = 1}
     */
    @EnumMember(
        value = 1L,
    ...
    /**
     * {@code FS_CONTEXT_FOR_RECONFIGURE = 2}
     */
    @EnumMember(
        value = 2L,
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "enum fs_context_phase"
  )
  public enum fs_context_phase implements Enum<fs_context_phase>, TypedEnum<fs_context_phase, java.lang. @Unsigned Integer> {
    /**
     * {@code FS_CONTEXT_CREATE_PARAMS = 0}
     */
    @EnumMember(
        value = 0L,
    ...
    /**
     * {@code FS_CONTEXT_AWAITING_MOUNT = 2}
     */
    @EnumMember(
        value = 2L,
    ...
    /**
     * {@code FS_CONTEXT_AWAITING_RECONF = 3}
     */
    @EnumMember(
        value = 3L,
    ...
    /**
     * {@code FS_CONTEXT_RECONF_PARAMS = 4}
     */
    @EnumMember(
        value = 4L,
    ...
    /**
     * {@code FS_CONTEXT_RECONFIGURING = 5}
     */
    @EnumMember(
        value = 5L,
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "enum fs_value_type"
  )
  public enum fs_value_type implements Enum<fs_value_type>, TypedEnum<fs_value_type, java.lang. @Unsigned Integer> {
    /**
     * {@code fs_value_is_undefined = 0}
     */
    @EnumMember(
        value = 0L,
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct fs_parameter"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class fs_parameter extends Struct {
    public String key;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct fs_context_operations"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class fs_context_operations extends Struct {
    public Ptr<?> free;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct fs_parse_result"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class fs_parse_result extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct fs_struct"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class fs_struct extends Struct {
    public int users;

    public seqlock_t seq;
  ...
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class fs_pin extends Struct {
    public @OriginalName("wait_queue_head_t") wait_queue_head wait;

    public int done;

    public hlist_node s_list;

    public hlist_node m_list;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct fs_sysfs_path"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class fs_sysfs_path extends Struct {
    public char len;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct fs_error_report"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class fs_error_report extends Struct {
    public int error;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct fs_disk_quota"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class fs_disk_quota extends Struct {
    ...
    public char @Size(8) [] d_padding4;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct fs_qfilestat"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class fs_qfilestat extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct fs_quota_stat"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class fs_quota_stat extends Struct {
    ...
    public @OriginalName("fs_qfilestat_t") fs_qfilestat qs_uquota;

    public @OriginalName("fs_qfilestat_t") fs_qfilestat qs_gquota;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct fs_qfilestatv"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class fs_qfilestatv extends Struct {
    public @Unsigned long qfs_ino;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct fs_quota_statv"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class fs_quota_statv extends Struct {
    public byte qs_version;
    ...
    public @Unsigned long @Size(7) [] qs_pad2;
  }
  ...
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class fs_of_anon_member_of_anon_member_of_anon_member_of_apparmor_audit_data extends Struct {

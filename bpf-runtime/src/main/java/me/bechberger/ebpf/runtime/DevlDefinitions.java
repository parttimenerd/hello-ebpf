...
/**
 * Generated class for BPF runtime types that start with devl
 */
@java.lang.SuppressWarnings("unused")
public final class DevlDefinitions {
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void devl_assert_locked(Ptr<devlink> devlink) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void devl_dpipe_headers_register(Ptr<devlink> devlink,
      Ptr<devlink_dpipe_headers> dpipe_headers) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void devl_dpipe_headers_unregister(Ptr<devlink> devlink) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void devl_health_reporter_destroy(Ptr<devlink_health_reporter> reporter) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void devl_linecard_destroy(Ptr<devlink_linecard> linecard) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void devl_lock(Ptr<devlink> devlink) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int devl_nested_devlink_set(Ptr<devlink> devlink, Ptr<devlink> nested_devlink) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int devl_param_driverinit_value_get(Ptr<devlink> devlink, @Unsigned int param_id,
      Ptr<devlink_param_value> val) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void devl_param_driverinit_value_set(Ptr<devlink> devlink, @Unsigned int param_id,
      devlink_param_value init_val) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void devl_param_value_changed(Ptr<devlink> devlink, @Unsigned int param_id) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int devl_port_fn_devlink_set(Ptr<devlink_port> devlink_port,
      Ptr<devlink> fn_devlink) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void devl_port_unregister(Ptr<devlink_port> devlink_port) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int devl_rate_leaf_create(Ptr<devlink_port> devlink_port, Ptr<?> priv,
      Ptr<devlink_rate> parent) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void devl_rate_leaf_destroy(Ptr<devlink_port> devlink_port) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<devlink_rate> devl_rate_node_create(Ptr<devlink> devlink, Ptr<?> priv,
      String node_name, Ptr<devlink_rate> parent) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void devl_rate_nodes_destroy(Ptr<devlink> devlink) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void devl_region_destroy(Ptr<devlink_region> region) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int devl_register(Ptr<devlink> devlink) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void devl_resource_occ_get_register(Ptr<devlink> devlink,
      @Unsigned long resource_id, Ptr<?> occ_get, Ptr<?> occ_get_priv) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void devl_resource_occ_get_unregister(Ptr<devlink> devlink,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int devl_resource_size_get(Ptr<devlink> devlink, @Unsigned long resource_id,
      Ptr<java.lang. @Unsigned Long> p_resource_size) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void devl_resources_unregister(Ptr<devlink> devlink) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int devl_sb_register(Ptr<devlink> devlink, @Unsigned int sb_index,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void devl_sb_unregister(Ptr<devlink> devlink, @Unsigned int sb_index) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int devl_trylock(Ptr<devlink> devlink) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void devl_unlock(Ptr<devlink> devlink) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void devl_unregister(Ptr<devlink> devlink) {
    throw new MethodIsBPFRelatedFunction();
  }
}

...
/**
 * Generated class for BPF runtime types that start with warn
 */
...
public final class WarnDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long warn_count_show(Ptr<kobject> kobj,
  ...
  @Type(
      ...
      cType = "struct warn_args"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class warn_args extends Struct {
    public String fmt;

    public __va_list_tag @Size(1) @OriginalName("va_list") [] args;
  }
}

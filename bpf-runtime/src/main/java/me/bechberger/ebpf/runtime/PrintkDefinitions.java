...
/**
 * Generated class for BPF runtime types that start with printk
 */
...
public final class PrintkDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void printk_force_console_enter() {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void printk_force_console_exit() {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void printk_get_console_flush_type(Ptr<console_flush_type> ft) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static boolean printk_get_next_message(Ptr<printk_message> pmsg, @Unsigned long seq,
      boolean is_extended, boolean may_suppress) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void printk_prot(Ptr<seq_file> m, @Unsigned @OriginalName("pgprotval_t") long pr,
      int level, boolean dmsg) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static boolean printk_timed_ratelimit(Ptr<java.lang. @Unsigned Long> caller_jiffies,
  ...
  @Type(
      ...
      cType = "struct printk_buffers"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class printk_buffers extends Struct {
    public char @Size(2048) [] outbuf;

    public char @Size(1024) [] scratchbuf;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct printk_info"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class printk_info extends Struct {
    ...
    public dev_printk_info dev_info;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct printk_record"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class printk_record extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct printk_ringbuffer"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class printk_ringbuffer extends Struct {
    public prb_desc_ring desc_ring;

    public prb_data_ring text_data_ring;

    public @OriginalName("atomic_long_t") atomic64_t fail;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "enum printk_info_flags"
  )
  public enum printk_info_flags implements Enum<printk_info_flags>, TypedEnum<printk_info_flags, java.lang. @Unsigned Integer> {
    /**
     * {@code LOG_FORCE_CON = 1}
     */
    @EnumMember(
        value = 1L,
        name = "LOG_FORCE_CON"
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct printk_message"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class printk_message extends Struct {

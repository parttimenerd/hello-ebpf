...
/**
 * Generated class for BPF runtime types that start with powercap
 */
...
public final class PowercapDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void powercap_release(Ptr<device> dev) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int powercap_unregister_zone(Ptr<powercap_control_type> control_type,
      Ptr<powercap_zone> power_zone) {
    throw new MethodIsBPFRelatedFunction();
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct powercap_control_type_ops"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class powercap_control_type_ops extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct powercap_control_type"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class powercap_control_type extends Struct {
    public device dev;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct powercap_zone_ops"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class powercap_zone_ops extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct powercap_zone"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class powercap_zone extends Struct {
    public int id;
    ...
    public Ptr<idr> parent_idr;

    public Ptr<?> private_data;

    public Ptr<Ptr<attribute>> zone_dev_attrs;

    public int zone_attr_count;

    public attribute_group dev_zone_attr_group;

    public Ptr<attribute_group> @Size(2) [] dev_attr_groups;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct powercap_zone_constraint"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class powercap_zone_constraint extends Struct {
    public int id;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct powercap_zone_constraint_ops"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class powercap_zone_constraint_ops extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct powercap_constraint_attr"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class powercap_constraint_attr extends Struct {
    public device_attribute power_limit_attr;

    public device_attribute time_window_attr;

    public device_attribute max_power_attr;

    public device_attribute min_power_attr;

    public device_attribute max_time_window_attr;

    public device_attribute min_time_window_attr;

    public device_attribute name_attr;
  }
}

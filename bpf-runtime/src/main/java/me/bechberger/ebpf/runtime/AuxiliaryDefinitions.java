...
/**
 * Generated class for BPF runtime types that start with auxiliary
 */
...
public final class AuxiliaryDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int auxiliary_bus_probe(Ptr<device> dev) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void auxiliary_bus_remove(Ptr<device> dev) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void auxiliary_bus_shutdown(Ptr<device> dev) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void auxiliary_device_destroy(Ptr<?> auxdev) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void auxiliary_device_release(Ptr<device> dev) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @Type(
      ...
      cType = "struct auxiliary_device"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class auxiliary_device extends Struct {
    public device dev;
    ...
    public sysfs_of_auxiliary_device sysfs;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct auxiliary_device_id"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class auxiliary_device_id extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct auxiliary_driver"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class auxiliary_driver extends Struct {
    public Ptr<?> probe;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct auxiliary_irq_info"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class auxiliary_irq_info extends Struct {
    public device_attribute sysfs_attr;

    public char @Size(11) [] name;
  }
}

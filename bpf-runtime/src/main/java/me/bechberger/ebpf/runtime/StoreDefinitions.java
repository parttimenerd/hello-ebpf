...
/**
 * Generated class for BPF runtime types that start with store
 */
@java.lang.SuppressWarnings("unused")
public final class StoreDefinitions {
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int __store_entry_arg(Ptr<trace_probe> tp, int argnum) {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int store_msg(Ptr<?> dest, Ptr<msg_msg> msg, @Unsigned long len) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void store_trace_entry_data(Ptr<?> edata, Ptr<trace_probe> tp, Ptr<pt_regs> regs) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long store_user_show(Ptr<kmem_cache> s, String buf) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void store_vblank(Ptr<drm_device> dev, @Unsigned int pipe,
      @Unsigned int vblank_count_inc, @OriginalName("ktime_t") long t_vblank, @Unsigned int last) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @Type(
      ...
      cType = "enum store_type"
  )
  public enum store_type implements Enum<store_type>, TypedEnum<store_type, java.lang. @Unsigned Integer> {
    /**
     * {@code wr_invalid = 0}
     */
    @EnumMember(
    ...
    /**
     * {@code wr_spanning_store = 4}
     */
    @EnumMember(
        value = 4L,
        name = "wr_spanning_store"
    )
    wr_spanning_store,

    /**
     * {@code wr_split_store = 5}
     */
    @EnumMember(
        value = 5L,
        name = "wr_split_store"

...
/**
 * Generated class for BPF runtime types that start with fdt
 */
@java.lang.SuppressWarnings("unused")
public final class FdtDefinitions {
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int fdt_add_mem_rsv(Ptr<?> fdt, @Unsigned @OriginalName("uint64_t") long address,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int fdt_add_reservemap_entry(Ptr<?> fdt,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int fdt_create(Ptr<?> buf, int bufsize) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int fdt_create_empty_tree(Ptr<?> buf, int bufsize) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int fdt_create_with_flags(Ptr<?> buf, int bufsize,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int fdt_del_mem_rsv(Ptr<?> fdt, int n) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int fdt_del_node(Ptr<?> fdt, int nodeoffset) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int fdt_end_node(Ptr<?> fdt) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int fdt_finish(Ptr<?> fdt) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int fdt_finish_reservemap(Ptr<?> fdt) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<?> fdt_grab_space_(Ptr<?> fdt, @Unsigned long len) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @Unsigned long fdt_header_size_(@Unsigned @OriginalName("uint32_t") int version) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int fdt_node_end_offset_(Ptr<?> fdt, int offset) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int fdt_nop_node(Ptr<?> fdt, int nodeoffset) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int fdt_pack(Ptr<?> fdt) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int fdt_resize(Ptr<?> fdt, Ptr<?> buf, int bufsize) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int fdt_rw_probe_(Ptr<?> fdt) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int fdt_splice_(Ptr<?> fdt, Ptr<?> splicepoint, int oldlen, int newlen) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int fdt_splice_mem_rsv_(Ptr<?> fdt, Ptr<fdt_reserve_entry> p, int oldn, int newn) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int fdt_splice_struct_(Ptr<?> fdt, Ptr<?> p, int oldlen, int newlen) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction("((const u8*)fdt_strerror($arg1))")
  public static String fdt_strerror(int errval) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int fdt_sw_probe_struct_(Ptr<?> fdt) {
    throw new MethodIsBPFRelatedFunction();
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct fdt_header"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class fdt_header extends Struct {
    public @Unsigned @OriginalName("fdt32_t") int magic;

    public @Unsigned @OriginalName("fdt32_t") int totalsize;

    public @Unsigned @OriginalName("fdt32_t") int off_dt_struct;

    public @Unsigned @OriginalName("fdt32_t") int off_dt_strings;

    public @Unsigned @OriginalName("fdt32_t") int off_mem_rsvmap;

    public @Unsigned @OriginalName("fdt32_t") int version;

    public @Unsigned @OriginalName("fdt32_t") int last_comp_version;

    public @Unsigned @OriginalName("fdt32_t") int boot_cpuid_phys;

    public @Unsigned @OriginalName("fdt32_t") int size_dt_strings;

    public @Unsigned @OriginalName("fdt32_t") int size_dt_struct;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct fdt_debugfs"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class fdt_debugfs extends Struct {
    public list_head list;

    public debugfs_blob_wrapper wrapper;

    public Ptr<dentry> file;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct fdt_reserve_entry"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class fdt_reserve_entry extends Struct {
    public @Unsigned @OriginalName("fdt64_t") long address;

    public @Unsigned @OriginalName("fdt64_t") long size;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct fdt_node_header"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class fdt_node_header extends Struct {
    public @Unsigned @OriginalName("fdt32_t") int tag;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct fdt_property"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class fdt_property extends Struct {
    public @Unsigned @OriginalName("fdt32_t") int tag;

    public @Unsigned @OriginalName("fdt32_t") int len;

    public @Unsigned @OriginalName("fdt32_t") int nameoff;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct fdt_errtabent"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class fdt_errtabent extends Struct {
    public String str;
  }
}

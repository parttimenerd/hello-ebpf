...
/**
 * Generated class for BPF runtime types that start with disable
 */
@java.lang.SuppressWarnings("unused")
public final class DisableDefinitions {
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void __disable_irq(Ptr<irq_desc> desc) {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<kprobe> __disable_kprobe(Ptr<kprobe> p) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void __disable_trace_kprobe(Ptr<trace_probe> tp) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static boolean disable_delayed_work(Ptr<delayed_work> dwork) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static boolean disable_delayed_work_sync(Ptr<delayed_work> dwork) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void disable_dmar_iommu(Ptr<intel_iommu> iommu) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void disable_dynirq(Ptr<irq_data> data) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int disable_eprobe(Ptr<trace_eprobe> ep, Ptr<trace_array> tr) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void disable_freq_invariance_workfn(Ptr<work_struct> work) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void disable_hotplug_cpu(int cpu) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void disable_igfx_irq(Ptr<pci_dev> dev) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int disable_kprobe(Ptr<kprobe> kp) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void disable_pid_allocation(Ptr<pid_namespace> ns) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void disable_pirq(Ptr<irq_data> data) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int disable_randmaps(String s) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long disable_show(Ptr<device> dev,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int disable_timer_pin_setup(String arg) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int disable_trace_fprobe(Ptr<trace_event_call> call, Ptr<trace_event_file> file) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int disable_trace_kprobe(Ptr<trace_event_call> call, Ptr<trace_event_file> file) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static boolean disable_work(Ptr<work_struct> work) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static boolean disable_work_sync(Ptr<work_struct> work) {
    throw new MethodIsBPFRelatedFunction();
  }

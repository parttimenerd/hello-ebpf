...
/**
 * Generated class for BPF runtime types that start with udp6
 */
@java.lang.SuppressWarnings("unused")
public final class Udp6Definitions {
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int __udp6_lib_err(Ptr<sk_buff> skb, Ptr<inet6_skb_parm> opt, char type, char code,
      int offset, @Unsigned @OriginalName("__be32") int info, Ptr<udp_table> udptable) {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int __udp6_lib_rcv(Ptr<sk_buff> skb, Ptr<udp_table> udptable, int proto) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int udp6_csum_init(Ptr<sk_buff> skb, Ptr<udphdr> uh, int proto) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int udp6_gro_complete(Ptr<sk_buff> skb, int nhoff) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<sk_buff> udp6_gro_receive(Ptr<list_head> head, Ptr<sk_buff> skb) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void udp6_proc_exit(Ptr<net> net) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int udp6_proc_init(Ptr<net> net) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int udp6_seq_show(Ptr<seq_file> seq, Ptr<?> v) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<sk_buff> udp6_ufo_fragment(Ptr<sk_buff> skb,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int udp6_unicast_rcv_skb(Ptr<sock> sk, Ptr<sk_buff> skb, Ptr<udphdr> uh) {
    throw new MethodIsBPFRelatedFunction();
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct udp6_sock"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class udp6_sock extends Struct {
    public udp_sock udp;

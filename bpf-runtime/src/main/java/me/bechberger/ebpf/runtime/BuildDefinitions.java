...
/**
 * Generated class for BPF runtime types that start with build
 */
...
public final class BuildDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<sk_buff> __build_skb(Ptr<?> data, @Unsigned int frag_size) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void __build_skb_around(Ptr<sk_buff> skb, Ptr<?> data, @Unsigned int frag_size) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void build_all_zonelists(Ptr<@OriginalName("pg_data_t") pglist_data> pgdat) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static char build_attr(Ptr<vc_data> vc, char _color, vc_intensity _intensity,
      boolean _blink, boolean _underline, boolean _reverse, boolean _italic) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void build_balance_mask(Ptr<sched_domain> sd, Ptr<sched_group> sg,
      Ptr<cpumask> mask) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int build_detached_freelist(Ptr<kmem_cache> s, @Unsigned long size, Ptr<Ptr<?>> p,
      Ptr<detached_freelist> df) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<sched_group> build_group_from_child_sched_domain(Ptr<sched_domain> sd,
      int cpu) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int build_id_parse(Ptr<vm_area_struct> vma, String build_id,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int build_id_parse_nofault(Ptr<vm_area_struct> vma, String build_id,
      Ptr<java.lang. @Unsigned Integer> size) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void build_inv_iommu_pages(Ptr<iommu_cmd> cmd, @Unsigned long address,
      @Unsigned long size, @Unsigned short domid, @Unsigned @OriginalName("ioasid_t") int pasid,
      boolean gn) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void build_inv_irt(Ptr<iommu_cmd> cmd, @Unsigned short devid) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int build_keys_header() {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<map_info> build_map_info(Ptr<address_space> mapping,
      @OriginalName("loff_t") long offset, boolean is_register) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int build_overlap_sched_groups(Ptr<sched_domain> sd, int cpu) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int build_sched_groups(Ptr<sched_domain> sd, int cpu) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<sk_buff> build_skb(Ptr<?> data, @Unsigned int frag_size) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<sk_buff> build_skb_around(Ptr<sk_buff> skb, Ptr<?> data,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static long build_tags(Ptr<apparmor_notif_all> unotif, Ptr<?> buf, Ptr<?> pos,
      @Unsigned short max_size, Ptr<aa_tags_struct> metatags, @Unsigned int mask,
      @Unsigned int permidx) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void build_tree(Ptr<deflate_state> s, Ptr<tree_desc_s> desc) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void build_zonelists(Ptr<@OriginalName("pg_data_t") pglist_data> pgdat) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int build_zonerefs_node(Ptr<@OriginalName("pg_data_t") pglist_data> pgdat,
      Ptr<zoneref> zonerefs) {
    throw new MethodIsBPFRelatedFunction();
  }
}

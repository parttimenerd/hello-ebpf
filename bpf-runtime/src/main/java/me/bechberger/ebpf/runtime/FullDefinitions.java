...
/**
 * Generated class for BPF runtime types that start with full
 */
...
public final class FullDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("loff_t") long full_proxy_llseek(Ptr<file> filp,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int full_proxy_open_regular(Ptr<inode> inode, Ptr<file> filp) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int full_proxy_open_short(Ptr<inode> inode, Ptr<file> filp) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static @Unsigned @OriginalName("__poll_t") int full_proxy_poll(Ptr<file> filp,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long full_proxy_read(Ptr<file> filp, String buf,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int full_proxy_release(Ptr<inode> inode, Ptr<file> file) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static long full_proxy_unlocked_ioctl(Ptr<file> filp, @Unsigned int cmd,
      @Unsigned long arg) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long full_scans_show(Ptr<kobject> kobj,

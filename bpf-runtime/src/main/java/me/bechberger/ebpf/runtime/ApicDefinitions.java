...
/**
 * Generated class for BPF runtime types that start with apic
 */
@java.lang.SuppressWarnings("unused")
public final class ApicDefinitions {
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void apic_ack_edge(Ptr<irq_data> irqd) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void apic_ack_irq(Ptr<irq_data> irqd) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @Unsigned int apic_default_calc_apicid(@Unsigned int cpu) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static @Unsigned int apic_flat_calc_apicid(@Unsigned int cpu) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void apic_force_complete_move(Ptr<irq_data> irqd) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int apic_retrigger_irq(Ptr<irq_data> irqd) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void apic_send_nmi_to_offline_cpu(@Unsigned int cpu) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int apic_set_extnmi(String arg) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int apic_set_verbosity(String arg) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void apic_update_irq_cfg(Ptr<irq_data> irqd, @Unsigned int vector,
      @Unsigned int cpu) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void apic_update_vector(Ptr<irq_data> irqd, @Unsigned int newvec,
      @Unsigned int newcpu) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @Type(
      ...
      cType = "struct apic_override"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class apic_override extends Struct {
    public Ptr<?> eoi;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "enum apic_intr_mode_id"
  )
  public enum apic_intr_mode_id implements Enum<apic_intr_mode_id>, TypedEnum<apic_intr_mode_id, java.lang. @Unsigned Integer> {
    /**
     * {@code APIC_PIC = 0}
     */
    @EnumMember(
    ...
    /**
     * {@code APIC_VIRTUAL_WIRE = 1}
     */
    @EnumMember(
        value = 1L,
        name = "APIC_VIRTUAL_WIRE"
    )
    APIC_VIRTUAL_WIRE,

    /**
     * {@code APIC_VIRTUAL_WIRE_NO_CONFIG = 2}
     */
    @EnumMember(
        value = 2L,
        name = "APIC_VIRTUAL_WIRE_NO_CONFIG"
    )
    APIC_VIRTUAL_WIRE_NO_CONFIG,

    /**
     * {@code APIC_SYMMETRIC_IO = 3}
     */
    @EnumMember(
        value = 3L,
        name = "APIC_SYMMETRIC_IO"
    )
    APIC_SYMMETRIC_IO,

    /**
     * {@code APIC_SYMMETRIC_IO_NO_ROUTING = 4}
     */
    @EnumMember(
        value = 4L,
        name = "APIC_SYMMETRIC_IO_NO_ROUTING"
    )
  ...
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class apic_ir extends Union {
    public @Unsigned long @Size(4) [] map;

    public @Unsigned int @Size(8) [] regs;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct apic_chip_data"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class apic_chip_data extends Struct {
    public irq_cfg hw_irq_cfg;
  ...
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class apic extends Struct {
    public Ptr<?> eoi;

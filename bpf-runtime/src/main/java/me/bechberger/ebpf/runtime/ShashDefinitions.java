...
/**
 * Generated class for BPF runtime types that start with shash
 */
@java.lang.SuppressWarnings("unused")
public final class ShashDefinitions {
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int shash_ahash_digest(Ptr<ahash_request> req, Ptr<shash_desc> desc) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int shash_ahash_finup(Ptr<ahash_request> req, Ptr<shash_desc> desc) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int shash_ahash_update(Ptr<ahash_request> req, Ptr<shash_desc> desc) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int shash_default_export_core(Ptr<shash_desc> desc, Ptr<?> out) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int shash_register_instance(Ptr<crypto_template> tmpl, Ptr<shash_instance> inst) {
    throw new MethodIsBPFRelatedFunction();
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct shash_desc"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class shash_desc extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct shash_alg"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class shash_alg extends Struct {
    public Ptr<?> init;
    ...
    @InlineUnion(22592)
    public anon_member_of_anon_member_of_shash_alg anon14$0;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct shash_instance"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class shash_instance extends Struct {
    public Ptr<?> free;

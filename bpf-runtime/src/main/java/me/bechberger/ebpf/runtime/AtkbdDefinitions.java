...
/**
 * Generated class for BPF runtime types that start with atkbd
 */
...
public final class AtkbdDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @Unsigned @OriginalName("umode_t") short atkbd_attr_is_visible(Ptr<kobject> kobj,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void atkbd_cleanup(Ptr<serio> serio) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int atkbd_connect(Ptr<serio> serio, Ptr<serio_driver> drv) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void atkbd_disconnect(Ptr<serio> serio) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long atkbd_do_show_err_count(Ptr<device> d,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long atkbd_do_show_extra(Ptr<device> d,
      Ptr<device_attribute> attr, String b) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long atkbd_do_show_force_release(Ptr<device> d,
      Ptr<device_attribute> attr, String b) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long atkbd_do_show_function_row_physmap(Ptr<device> d,
      Ptr<device_attribute> attr, String b) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long atkbd_do_show_scroll(Ptr<device> d,
      Ptr<device_attribute> attr, String b) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long atkbd_do_show_set(Ptr<device> d,
      Ptr<device_attribute> attr, String b) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long atkbd_do_show_softraw(Ptr<device> d,
      Ptr<device_attribute> attr, String b) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long atkbd_do_show_softrepeat(Ptr<device> d,
      Ptr<device_attribute> attr, String b) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int atkbd_event(Ptr<input_dev> dev, @Unsigned int type, @Unsigned int code,
      int value) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void atkbd_event_work(Ptr<work_struct> work) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int atkbd_get_keymap_from_fwnode(Ptr<atkbd> atkbd) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @Unsigned int atkbd_oqo_01plus_scancode_fixup(Ptr<atkbd> atkbd,
      @Unsigned int code) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static ps2_disposition atkbd_pre_receive_byte(Ptr<ps2dev> ps2dev, char data,
      @Unsigned int flags) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int atkbd_probe(Ptr<atkbd> atkbd) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void atkbd_receive_byte(Ptr<ps2dev> ps2dev, char data) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int atkbd_reconnect(Ptr<serio> serio) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void atkbd_schedule_event_work(Ptr<atkbd> atkbd, int event_bit) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int atkbd_select_set(Ptr<atkbd> atkbd, int target_set, int allow_extra) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void atkbd_set_device_attrs(Ptr<atkbd> atkbd) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void atkbd_set_keycode_table(Ptr<atkbd> atkbd) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int atkbd_set_leds(Ptr<atkbd> atkbd) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int atkbd_set_repeat_rate(Ptr<atkbd> atkbd) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  public static class atkbd extends Struct {
    public ps2dev ps2dev;
    ...
    public @Unsigned short @Size(512) [] keycode;

    public @Unsigned long @Size(8) [] force_release_mask;

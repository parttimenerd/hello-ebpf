...
/**
 * Generated class for BPF runtime types that start with pmc
 */
...
public final class PmcDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int pmc_atom_read(int offset, Ptr<java.lang. @Unsigned Integer> value) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int pmc_dev_state_open(Ptr<inode> inode, Ptr<file> file) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int pmc_dev_state_show(Ptr<seq_file> s, Ptr<?> unused) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int pmc_pss_state_open(Ptr<inode> inode, Ptr<file> file) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int pmc_pss_state_show(Ptr<seq_file> s, Ptr<?> unused) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int pmc_sleep_tmr_open(Ptr<inode> inode, Ptr<file> file) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int pmc_sleep_tmr_show(Ptr<seq_file> s, Ptr<?> unused) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  public enum pmc_type implements Enum<pmc_type>, TypedEnum<pmc_type, java.lang. @Unsigned Integer> {
    /**
     * {@code KVM_PMC_GP = 0}
     */
    @EnumMember(
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct pmc_clk"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class pmc_clk extends Struct {
    public String name;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct pmc_clk_data"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class pmc_clk_data extends Struct {
    public Ptr<?> base;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct pmc_bit_map"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class pmc_bit_map extends Struct {
    public String name;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct pmc_reg_map"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class pmc_reg_map extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct pmc_data"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class pmc_data extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct pmc_dev"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class pmc_dev extends Struct {

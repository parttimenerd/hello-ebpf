...
/**
 * Generated class for BPF runtime types that start with debugfs
 */
...
public final class DebugfsDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int __debugfs_file_get(Ptr<dentry> dentry, dbgfs_get_mode mode) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<inode> debugfs_alloc_inode(Ptr<super_block> sb) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int debugfs_atomic_t_get(Ptr<?> data, Ptr<java.lang. @Unsigned Long> val) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long debugfs_attr_read(Ptr<file> file, String buf,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<vfsmount> debugfs_automount(Ptr<path> path) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int debugfs_devm_entry_open(Ptr<inode> inode, Ptr<file> f) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void debugfs_enter_cancellation(Ptr<file> file,
      Ptr<debugfs_cancellation> cancellation) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int debugfs_file_get(Ptr<dentry> dentry) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void debugfs_file_put(Ptr<dentry> dentry) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int debugfs_fill_super(Ptr<super_block> sb, Ptr<fs_context> fc) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void debugfs_free_fc(Ptr<fs_context> fc) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void debugfs_free_inode(Ptr<inode> inode) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int debugfs_get_stored_pages(Ptr<?> data, Ptr<java.lang. @Unsigned Long> val) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int debugfs_get_total_size(Ptr<?> data, Ptr<java.lang. @Unsigned Long> val) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int debugfs_get_tree(Ptr<fs_context> fc) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int debugfs_init_fs_context(Ptr<fs_context> fc) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void debugfs_leave_cancellation(Ptr<file> file,
      Ptr<debugfs_cancellation> cancellation) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int debugfs_parse_param(Ptr<fs_context> fc, Ptr<fs_parameter> param) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long debugfs_read_file_bool(Ptr<file> file,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long debugfs_read_file_str(Ptr<file> file, String user_buf,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int debugfs_reconfigure(Ptr<fs_context> fc) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int debugfs_regset32_open(Ptr<inode> inode, Ptr<file> file) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int debugfs_regset32_show(Ptr<seq_file> s, Ptr<?> data) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void debugfs_release_dentry(Ptr<dentry> dentry) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void debugfs_remove(Ptr<dentry> dentry) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int debugfs_setattr(Ptr<mnt_idmap> idmap, Ptr<dentry> dentry, Ptr<iattr> ia) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int debugfs_show_options(Ptr<seq_file> m, Ptr<dentry> root) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int debugfs_size_t_get(Ptr<?> data, Ptr<java.lang. @Unsigned Long> val) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void debugfs_slab_add(Ptr<kmem_cache> s) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void debugfs_slab_release(Ptr<kmem_cache> s) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int debugfs_u16_get(Ptr<?> data, Ptr<java.lang. @Unsigned Long> val) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int debugfs_u32_get(Ptr<?> data, Ptr<java.lang. @Unsigned Long> val) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int debugfs_u64_get(Ptr<?> data, Ptr<java.lang. @Unsigned Long> val) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int debugfs_u8_get(Ptr<?> data, Ptr<java.lang. @Unsigned Long> val) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int debugfs_ulong_get(Ptr<?> data, Ptr<java.lang. @Unsigned Long> val) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @Type(
      ...
      cType = "struct debugfs_blob_wrapper"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class debugfs_blob_wrapper extends Struct {
    public Ptr<?> data;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct debugfs_u32_array"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class debugfs_u32_array extends Struct {
    public Ptr<java.lang. @Unsigned Integer> array;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct debugfs_short_fops"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class debugfs_short_fops extends Struct {
    public Ptr<?> read;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct debugfs_cancellation"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class debugfs_cancellation extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct debugfs_inode_info"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class debugfs_inode_info extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct debugfs_fsdata"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class debugfs_fsdata extends Struct {
    public Ptr<file_operations> real_fops;

    public Ptr<debugfs_short_fops> short_fops;

    public anon_member_of_debugfs_fsdata anon2;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct debugfs_fs_info"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class debugfs_fs_info extends Struct {
    public kuid_t uid;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct debugfs_reg32"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class debugfs_reg32 extends Struct {
    public String name;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct debugfs_regset32"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class debugfs_regset32 extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct debugfs_devm_entry"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class debugfs_devm_entry extends Struct {
    public Ptr<?> read;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct debugfs_info"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class debugfs_info extends Struct {
    public Ptr<dentry> debug_dir;

    public Ptr<?> rasdes_info;
  }
}

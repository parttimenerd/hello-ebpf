...
/**
 * Generated class for BPF runtime types that start with watchdog
 */
@java.lang.SuppressWarnings("unused")
public final class WatchdogDefinitions {
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int ___watchdog_register_device(Ptr<watchdog_device> wdd) {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void watchdog_core_data_release(Ptr<device> dev) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void watchdog_enable(@Unsigned int cpu) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void watchdog_hardlockup_check(@Unsigned int cpu, Ptr<pt_regs> regs) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void watchdog_hardlockup_disable(@Unsigned int cpu) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void watchdog_hardlockup_enable(@Unsigned int cpu) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void watchdog_hardlockup_touch_cpu(@Unsigned int cpu) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int watchdog_init_timeout(Ptr<watchdog_device> wdd, @Unsigned int timeout_parm,
      Ptr<device> dev) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static long watchdog_ioctl(Ptr<file> file, @Unsigned int cmd, @Unsigned long arg) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ktime_t") long watchdog_next_keepalive(Ptr<watchdog_device> wdd) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int watchdog_open(Ptr<inode> inode, Ptr<file> file) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void watchdog_overflow_callback(Ptr<perf_event> event, Ptr<perf_sample_data> data,
      Ptr<pt_regs> regs) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void watchdog_ping_work(Ptr<kthread_work> work) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int watchdog_pm_notifier(Ptr<notifier_block> nb, @Unsigned long mode, Ptr<?> data) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction("watchdog_pretimeout_governor_set($arg1, (const u8 *)$arg2)")
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int watchdog_reboot_notifier(Ptr<notifier_block> nb, @Unsigned long code,
      Ptr<?> data) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int watchdog_release(Ptr<inode> inode, Ptr<file> file) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int watchdog_restart_notifier(Ptr<notifier_block> nb, @Unsigned long action,
      Ptr<?> data) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int watchdog_set_last_hw_keepalive(Ptr<watchdog_device> wdd,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static hrtimer_restart watchdog_timer_expired(Ptr<hrtimer> timer) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static hrtimer_restart watchdog_timer_fn(Ptr<hrtimer> hrtimer) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction("watchdog_write($arg1, (const u8 *)$arg2, $arg3, $arg4)")
  public static @OriginalName("ssize_t") long watchdog_write(Ptr<file> file, String data,
  ...
  @Type(
      ...
      cType = "struct watchdog_info"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class watchdog_info extends Struct {
    public @Unsigned int options;

    public @Unsigned int firmware_version;

    public char @Size(32) [] identity;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct watchdog_ops"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class watchdog_ops extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct watchdog_device"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class watchdog_device extends Struct {
    public int id;
    ...
    public notifier_block reboot_nb;

    public notifier_block restart_nb;
    ...
    public list_head deferred;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct watchdog_governor"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class watchdog_governor extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct watchdog_core_data"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class watchdog_core_data extends Struct {
    public device dev;
    ...
    public @OriginalName("ktime_t") long last_keepalive;

    public @OriginalName("ktime_t") long last_hw_keepalive;

    public @OriginalName("ktime_t") long open_deadline;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct watchdog_pretimeout"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class watchdog_pretimeout extends Struct {
    public Ptr<watchdog_device> wdd;

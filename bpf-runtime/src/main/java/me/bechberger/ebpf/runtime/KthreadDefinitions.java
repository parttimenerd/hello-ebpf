...
/**
 * Generated class for BPF runtime types that start with kthread
 */
...
public final class KthreadDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void __kthread_queue_delayed_work(Ptr<kthread_worker> worker,
      Ptr<kthread_delayed_work> dwork, @Unsigned long delay) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void kthread_associate_blkcg(Ptr<cgroup_subsys_state> css) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void kthread_bind(Ptr<task_struct> p, @Unsigned int cpu) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<cgroup_subsys_state> kthread_blkcg() {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void kthread_complete_and_exit(Ptr<completion> comp, long code) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<?> kthread_data(Ptr<task_struct> task) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void kthread_delayed_work_timer_fn(Ptr<timer_list> t) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void kthread_destroy_worker(Ptr<kthread_worker> worker) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void kthread_flush_worker(Ptr<kthread_worker> worker) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static boolean kthread_freezable_should_stop(
      Ptr<java.lang. @OriginalName("bool") Boolean> was_frozen) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<?> kthread_func(Ptr<task_struct> task) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void kthread_insert_work(Ptr<kthread_worker> worker, Ptr<kthread_work> work,
      Ptr<list_head> pos) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static boolean kthread_is_per_cpu(Ptr<task_struct> p) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static boolean kthread_mod_delayed_work(Ptr<kthread_worker> worker,
      Ptr<kthread_delayed_work> dwork, @Unsigned long delay) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int kthread_park(Ptr<task_struct> k) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<?> kthread_probe_data(Ptr<task_struct> task) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static boolean kthread_queue_delayed_work(Ptr<kthread_worker> worker,
      Ptr<kthread_delayed_work> dwork, @Unsigned long delay) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static boolean kthread_queue_work(Ptr<kthread_worker> worker, Ptr<kthread_work> work) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void kthread_set_per_cpu(Ptr<task_struct> k, int cpu) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int kthread_stop(Ptr<task_struct> k) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int kthread_stop_put(Ptr<task_struct> k) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void kthread_unpark(Ptr<task_struct> k) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void kthread_unuse_mm(Ptr<mm_struct> mm) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void kthread_use_mm(Ptr<mm_struct> mm) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @Type(
      ...
      cType = "struct kthread_work"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class kthread_work extends Struct {
    public list_head node;

    public @OriginalName("kthread_work_func_t") Ptr<?> func;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct kthread_worker"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class kthread_worker extends Struct {
    public @Unsigned int flags;

    public @OriginalName("raw_spinlock_t") raw_spinlock lock;

    public list_head work_list;

    public list_head delayed_work_list;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct kthread_delayed_work"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class kthread_delayed_work extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct kthread_create_info"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class kthread_create_info extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct kthread_flush_work"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class kthread_flush_work extends Struct {
    public kthread_work work;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct kthread"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class kthread extends Struct {
    ...
    public list_head hotplug_node;

    public Ptr<cpumask> preferred_affinity;
  }
}

...
/**
 * Generated class for BPF runtime types that start with smp
 */
@java.lang.SuppressWarnings("unused")
public final class SmpDefinitions {
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void __smp_call_single_queue(int cpu, Ptr<llist_node> node) {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void smp_call_function(@OriginalName("smp_call_func_t") Ptr<?> func, Ptr<?> info,
      int wait) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int smp_call_function_single(int cpu, @OriginalName("smp_call_func_t") Ptr<?> func,
      Ptr<?> info, int wait) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int smp_call_function_single_async(int cpu,
      Ptr<@OriginalName("call_single_data_t") __call_single_data> csd) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction("smp_call_on_cpu($arg1, (int (*)(void*))$arg2, $arg3, $arg4)")
  public static int smp_call_on_cpu(@Unsigned int cpu, Ptr<?> func, Ptr<?> par, boolean phys) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void smp_call_on_cpu_callback(Ptr<work_struct> work) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int smp_check_mpc(Ptr<mpc_table> mpc, String oem, String str) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void smp_dump_mptable(Ptr<mpc_table> mpc, String mpt) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int smp_mon_event_count(Ptr<?> arg) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int smp_stop_nmi_callback(@Unsigned int val, Ptr<pt_regs> regs) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void smp_text_poke_batch_finish() {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int smp_text_poke_int3_handler(Ptr<pt_regs> regs) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void smp_text_poke_sync_each_cpu() {
    throw new MethodIsBPFRelatedFunction();
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct smp_ops"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class smp_ops extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct smp_alt_module"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class smp_alt_module extends Struct {
    public Ptr<module> mod;

    public String name;

    public Ptr<java.lang.Integer> locks;

    public Ptr<java.lang.Integer> locks_end;

    public Ptr<java.lang.Character> text;

    public Ptr<java.lang.Character> text_end;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct smp_text_poke_loc"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class smp_text_poke_loc extends Struct {
    public int rel_addr;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct smp_text_poke_array"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class smp_text_poke_array extends Struct {
    public smp_text_poke_loc @Size(256) [] vec;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct smp_hotplug_thread"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class smp_hotplug_thread extends Struct {
    public Ptr<Ptr<task_struct>> store;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct smp_call_on_cpu_struct"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class smp_call_on_cpu_struct extends Struct {

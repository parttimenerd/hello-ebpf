...
/**
 * Generated class for BPF runtime types that start with bql
 */
...
public final class BqlDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long bql_show_hold_time(Ptr<kobject> kobj,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long bql_show_inflight(Ptr<kobject> kobj,
      Ptr<attribute> attr, Ptr<netdev_queue> queue, String buf) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long bql_show_limit(Ptr<kobject> kobj, Ptr<attribute> attr,
      Ptr<netdev_queue> queue, String buf) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long bql_show_limit_max(Ptr<kobject> kobj,
      Ptr<attribute> attr, Ptr<netdev_queue> queue, String buf) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long bql_show_limit_min(Ptr<kobject> kobj,
      Ptr<attribute> attr, Ptr<netdev_queue> queue, String buf) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long bql_show_stall_cnt(Ptr<kobject> kobj,
      Ptr<attribute> attr, Ptr<netdev_queue> queue, String buf) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long bql_show_stall_max(Ptr<kobject> kobj,
      Ptr<attribute> attr, Ptr<netdev_queue> queue, String buf) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long bql_show_stall_thrs(Ptr<kobject> kobj,
      Ptr<attribute> attr, Ptr<netdev_queue> queue, String buf) {
    throw new MethodIsBPFRelatedFunction();
  }
}

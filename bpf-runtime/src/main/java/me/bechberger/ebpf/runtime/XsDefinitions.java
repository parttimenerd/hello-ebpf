...
/**
 * Generated class for BPF runtime types that start with xs
 */
@java.lang.SuppressWarnings("unused")
public final class XsDefinitions {
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void xs_free_req(Ptr<kref> kref) {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int xs_reboot_notify(Ptr<notifier_block> nb, @Unsigned long code, Ptr<?> unused) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void xs_request_exit(Ptr<xb_req_data> req) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void xs_send(Ptr<xb_req_data> req, Ptr<xsd_sockmsg> msg) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<?> xs_wait_for_reply(Ptr<xb_req_data> req, Ptr<xsd_sockmsg> msg) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void xs_wake_up(Ptr<xb_req_data> req) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int xs_watch_msg(Ptr<xs_watch_event> event) {
    throw new MethodIsBPFRelatedFunction();
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct xs_watch_event"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class xs_watch_event extends Struct {
    public list_head list;

    public @Unsigned int len;

    public Ptr<xenbus_watch> handle;

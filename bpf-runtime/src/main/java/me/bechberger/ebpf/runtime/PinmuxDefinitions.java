...
/**
 * Generated class for BPF runtime types that start with pinmux
 */
@java.lang.SuppressWarnings("unused")
public final class PinmuxDefinitions {
  @NotUsableInJava
  @BuiltinBPFFunction
  public static boolean pinmux_can_be_used_for_gpio(Ptr<pinctrl_dev> pctldev, @Unsigned int pin) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int pinmux_check_ops(Ptr<pinctrl_dev> pctldev) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void pinmux_free_gpio(Ptr<pinctrl_dev> pctldev, @Unsigned int pin,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int pinmux_functions_open(Ptr<inode> inode, Ptr<file> file) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int pinmux_functions_show(Ptr<seq_file> s, Ptr<?> what) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int pinmux_gpio_direction(Ptr<pinctrl_dev> pctldev, Ptr<pinctrl_gpio_range> range,
      @Unsigned int pin, boolean input) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void pinmux_init_device_debugfs(Ptr<dentry> devroot, Ptr<pinctrl_dev> pctldev) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int pinmux_pins_open(Ptr<inode> inode, Ptr<file> file) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int pinmux_pins_show(Ptr<seq_file> s, Ptr<?> what) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int pinmux_request_gpio(Ptr<pinctrl_dev> pctldev, Ptr<pinctrl_gpio_range> range,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int pinmux_select_open(Ptr<inode> inode, Ptr<file> file) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int pinmux_select_show(Ptr<seq_file> s, Ptr<?> unused) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @Type(
      ...
      cType = "struct pinmux_ops"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class pinmux_ops extends Struct {
    public Ptr<?> request;

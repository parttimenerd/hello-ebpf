...
/**
 * Generated class for BPF runtime types that start with nla
 */
...
public final class NlaDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<nlattr> __nla_reserve(Ptr<sk_buff> skb, int attrtype, int attrlen) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<nlattr> __nla_reserve_64bit(Ptr<sk_buff> skb, int attrtype, int attrlen,
      int padattr) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<?> __nla_reserve_nohdr(Ptr<sk_buff> skb, int attrlen) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int nla_put_ifalias(Ptr<sk_buff> skb, Ptr<net_device> dev) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int nla_put_nh_group(Ptr<sk_buff> skb, Ptr<nexthop> nh, @Unsigned int op_flags,
      Ptr<java.lang. @Unsigned Integer> resp_op_flags) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int nla_put_nh_group_res(Ptr<sk_buff> skb, Ptr<nh_group> nhg) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int nla_put_nh_group_stats(Ptr<sk_buff> skb, Ptr<nexthop> nh,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<nlattr> nla_reserve(Ptr<sk_buff> skb, int attrtype, int attrlen) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<nlattr> nla_reserve_64bit(Ptr<sk_buff> skb, int attrtype, int attrlen,
      int padattr) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<?> nla_reserve_nohdr(Ptr<sk_buff> skb, int attrlen) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @Type(
      ...
      cType = "struct nla_policy"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class nla_policy extends Struct {
    public char type;
    ...
    @InlineUnion(3796)
    public anon_member_of_anon_member_of_nla_policy anon3$7;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct nla_bitfield32"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class nla_bitfield32 extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "enum nla_policy_validation"
  )
  public enum nla_policy_validation implements Enum<nla_policy_validation>, TypedEnum<nla_policy_validation, java.lang. @Unsigned Integer> {
    /**
     * {@code NLA_VALIDATE_NONE = 0}
     */
    @EnumMember(
        value = 0L,
        name = "NLA_VALIDATE_NONE"
    )
    NLA_VALIDATE_NONE,

    /**
     * {@code NLA_VALIDATE_RANGE = 1}
     */
    @EnumMember(
        value = 1L,
        name = "NLA_VALIDATE_RANGE"
    )
    NLA_VALIDATE_RANGE,

    /**
     * {@code NLA_VALIDATE_RANGE_WARN_TOO_LONG = 2}
     */
    @EnumMember(
        value = 2L,
        name = "NLA_VALIDATE_RANGE_WARN_TOO_LONG"
    )
    NLA_VALIDATE_RANGE_WARN_TOO_LONG,

    /**
     * {@code NLA_VALIDATE_MIN = 3}
     */
    @EnumMember(
        value = 3L,
        name = "NLA_VALIDATE_MIN"
    )
    NLA_VALIDATE_MIN,

    /**
     * {@code NLA_VALIDATE_MAX = 4}
     */
    @EnumMember(
        value = 4L,
        name = "NLA_VALIDATE_MAX"
    )
    NLA_VALIDATE_MAX,

    /**
     * {@code NLA_VALIDATE_MASK = 5}
     */
    @EnumMember(
        value = 5L,
        name = "NLA_VALIDATE_MASK"
    )
    NLA_VALIDATE_MASK,

    /**
     * {@code NLA_VALIDATE_RANGE_PTR = 6}
     */
    @EnumMember(
        value = 6L,
        name = "NLA_VALIDATE_RANGE_PTR"
    )
    NLA_VALIDATE_RANGE_PTR,

    /**
     * {@code NLA_VALIDATE_FUNCTION = 7}
     */
    @EnumMember(
        value = 7L,
        name = "NLA_VALIDATE_FUNCTION"
    )

...
/**
 * Generated class for BPF runtime types that start with cipso
 */
@java.lang.SuppressWarnings("unused")
public final class CipsoDefinitions {
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<?> cipso_seq_next(Ptr<seq_file> s, Ptr<?> v,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int cipso_seq_show(Ptr<seq_file> s, Ptr<?> v) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<?> cipso_seq_start(Ptr<seq_file> s,
      Ptr<java.lang. @OriginalName("loff_t") Long> pos) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int cipso_v4_delopt(Ptr<Ptr<ip_options_rcu>> opt_ptr) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int cipso_v4_doi_add(Ptr<cipso_v4_doi> doi_def, Ptr<netlbl_audit> audit_info) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void cipso_v4_doi_free_rcu(Ptr<callback_head> entry) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int cipso_v4_doi_remove(@Unsigned int doi, Ptr<netlbl_audit> audit_info) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction("cipso_v4_doi_walk($arg1, (int (*)(struct cipso_v4_doi*, void*))$arg2, $arg3)")
  public static int cipso_v4_doi_walk(Ptr<java.lang. @Unsigned Integer> skip_cnt, Ptr<?> callback,
      Ptr<?> cb_arg) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void cipso_v4_error(Ptr<sk_buff> skb, int error, @Unsigned int gateway) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void cipso_v4_req_delattr(Ptr<request_sock> req) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int cipso_v4_skbuff_delattr(Ptr<sk_buff> skb) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void cipso_v4_sock_delattr(Ptr<sock> sk) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int cipso_v4_sock_getattr(Ptr<sock> sk, Ptr<netlbl_lsm_secattr> secattr) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @Type(
      ...
      cType = "struct cipso_v4_std_map_tbl"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class cipso_v4_std_map_tbl extends Struct {
    public cat_of_cipso_v4_std_map_tbl_and_lvl_of_cipso_v4_std_map_tbl lvl;

    public cat_of_cipso_v4_std_map_tbl_and_lvl_of_cipso_v4_std_map_tbl cat;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct cipso_v4_doi"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class cipso_v4_doi extends Struct {
    public @Unsigned int doi;

    public @Unsigned int type;

    public map_of_cipso_v4_doi map;

    public char @Size(5) [] tags;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct cipso_v4_map_cache_bkt"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class cipso_v4_map_cache_bkt extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct cipso_v4_map_cache_entry"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class cipso_v4_map_cache_entry extends Struct {
    ...
    public Ptr<netlbl_lsm_cache> lsm_data;

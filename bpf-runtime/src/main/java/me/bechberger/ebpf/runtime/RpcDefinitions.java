...
/**
 * Generated class for BPF runtime types that start with rpc
 */
@java.lang.SuppressWarnings("unused")
public final class RpcDefinitions {
  @Type(
      noCCodeGeneration = true,
      cType = "struct rpc_rqst"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class rpc_rqst extends Struct {
    public Ptr<rpc_xprt> rq_xprt;

    public xdr_buf rq_snd_buf;

    public xdr_buf rq_rcv_buf;

    public Ptr<rpc_task> rq_task;

    public Ptr<rpc_cred> rq_cred;

    public @Unsigned @OriginalName("__be32") int rq_xid;

    public int rq_cong;

    public @Unsigned int @Size(3) [] rq_seqnos;

    public @Unsigned int rq_seqno_count;

    public int rq_enc_pages_num;

    public Ptr<Ptr<page>> rq_enc_pages;
    ...
    public list_head rq_xmit;

    public list_head rq_xmit2;
    ...
    public @OriginalName("ktime_t") long rq_rtt;

    public @Unsigned int rq_retries;

    public @Unsigned int rq_connect_cookie;

    public atomic_t rq_pin;

    public @Unsigned int rq_bytes_sent;

    public @OriginalName("ktime_t") long rq_xtime;

    public int rq_ntrans;

    public lwq_node rq_bc_list;

    public @Unsigned long rq_bc_pa_state;

    public list_head rq_bc_pa_list;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct rpc_message"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class rpc_message extends Struct {
    ...
    public Ptr<cred> rpc_cred;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct rpc_procinfo"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class rpc_procinfo extends Struct {
    public @Unsigned int p_proc;

    public @OriginalName("kxdreproc_t") Ptr<?> p_encode;

    public @OriginalName("kxdrdproc_t") Ptr<?> p_decode;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct rpc_wait"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class rpc_wait extends Struct {
    public list_head list;

    public list_head links;

    public list_head timer_list;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct rpc_timeout"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class rpc_timeout extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct rpc_task"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class rpc_task extends Struct {
    public atomic_t tk_count;

    public int tk_status;

    public list_head tk_task;
    ...
    public Ptr<workqueue_struct> tk_workqueue;

    public @OriginalName("ktime_t") long tk_start;

    public @OriginalName("pid_t") int tk_owner;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct rpc_wait_queue"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class rpc_wait_queue extends Struct {
    public @OriginalName("spinlock_t") spinlock lock;

    public list_head @Size(4) [] tasks;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct rpc_call_ops"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class rpc_call_ops extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct rpc_clnt"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class rpc_clnt extends Struct {
    public @OriginalName("refcount_t") refcount_struct cl_count;

    public @Unsigned int cl_clid;

    public list_head cl_clients;

    public list_head cl_tasks;

    public atomic_t cl_pid;
    ...
    public @OriginalName("rpc_iostats") Ptr<?> cl_metrics;
    ...
    public @Unsigned int cl_netunreach_fatal;
    ...
    public atomic_t cl_swapper;

    public int cl_nodelen;

    public char @Size(65) [] cl_nodename;
    ...
    public Ptr<cred> cl_cred;

    public @Unsigned int cl_max_connect;

    public Ptr<super_block> pipefs_sb;

    public atomic_t cl_task_count;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct rpc_xprt"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class rpc_xprt extends Struct {
    public kref kref;
    ...
    public atomic_t swapper;

    public @Unsigned int bind_index;

    public list_head xprt_switch;
    ...
    public work_struct task_cleanup;
    ...
    public @OriginalName("atomic_long_t") atomic64_t queuelen;

    public @OriginalName("spinlock_t") spinlock transport_lock;

    public @OriginalName("spinlock_t") spinlock reserve_lock;
    ...
    public list_head xmit_queue;

    public @OriginalName("atomic_long_t") atomic64_t xmit_queuelen;

    public @OriginalName("svc_xprt") Ptr<?> bc_xprt;

    public Ptr<svc_serv> bc_serv;

    public @Unsigned int bc_alloc_max;

    public @Unsigned int bc_alloc_count;

    public atomic_t bc_slot_count;

    public @OriginalName("spinlock_t") spinlock bc_pa_lock;

    public list_head bc_pa_list;

    public rb_root recv_queue;

    public stat_of_rpc_xprt stat;

    public Ptr<net> xprt_net;

    public @OriginalName("netns_tracker") lockdep_map_p ns_tracker;

    public String servername;

    public String @Size(6) [] address_strings;

    public Ptr<dentry> debugfs;

    public callback_head rcu;

    public Ptr<xprt_class> xprt_class;

    public @OriginalName("rpc_sysfs_xprt") Ptr<?> xprt_sysfs;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct rpc_cred"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class rpc_cred extends Struct {
    public hlist_node cr_hash;

    public list_head cr_lru;

    public callback_head cr_rcu;
    ...
    public @OriginalName("refcount_t") refcount_struct cr_count;

    public Ptr<cred> cr_cred;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct rpc_timer"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class rpc_timer extends Struct {
    public list_head list;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct rpc_auth"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class rpc_auth extends Struct {
    ...
    public @Unsigned @OriginalName("rpc_authflavor_t") int au_flavor;

    public @OriginalName("refcount_t") refcount_struct au_count;

    public @OriginalName("rpc_cred_cache") Ptr<?> au_credcache;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct rpc_credops"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class rpc_credops extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct rpc_authops"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class rpc_authops extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct rpc_auth_create_args"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class rpc_auth_create_args extends Struct {
    public @Unsigned @OriginalName("rpc_authflavor_t") int pseudoflavor;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct rpc_xprt_ops"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class rpc_xprt_ops extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct rpc_xprt_switch"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class rpc_xprt_switch extends Struct {
    public @OriginalName("spinlock_t") spinlock xps_lock;

    public kref xps_kref;
    ...
    public @OriginalName("atomic_long_t") atomic64_t xps_queuelen;

    public list_head xps_xprt_list;

    public Ptr<net> xps_net;

    public Ptr<rpc_xprt_iter_ops> xps_iter_ops;

    public @OriginalName("rpc_sysfs_xprt_switch") Ptr<?> xps_sysfs;

    public callback_head xps_rcu;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct rpc_stat"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class rpc_stat extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct rpc_program"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class rpc_program extends Struct {
    public String name;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct rpc_rtt"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class rpc_rtt extends Struct {
    public @Unsigned long timeo;

    public @Unsigned long @Size(5) [] srtt;

    public @Unsigned long @Size(5) [] sdrtt;

    public int @Size(5) [] ntimeouts;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct rpc_pipe_dir_head"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class rpc_pipe_dir_head extends Struct {
    public list_head pdh_entries;

    public Ptr<dentry> pdh_dentry;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct rpc_xprt_iter_ops"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class rpc_xprt_iter_ops extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct rpc_xprt_iter"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class rpc_xprt_iter extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct rpc_sysfs_client"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class rpc_sysfs_client extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct rpc_version"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class rpc_version extends Struct {
    public @Unsigned int number;
    ...
    public Ptr<java.lang. @Unsigned Integer> counts;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct { short unsigned int report_key_length; u8 reserved1; u8 reserved2; u8 ucca; u8 vra; u8 type_code; u8 region_mask; u8 rpc_scheme; u8 reserved3; }"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class rpc_state_t extends Struct {

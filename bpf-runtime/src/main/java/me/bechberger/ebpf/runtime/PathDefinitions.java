...
/**
 * Generated class for BPF runtime types that start with path
 */
...
public final class PathDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static d_walk_ret path_check_mount(Ptr<?> data, Ptr<dentry> dentry) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<icc_path> path_find(Ptr<device> dev, Ptr<icc_node> src, Ptr<icc_node> dst) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int path_from_stashed(Ptr<Ptr<dentry>> stashed, Ptr<vfsmount> mnt, Ptr<?> data,
      Ptr<path> path) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int path_lookupat(Ptr<nameidata> nd, @Unsigned int flags, Ptr<path> path) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int path_pts(Ptr<path> path) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long path_show(Ptr<device> dev, Ptr<device_attribute> attr,
      String buf) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int path_umount(Ptr<path> path, int flags) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  public static class path_of_param_of_tomoyo_request_info extends Struct {
    public Ptr<tomoyo_path_info> filename;

    public Ptr<tomoyo_path_info> matched_path;
  ...
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class path_number_of_param_of_tomoyo_request_info extends Struct {
    public Ptr<tomoyo_path_info> filename;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct path_cond"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class path_cond extends Struct {
    public kuid_t uid;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "enum path_flags"
  )
  public enum path_flags implements Enum<path_flags>, TypedEnum<path_flags, java.lang. @Unsigned Integer> {
    /**
     * {@code PATH_IS_DIR = 1}
     */
    @EnumMember(
    ...
    /**
     * {@code PATH_CONNECT_PATH = 4}
     */
    @EnumMember(
        value = 4L,
        name = "PATH_CONNECT_PATH"
    )
    PATH_CONNECT_PATH,

    /**
     * {@code PATH_CHROOT_REL = 8}
     */
    @EnumMember(
        value = 8L,
        name = "PATH_CHROOT_REL"
    )
    PATH_CHROOT_REL,

    /**
     * {@code PATH_CHROOT_NSCONNECT = 16}
     */
    @EnumMember(
        value = 16L,
        name = "PATH_CHROOT_NSCONNECT"
    )
    PATH_CHROOT_NSCONNECT,

    /**
     * {@code PATH_CONNECT_IPC_PATH = 32}
     */
    @EnumMember(
        value = 32L,
        name = "PATH_CONNECT_IPC_PATH"
    )
    PATH_CONNECT_IPC_PATH,

    /**
     * {@code PATH_DELEGATE_DELETED = 65536}
     */
    @EnumMember(
        value = 65536L,
        name = "PATH_DELEGATE_DELETED"
    )
    PATH_DELEGATE_DELETED,

    /**
     * {@code PATH_MEDIATE_DELETED = 131072}
     */
    @EnumMember(
        value = 131072L,
        name = "PATH_MEDIATE_DELETED"
    )

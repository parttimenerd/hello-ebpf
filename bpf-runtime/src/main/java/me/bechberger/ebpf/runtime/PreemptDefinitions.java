...
/**
 * Generated class for BPF runtime types that start with preempt
 */
...
public final class PreemptDefinitions {
  ...
  public static final int preempt_dynamic_lazy = 3;
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static boolean preempt_model_lazy() {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction("((const u8*)preempt_model_str())")
  public static String preempt_model_str() {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @Type(
      ...
      cType = "struct preempt_ops"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class preempt_ops extends Struct {
    public Ptr<?> sched_in;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct preempt_notifier"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class preempt_notifier extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "enum preempt_dynamic"
  )
  public enum preempt_dynamic implements Enum<preempt_dynamic>, TypedEnum<preempt_dynamic, java.lang.Integer> {
    /**
     * {@code preempt_dynamic_undefined = -1}
     */
    @EnumMember(
        value = -1L,
        name = "preempt_dynamic_undefined"
    )
    preempt_dynamic_undefined,

    /**
     * {@code preempt_dynamic_none = 0}
     */
    @EnumMember(
        value = 0L,
        name = "preempt_dynamic_none"
    )
    preempt_dynamic_none,

    /**
     * {@code preempt_dynamic_voluntary = 1}
     */
    @EnumMember(
        value = 1L,
        name = "preempt_dynamic_voluntary"
    )
    preempt_dynamic_voluntary,

    /**
     * {@code preempt_dynamic_full = 2}
     */
    @EnumMember(
        value = 2L,
        name = "preempt_dynamic_full"
    )
    preempt_dynamic_full,

    /**
     * {@code preempt_dynamic_lazy = 3}
     */
    @EnumMember(
        value = 3L,
        name = "preempt_dynamic_lazy"
    )

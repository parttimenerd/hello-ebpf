...
/**
 * Generated class for BPF runtime types that start with ecc
 */
...
public final class EccDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<java.lang. @Unsigned Long> ecc_alloc_digits_space(@Unsigned int ndigits) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int ecc_gen_privkey(@Unsigned int curve_id, @Unsigned int ndigits,
      Ptr<java.lang. @Unsigned Long> private_key) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction("((const struct ecc_curve*)ecc_get_curve($arg1))")
  ...
  @Type(
      ...
      cType = "struct ecc_point"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class ecc_point extends Struct {
    public Ptr<java.lang. @Unsigned Long> x;

    public Ptr<java.lang. @Unsigned Long> y;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct ecc_curve"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class ecc_curve extends Struct {
    public String name;
    ...
    public Ptr<java.lang. @Unsigned Long> p;

    public Ptr<java.lang. @Unsigned Long> n;

    public Ptr<java.lang. @Unsigned Long> a;

    public Ptr<java.lang. @Unsigned Long> b;
  }
}

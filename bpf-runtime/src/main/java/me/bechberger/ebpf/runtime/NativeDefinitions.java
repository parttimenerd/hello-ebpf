...
/**
 * Generated class for BPF runtime types that start with native
 */
@java.lang.SuppressWarnings("unused")
public final class NativeDefinitions {
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void __native_queued_spin_unlock(Ptr<qspinlock> lock) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void __native_set_fixmap(fixed_addresses idx, pte_t pte) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static boolean __native_vcpu_is_preempted(long cpu) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void native_cpuid(Ptr<java.lang. @Unsigned Integer> eax,
      Ptr<java.lang. @Unsigned Integer> ebx, Ptr<java.lang. @Unsigned Integer> ecx,
      Ptr<java.lang. @Unsigned Integer> edx) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<irq_domain> native_create_pci_msi_domain() {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void native_flush_tlb_one_user(@Unsigned long addr) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @Unsigned int native_io_apic_read(@Unsigned int apic, @Unsigned int reg) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int native_kick_ap(@Unsigned int cpu, Ptr<task_struct> tidle) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void native_load_tls(Ptr<thread_struct> t, @Unsigned int cpu) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void native_machine_crash_shutdown(Ptr<pt_regs> regs) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void native_queued_spin_lock_slowpath(Ptr<qspinlock> lock, @Unsigned int val) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @Unsigned long native_read_msr(@Unsigned int msr) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int native_read_msr_safe(@Unsigned int msr, Ptr<java.lang. @Unsigned Long> p) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void native_send_call_func_single_ipi(int cpu) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void native_set_fixmap(@Unsigned int idx,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void native_set_p4d(Ptr<p4d_t> p4dp, p4d_t p4d) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void native_set_pgd(Ptr<pgd_t> pgdp, pgd_t pgd) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void native_set_pmd(Ptr<pmd_t> pmdp, pmd_t pmd) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void native_set_pte(Ptr<pte_t> ptep, pte_t pte) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void native_set_pud(Ptr<pud_t> pudp, pud_t pud) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void native_smp_send_reschedule(int cpu) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static @Unsigned long native_steal_clock(int cpu) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void native_write_msr(@Unsigned int msr, @Unsigned long val) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int native_write_msr_safe(@Unsigned int msr, @Unsigned long val) {
    throw new MethodIsBPFRelatedFunction();
  }

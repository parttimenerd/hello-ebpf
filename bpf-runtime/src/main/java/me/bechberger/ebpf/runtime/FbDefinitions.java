...
/**
 * Generated class for BPF runtime types that start with fb
 */
...
public final class FbDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int fb_alloc_cmap_gfp(Ptr<fb_cmap> cmap, int len, int transp,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void fb_bl_default_curve(Ptr<fb_info> fb_info, char off, char min, char max) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<backlight_device> fb_bl_device(Ptr<fb_info> info) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void fb_bl_notify_blank(Ptr<fb_info> info, int old_blank) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int fb_blank(Ptr<fb_info> info, int blank) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static long fb_compat_ioctl(Ptr<file> file, @Unsigned int cmd, @Unsigned long arg) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction("((const struct fb_cmap*)fb_default_cmap($arg1))")
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void fb_deferred_io_cleanup(Ptr<fb_info> info) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static @Unsigned @OriginalName("vm_fault_t") int fb_deferred_io_fault(Ptr<vm_fault> vmf) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int fb_deferred_io_fsync(Ptr<file> file, @OriginalName("loff_t") long start,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int fb_deferred_io_init(Ptr<fb_info> info) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static @Unsigned @OriginalName("vm_fault_t") int fb_deferred_io_mkwrite(
      Ptr<vm_fault> vmf) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int fb_deferred_io_mmap(Ptr<fb_info> info, Ptr<vm_area_struct> vma) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void fb_deferred_io_open(Ptr<fb_info> info, Ptr<inode> inode, Ptr<file> file) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void fb_deferred_io_release(Ptr<fb_info> info) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static @Unsigned @OriginalName("vm_fault_t") int fb_deferred_io_track_page(
      Ptr<fb_info> info, @Unsigned long offset, Ptr<page> page) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void fb_deferred_io_work(Ptr<work_struct> work) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void fb_destroy_modelist(Ptr<list_head> head) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int fb_device_create(Ptr<fb_info> fb_info) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void fb_device_destroy(Ptr<fb_info> fb_info) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void fb_edid_to_monspecs(String edid, Ptr<fb_monspecs> specs) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction("((const u8*)fb_firmware_edid($arg1))")
  public static String fb_firmware_edid(Ptr<device> device) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void fb_flashcursor(Ptr<work_struct> work) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static String fb_get_buffer_offset(Ptr<fb_info> info, Ptr<fb_pixmap> buf,
      @Unsigned int size) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int fb_get_mode(int flags, @Unsigned int val, Ptr<fb_var_screeninfo> var,
      Ptr<fb_info> info) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int fb_get_monitor_limits(String edid, Ptr<fb_monspecs> specs) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int fb_getput_cmap(Ptr<fb_info> info, @Unsigned int cmd, @Unsigned long arg) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int fb_io_mmap(Ptr<fb_info> info, Ptr<vm_area_struct> vma) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long fb_io_read(Ptr<fb_info> info, String buf,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static long fb_ioctl(Ptr<file> file, @Unsigned int cmd, @Unsigned long arg) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int fb_mmap(Ptr<file> file, Ptr<vm_area_struct> vma) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int fb_new_modelist(Ptr<fb_info> info) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int fb_open(Ptr<inode> inode, Ptr<file> file) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void fb_pad_aligned_buffer(Ptr<java.lang.Character> dst, @Unsigned int d_pitch,
      Ptr<java.lang.Character> src, @Unsigned int s_pitch, @Unsigned int height) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void fb_pad_unaligned_buffer(Ptr<java.lang.Character> dst, @Unsigned int d_pitch,
      Ptr<java.lang.Character> src, @Unsigned int idx, @Unsigned int height,
      @Unsigned int shift_high, @Unsigned int shift_low, @Unsigned int mod) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int fb_pan_display(Ptr<fb_info> info, Ptr<fb_var_screeninfo> var) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int fb_parse_edid(String edid, Ptr<fb_var_screeninfo> var) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long fb_read(Ptr<file> file, String buf,
      @Unsigned long count, Ptr<java.lang. @OriginalName("loff_t") Long> ppos) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int fb_register_client(Ptr<notifier_block> nb) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int fb_release(Ptr<inode> inode, Ptr<file> file) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<?> fb_seq_next(Ptr<seq_file> m, Ptr<?> v,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int fb_seq_show(Ptr<seq_file> m, Ptr<?> v) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<?> fb_seq_start(Ptr<seq_file> m,
      Ptr<java.lang. @OriginalName("loff_t") Long> pos) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void fb_seq_stop(Ptr<seq_file> m, Ptr<?> v) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int fb_set_cmap(Ptr<fb_cmap> cmap, Ptr<fb_info> info) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void fb_set_suspend(Ptr<fb_info> info, int state) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int fb_set_user_cmap(Ptr<fb_cmap_user> cmap, Ptr<fb_info> info) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int fb_set_var(Ptr<fb_info> info, Ptr<fb_var_screeninfo> var) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long fb_sys_read(Ptr<fb_info> info, String buf,
      @Unsigned long count, Ptr<java.lang. @OriginalName("loff_t") Long> ppos) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int fb_unregister_client(Ptr<notifier_block> nb) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @Type(
      ...
      cType = "struct fb_fix_screeninfo"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class fb_fix_screeninfo extends Struct {
    ...
    public @Unsigned short @Size(2) [] reserved;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct fb_bitfield"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class fb_bitfield extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct fb_var_screeninfo"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class fb_var_screeninfo extends Struct {
    ...
    public @Unsigned int @Size(4) [] reserved;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct fb_cmap"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class fb_cmap extends Struct {
    public @Unsigned int start;

    public @Unsigned int len;

    public Ptr<java.lang. @Unsigned Short> red;

    public Ptr<java.lang. @Unsigned Short> green;

    public Ptr<java.lang. @Unsigned Short> blue;

    public Ptr<java.lang. @Unsigned Short> transp;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct fb_copyarea"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class fb_copyarea extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct fb_fillrect"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class fb_fillrect extends Struct {
    public @Unsigned int dx;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct fb_image"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class fb_image extends Struct {
    public @Unsigned int dx;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct fb_cursor"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class fb_cursor extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct fb_chroma"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class fb_chroma extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct fb_monspecs"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class fb_monspecs extends Struct {
    public fb_chroma chroma;

    public Ptr<fb_videomode> modedb;

    public char @Size(4) [] manufacturer;

    public char @Size(14) [] monitor;

    public char @Size(14) [] serial_no;

    public char @Size(14) [] ascii;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct fb_videomode"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class fb_videomode extends Struct {
    public String name;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct fb_info"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class fb_info extends Struct {
    ...
    public list_head modelist;

    public Ptr<fb_videomode> mode;

    public int blank;

    public Ptr<backlight_device> bl_dev;

    public mutex bl_curve_mutex;

    public char @Size(128) [] bl_curve;

    public Ptr<lcd_device> lcd_dev;

    public delayed_work deferred_work;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct fb_blit_caps"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class fb_blit_caps extends Struct {
    public @Unsigned long @Size(1) [] x;

    public @Unsigned long @Size(2) [] y;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct fb_pixmap"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class fb_pixmap extends Struct {
    ...
    public @Unsigned long @Size(1) [] blit_x;

    public @Unsigned long @Size(2) [] blit_y;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct fb_deferred_io_pageref"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class fb_deferred_io_pageref extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct fb_deferred_io"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class fb_deferred_io extends Struct {
  ...
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class fb_ops extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct fb_tilemap"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class fb_tilemap extends Struct {
    public @Unsigned int width;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct fb_tilerect"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class fb_tilerect extends Struct {
    public @Unsigned int sx;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct fb_tilearea"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class fb_tilearea extends Struct {
    public @Unsigned int sx;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct fb_tileblit"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class fb_tileblit extends Struct {
    public @Unsigned int sx;
    ...
    public Ptr<java.lang. @Unsigned Integer> indices;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct fb_tilecursor"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class fb_tilecursor extends Struct {
    public @Unsigned int sx;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct fb_tile_ops"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class fb_tile_ops extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct fb_modelist"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class fb_modelist extends Struct {
    public list_head list;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct fb_cmap_user"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class fb_cmap_user extends Struct {
    public @Unsigned int start;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct fb_cvt_data"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class fb_cvt_data extends Struct {
    public @Unsigned int xres;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct __fb_timings"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class __fb_timings extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct fb_fix_screeninfo32"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class fb_fix_screeninfo32 extends Struct {
    public char @Size(16) [] id;

    public @Unsigned @OriginalName("compat_caddr_t") int smem_start;
    ...
    public @Unsigned @OriginalName("compat_caddr_t") int mmio_start;

    public @Unsigned int mmio_len;

    public @Unsigned int accel;

    public @Unsigned short @Size(3) [] reserved;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct fb_cmap32"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class fb_cmap32 extends Struct {
    public @Unsigned int start;

    public @Unsigned int len;

    public @Unsigned @OriginalName("compat_caddr_t") int red;

    public @Unsigned @OriginalName("compat_caddr_t") int green;

    public @Unsigned @OriginalName("compat_caddr_t") int blue;

    public @Unsigned @OriginalName("compat_caddr_t") int transp;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct fb_con2fbmap"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class fb_con2fbmap extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct fb_address"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class fb_address extends Struct {
    public Ptr<?> address;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct fb_reverse"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class fb_reverse extends Struct {
    public boolean _byte;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct fb_pattern"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class fb_pattern extends Struct {
    public @Unsigned long pixels;

    public int left;

    public int right;

    public fb_reverse reverse;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct fb_bitmap_iter"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class fb_bitmap_iter extends Struct {
    public Ptr<java.lang.Character> data;

    public @Unsigned long @Size(2) [] colors;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct fb_color_iter"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class fb_color_iter extends Struct {
    public Ptr<java.lang.Character> data;

    public Ptr<java.lang. @Unsigned Integer> palette;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct fb_bitmap4x_iter"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class fb_bitmap4x_iter extends Struct {
    public Ptr<java.lang.Character> data;

    public @Unsigned int fgxcolor;

    public @Unsigned int bgcolor;

    public int width;

    public int i;

    public Ptr<java.lang. @Unsigned Integer> expand;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct fbcurpos"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class fbcurpos extends Struct {

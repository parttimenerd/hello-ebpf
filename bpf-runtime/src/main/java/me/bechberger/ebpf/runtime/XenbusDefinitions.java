...
/**
 * Generated class for BPF runtime types that start with xenbus
 */
@java.lang.SuppressWarnings("unused")
public final class XenbusDefinitions {
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int __xenbus_map_ring(Ptr<xenbus_device> dev,
      Ptr<java.lang. @Unsigned @OriginalName("grant_ref_t") Integer> gnt_refs,
      @Unsigned int nr_grefs,
      Ptr<java.lang. @Unsigned @OriginalName("grant_handle_t") Integer> handles,
      Ptr<map_ring_valloc> info, @Unsigned int flags,
      Ptr<java.lang. @OriginalName("bool") Boolean> leaked) {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int __xenbus_switch_state(Ptr<xenbus_device> dev, xenbus_state state, int depth) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static long xenbus_alloc(@Unsigned @OriginalName("domid_t") short domid) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int xenbus_alloc_evtchn(Ptr<xenbus_device> dev,
      Ptr<java.lang. @Unsigned @OriginalName("evtchn_port_t") Integer> port) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static long xenbus_backend_ioctl(Ptr<file> file, @Unsigned int cmd, @Unsigned long data) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int xenbus_backend_mmap(Ptr<file> file, Ptr<vm_area_struct> vma) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int xenbus_backend_open(Ptr<inode> inode, Ptr<file> filp) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int xenbus_dev_cancel(Ptr<device> dev) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int xenbus_dev_probe(Ptr<device> _dev) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void xenbus_dev_queue_reply(Ptr<xb_req_data> req) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void xenbus_dev_release(Ptr<device> dev) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void xenbus_dev_remove(Ptr<device> _dev) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int xenbus_dev_request_and_reply(Ptr<xsd_sockmsg> msg, Ptr<?> par) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int xenbus_dev_resume(Ptr<device> dev) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int xenbus_dev_suspend(Ptr<device> dev) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int xenbus_file_open(Ptr<inode> inode, Ptr<file> filp) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static @Unsigned @OriginalName("__poll_t") int xenbus_file_poll(Ptr<file> file,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long xenbus_file_read(Ptr<file> filp, String ubuf,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int xenbus_file_release(Ptr<inode> inode, Ptr<file> filp) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int xenbus_free_evtchn(Ptr<xenbus_device> dev,
      @Unsigned @OriginalName("evtchn_port_t") int port) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void xenbus_frontend_delayed_resume(Ptr<work_struct> w) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int xenbus_frontend_dev_probe(Ptr<device> dev) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int xenbus_frontend_dev_resume(Ptr<device> dev) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void xenbus_frontend_dev_shutdown(Ptr<device> _dev) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("irqreturn_t") irqreturn xenbus_late_init(int irq, Ptr<?> unused) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int xenbus_map_ring_hvm(Ptr<xenbus_device> dev, Ptr<map_ring_valloc> info,
      Ptr<java.lang. @Unsigned @OriginalName("grant_ref_t") Integer> gnt_ref,
      @Unsigned int nr_grefs, Ptr<Ptr<?>> vaddr) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int xenbus_map_ring_pv(Ptr<xenbus_device> dev, Ptr<map_ring_valloc> info,
      Ptr<java.lang. @Unsigned @OriginalName("grant_ref_t") Integer> gnt_refs,
      @Unsigned int nr_grefs, Ptr<Ptr<?>> vaddr) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void xenbus_map_ring_setup_grant_hvm(@Unsigned long gfn, @Unsigned int goffset,
      @Unsigned int len, Ptr<?> data) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int xenbus_map_ring_valloc(Ptr<xenbus_device> dev,
      Ptr<java.lang. @Unsigned @OriginalName("grant_ref_t") Integer> gnt_refs,
      @Unsigned int nr_grefs, Ptr<Ptr<?>> vaddr) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int xenbus_probe_devices(Ptr<xen_bus_type> bus) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int xenbus_read_otherend_details(Ptr<xenbus_device> xendev, String id_node,
      String path_node) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int xenbus_resume_cb(Ptr<notifier_block> nb, @Unsigned long action, Ptr<?> data) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int xenbus_setup_ring(Ptr<xenbus_device> dev,
      @Unsigned @OriginalName("gfp_t") int gfp, Ptr<Ptr<?>> vaddr, @Unsigned int nr_pages,
      Ptr<java.lang. @Unsigned @OriginalName("grant_ref_t") Integer> grefs) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction("((const u8*)xenbus_strstate($arg1))")
  public static String xenbus_strstate(xenbus_state state) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int xenbus_switch_state(Ptr<xenbus_device> dev, xenbus_state state) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void xenbus_teardown_ring(Ptr<Ptr<?>> vaddr, @Unsigned int nr_pages,
      Ptr<java.lang. @Unsigned @OriginalName("grant_ref_t") Integer> grefs) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int xenbus_unmap_ring(Ptr<xenbus_device> dev,
      Ptr<java.lang. @Unsigned @OriginalName("grant_handle_t") Integer> handles,
      @Unsigned int nr_handles, Ptr<java.lang. @Unsigned Long> vaddrs) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void xenbus_unmap_ring_setup_grant_hvm(@Unsigned long gfn, @Unsigned int goffset,
      @Unsigned int len, Ptr<?> data) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void xenbus_worker(Ptr<work_struct> wq) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @Type(
      ...
      cType = "struct xenbus_watch"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class xenbus_watch extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct xenbus_transaction"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class xenbus_transaction extends Struct {
    public @Unsigned int id;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "enum xenbus_state"
  )
  public enum xenbus_state implements Enum<xenbus_state>, TypedEnum<xenbus_state, java.lang. @Unsigned Integer> {
    /**
     * {@code XenbusStateUnknown = 0}
     */
    @EnumMember(
        value = 0L,
    ...
    /**
     * {@code XenbusStateInitialising = 1}
     */
    @EnumMember(
        value = 1L,
    ...
    /**
     * {@code XenbusStateReconfiguring = 7}
     */
    @EnumMember(
        value = 7L,
    ...
    /**
     * {@code XenbusStateReconfigured = 8}
     */
    @EnumMember(
        value = 8L,
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct xenbus_device"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class xenbus_device extends Struct {
    ...
    public completion down;

    public work_struct work;

    public semaphore reclaim_sem;

    public atomic_t event_channels;

    public atomic_t events;

    public atomic_t spurious_events;

    public atomic_t jiffies_eoi_delayed;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct xenbus_map_node"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class xenbus_map_node extends Struct {
    ...
    public @Unsigned @OriginalName("grant_handle_t") int @Size(16) [] handles;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct xenbus_ring_ops"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class xenbus_ring_ops extends Struct {
    public Ptr<?> map;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct xenbus_device_id"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class xenbus_device_id extends Struct {
    public char @Size(32) [] devicetype;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct xenbus_driver"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class xenbus_driver extends Struct {
    public String name;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct xenbus_transaction_holder"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class xenbus_transaction_holder extends Struct {
    public list_head list;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct xenbus_file_priv"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class xenbus_file_priv extends Struct {
    public mutex msgbuffer_mutex;

    public list_head transactions;

    public list_head watches;

    public @Unsigned int len;

    public u_of_xenbus_file_priv u;

    public mutex reply_mutex;

    public list_head read_buffers;

    public @OriginalName("wait_queue_head_t") wait_queue_head read_waitq;

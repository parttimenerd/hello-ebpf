...
/**
 * Generated class for BPF runtime types that start with integrity
 */
...
public final class IntegrityDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction("integrity_init_keyring((const unsigned int)$arg1)")
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int integrity_kernel_read(Ptr<file> file, @OriginalName("loff_t") long offset,
      Ptr<?> addr, @Unsigned long count) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction("integrity_keyring_from_id((const unsigned int)$arg1)")
  public static Ptr<key> integrity_keyring_from_id(@Unsigned int id) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @Type(
      ...
      cType = "enum integrity_status"
  )
  public enum integrity_status implements Enum<integrity_status>, TypedEnum<integrity_status, java.lang. @Unsigned Integer> {
    /**
     * {@code INTEGRITY_PASS = 0}
     */
    @EnumMember(
        value = 0L,
        name = "INTEGRITY_PASS"
    ...
    /**
     * {@code INTEGRITY_PASS_IMMUTABLE = 1}
     */
    @EnumMember(
        value = 1L,
        name = "INTEGRITY_PASS_IMMUTABLE"
    )
    INTEGRITY_PASS_IMMUTABLE,

    /**
     * {@code INTEGRITY_FAIL = 2}
     */
    @EnumMember(
        value = 2L,
        name = "INTEGRITY_FAIL"
    ...
    /**
     * {@code INTEGRITY_FAIL_IMMUTABLE = 3}
     */
    @EnumMember(
        value = 3L,
        name = "INTEGRITY_FAIL_IMMUTABLE"
    )
    INTEGRITY_FAIL_IMMUTABLE,

    /**
     * {@code INTEGRITY_NOLABEL = 4}
     */
    @EnumMember(
        value = 4L,
        name = "INTEGRITY_NOLABEL"
    )
    INTEGRITY_NOLABEL,

    /**
     * {@code INTEGRITY_NOXATTRS = 5}
     */
    @EnumMember(
        value = 5L,
        name = "INTEGRITY_NOXATTRS"
    )
    INTEGRITY_NOXATTRS,

    /**
     * {@code INTEGRITY_UNKNOWN = 6}
     */
    @EnumMember(
        value = 6L,
        name = "INTEGRITY_UNKNOWN"
    )
    INTEGRITY_UNKNOWN
  }
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct integrity_inode_attributes"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class integrity_inode_attributes extends Struct {

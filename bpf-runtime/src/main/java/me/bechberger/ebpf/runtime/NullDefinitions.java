...
/**
 * Generated class for BPF runtime types that start with null
 */
...
public final class NullDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int null_final(Ptr<shash_desc> desc, Ptr<java.lang.Character> out) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int null_init(Ptr<shash_desc> desc) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("loff_t") long null_lseek(Ptr<file> file,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long null_show(Ptr<mddev> mddev, String page) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int null_skcipher_crypt(Ptr<skcipher_request> req) {
    throw new MethodIsBPFRelatedFunction();
  }

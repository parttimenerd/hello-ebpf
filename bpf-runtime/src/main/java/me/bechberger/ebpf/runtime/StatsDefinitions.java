...
/**
 * Generated class for BPF runtime types that start with stats
 */
...
public final class StatsDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int stats_open(Ptr<inode> inode, Ptr<file> file) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int stats_parse_request(Ptr<ethnl_req_info> req_base, Ptr<Ptr<nlattr>> tb,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void stats_request(Ptr<virtqueue> vq) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int stats_show(Ptr<seq_file> seq, Ptr<?> v) {
    throw new MethodIsBPFRelatedFunction();
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct { int promotion_count; int demotion_count; }"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class stats_of_ladder_device_state extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "union { struct macsec_tx_sc_stats *tx_sc_stats; struct macsec_tx_sa_stats *tx_sa_stats; struct macsec_rx_sc_stats *rx_sc_stats; struct macsec_rx_sa_stats *rx_sa_stats; struct macsec_dev_stats *dev_stats; }"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class stats_of_macsec_context extends Union {
    public Ptr<macsec_tx_sc_stats> tx_sc_stats;

    public Ptr<macsec_tx_sa_stats> tx_sa_stats;

    public Ptr<macsec_rx_sc_stats> rx_sc_stats;

    public Ptr<macsec_rx_sa_stats> rx_sa_stats;

    public Ptr<macsec_dev_stats> dev_stats;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct stats_req_info"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class stats_req_info extends Struct {
    public ethnl_req_info base;

    public @Unsigned long @Size(1) [] stat_mask;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct stats_reply_data"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class stats_reply_data extends Struct {
    public ethnl_reply_data base;

    @InlineUnion(61259)
    public anon_member_of_anon_member_of_stats_reply_data_and_stats_of_anon_member_of_stats_reply_data anon1$0;

    @InlineUnion(61259)
    public anon_member_of_anon_member_of_stats_reply_data_and_stats_of_anon_member_of_stats_reply_data stats;

    public Ptr<ethtool_rmon_hist_range> rmon_ranges;
  }
}

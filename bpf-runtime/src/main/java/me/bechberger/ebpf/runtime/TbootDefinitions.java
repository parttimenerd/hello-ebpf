...
/**
 * Generated class for BPF runtime types that start with tboot
 */
@java.lang.SuppressWarnings("unused")
public final class TbootDefinitions {
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int tboot_dying_cpu(@Unsigned int cpu) {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int tboot_extended_sleep(char sleep_state, @Unsigned int val_a,
      @Unsigned int val_b) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<acpi_table_header> tboot_get_dmar_table(Ptr<acpi_table_header> dmar_tbl) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long tboot_log_read(Ptr<file> file, String user_buf,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int tboot_sleep(char sleep_state, @Unsigned int pm1a_control,
  ...
  @Type(
      ...
      cType = "struct tboot_mac_region"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class tboot_mac_region extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct tboot_acpi_generic_address"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class tboot_acpi_generic_address extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct tboot_acpi_sleep_info"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class tboot_acpi_sleep_info extends Struct {

...
/**
 * Generated class for BPF runtime types that start with cn
 */
...
public final class CnDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int cn_bind(Ptr<net> net, int group) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int cn_filter(Ptr<sock> dsk, Ptr<sk_buff> skb, Ptr<?> data) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int cn_netlink_send(Ptr<cn_msg> msg, @Unsigned int portid, @Unsigned int __group,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int cn_netlink_send_mult(Ptr<cn_msg> msg, @Unsigned short len, @Unsigned int portid,
      @Unsigned int __group, @Unsigned @OriginalName("gfp_t") int gfp_mask,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int cn_print_exe_file(Ptr<core_name> cn, boolean name_only) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void cn_proc_mcast_ctl(Ptr<cn_msg> msg, Ptr<netlink_skb_parms> nsp) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int cn_proc_show(Ptr<seq_file> m, Ptr<?> v) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void cn_release(Ptr<sock> sk, Ptr<java.lang. @Unsigned Long> groups) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void cn_rx_skb(Ptr<sk_buff> skb) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  public static class cn_msg extends Struct {
    public cb_id id;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct cn_queue_dev"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class cn_queue_dev extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct cn_callback_id"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class cn_callback_id extends Struct {
    public char @Size(32) [] name;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct cn_callback_entry"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class cn_callback_entry extends Struct {
    public list_head callback_entry;
  ...
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class cn_dev extends Struct {
    public cb_id id;

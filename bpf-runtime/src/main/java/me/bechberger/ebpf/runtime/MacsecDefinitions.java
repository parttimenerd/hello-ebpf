...
/**
 * Generated class for BPF runtime types that start with macsec
 */
@java.lang.SuppressWarnings("unused")
public final class MacsecDefinitions {
  @Type(
      noCCodeGeneration = true,
      cType = "struct macsec_ops"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class macsec_ops extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "enum macsec_validation_type"
  )
  public enum macsec_validation_type implements Enum<macsec_validation_type>, TypedEnum<macsec_validation_type, java.lang. @Unsigned Integer> {
    /**
     * {@code MACSEC_VALIDATE_DISABLED = 0}
     */
    @EnumMember(
        value = 0L,
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "enum macsec_offload"
  )
  public enum macsec_offload implements Enum<macsec_offload>, TypedEnum<macsec_offload, java.lang. @Unsigned Integer> {
    /**
     * {@code MACSEC_OFFLOAD_OFF = 0}
     */
    @EnumMember(
        value = 0L,
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct macsec_key"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class macsec_key extends Struct {
    public char @Size(16) [] id;

    public Ptr<crypto_aead> tfm;

    public @OriginalName("salt_t") salt salt;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct macsec_rx_sc_stats"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class macsec_rx_sc_stats extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct macsec_rx_sa_stats"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class macsec_rx_sa_stats extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct macsec_tx_sa_stats"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class macsec_tx_sa_stats extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct macsec_tx_sc_stats"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class macsec_tx_sc_stats extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct macsec_dev_stats"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class macsec_dev_stats extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct macsec_rx_sa"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class macsec_rx_sa extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct macsec_rx_sc"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class macsec_rx_sc extends Struct {
    public Ptr<macsec_rx_sc> next;

    public @Unsigned @OriginalName("sci_t") long sci;

    public boolean active;

    public Ptr<macsec_rx_sa> @Size(4) [] sa;

    public Ptr<pcpu_rx_sc_stats> stats;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct macsec_tx_sa"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class macsec_tx_sa extends Struct {
    public macsec_key key;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct macsec_tx_sc"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class macsec_tx_sc extends Struct {
    public boolean active;
    ...
    public Ptr<macsec_tx_sa> @Size(4) [] sa;

    public Ptr<pcpu_tx_sc_stats> stats;

    public Ptr<metadata_dst> md_dst;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct macsec_secy"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class macsec_secy extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct macsec_context"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class macsec_context extends Struct {
    @InlineUnion(50376)
    public Ptr<net_device> netdev;
    ...
    public sa_of_macsec_context sa;

    public stats_of_macsec_context stats;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct macsec_info"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class macsec_info extends Struct {
    public @Unsigned @OriginalName("sci_t") long sci;
  }
}

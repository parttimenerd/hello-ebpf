...
/**
 * Generated class for BPF runtime types that start with kobject
 */
@java.lang.SuppressWarnings("unused")
public final class KobjectDefinitions {
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void __kobject_del(Ptr<kobject> kobj) {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int kobject_add_internal(Ptr<kobject> kobj) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void kobject_cleanup(Ptr<kobject> kobj) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void kobject_del(Ptr<kobject> kobj) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<kobject> kobject_get(Ptr<kobject> kobj) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<kobject> kobject_get_unless_zero(Ptr<kobject> kobj) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int kobject_move(Ptr<kobject> kobj, Ptr<kobject> new_parent) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void kobject_put(Ptr<kobject> kobj) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int kobject_uevent(Ptr<kobject> kobj, kobject_action action) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int kobject_uevent_env(Ptr<kobject> kobj, kobject_action action,
      Ptr<String> envp_ext) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @Type(
      ...
      cType = "enum kobject_action"
  )
  public enum kobject_action implements Enum<kobject_action>, TypedEnum<kobject_action, java.lang. @Unsigned Integer> {
    /**
     * {@code KOBJ_ADD = 0}
     */
    @EnumMember(

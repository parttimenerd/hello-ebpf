...
/**
 * Generated class for BPF runtime types that start with tls
 */
...
public final class TlsDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int tls_alert_send(Ptr<socket> sock, char level, char description) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int tls_handshake_accept(Ptr<handshake_req> req, Ptr<genl_info> info, int fd) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static boolean tls_handshake_cancel(Ptr<sock> sk) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void tls_handshake_close(Ptr<socket> sock) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void tls_handshake_done(Ptr<handshake_req> req, @Unsigned int status,
      Ptr<genl_info> info) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @Type(
      ...
      cType = "struct tls_descs"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class tls_descs extends Struct {
    public desc_struct @Size(3) [] desc;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct tls_msg"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class tls_msg extends Struct {
    public char control;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct tls_crypto_info"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class tls_crypto_info extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct tls_strparser"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class tls_strparser extends Struct {
    public Ptr<sock> sk;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct tls_sw_context_rx"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class tls_sw_context_rx extends Struct {
    public Ptr<crypto_aead> aead_recv;

    public crypto_wait async_wait;

    public sk_buff_head rx_list;
    ...
    public boolean key_update_pending;

    public tls_strparser strp;

    public atomic_t decrypt_pending;

    public sk_buff_head async_hold;

    public wait_queue_head wq;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct tls_context"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class tls_context extends Struct {
    ...
    public cipher_context tx;

    public cipher_context rx;

    public Ptr<scatterlist> partially_sent_record;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "union tls_crypto_context"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class tls_crypto_context extends Union {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct tls_prot_info"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class tls_prot_info extends Struct {
    public @Unsigned short version;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "enum tls_offload_ctx_dir"
  )
  public enum tls_offload_ctx_dir implements Enum<tls_offload_ctx_dir>, TypedEnum<tls_offload_ctx_dir, java.lang. @Unsigned Integer> {
    /**
     * {@code TLS_OFFLOAD_CTX_DIR_RX = 0}
     */
    @EnumMember(
        value = 0L,
        name = "TLS_OFFLOAD_CTX_DIR_RX"
    )
    TLS_OFFLOAD_CTX_DIR_RX,

    /**
     * {@code TLS_OFFLOAD_CTX_DIR_TX = 1}
     */
    @EnumMember(
        value = 1L,
        name = "TLS_OFFLOAD_CTX_DIR_TX"
    )
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct tls_sw_context_tx"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class tls_sw_context_tx extends Struct {
    public Ptr<crypto_aead> aead_send;

    public crypto_wait async_wait;

    public tx_work tx_work;

    public @OriginalName("tls_rec") Ptr<?> open_rec;

    public list_head tx_list;

    public atomic_t encrypt_pending;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct tls_handshake_args"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class tls_handshake_args extends Struct {
    public Ptr<socket> ta_sock;

    public @OriginalName("tls_done_func_t") Ptr<?> ta_done;
    ...
    public @OriginalName("key_serial_t") int ta_keyring;

    public @OriginalName("key_serial_t") int ta_my_cert;

    public @OriginalName("key_serial_t") int ta_my_privkey;

    public @Unsigned int ta_num_peerids;

    public @OriginalName("key_serial_t") int @Size(5) [] ta_my_peerids;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct tls_handshake_req"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class tls_handshake_req extends Struct {
    ...
    public @OriginalName("key_serial_t") int th_keyring;

    public @OriginalName("key_serial_t") int th_certificate;

    public @OriginalName("key_serial_t") int th_privkey;

    public @Unsigned int th_num_peerids;

    public @OriginalName("key_serial_t") int @Size(5) [] th_peerid;
  }
}

...
/**
 * Generated class for BPF runtime types that start with kallsyms
 */
...
public final class KallsymsDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @Unsigned int kallsyms_expand_symbol(@Unsigned int off, String result,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction("((const u8*)kallsyms_lookup($arg1, $arg2, $arg3, $arg4, $arg5))")
  public static String kallsyms_lookup(@Unsigned long addr,
      Ptr<java.lang. @Unsigned Long> symbolsize, Ptr<java.lang. @Unsigned Long> offset,
      Ptr<String> modname, String namebuf) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction("kallsyms_lookup_buildid($arg1, $arg2, $arg3, $arg4, (const u8**)$arg5, $arg6)")
  public static int kallsyms_lookup_buildid(@Unsigned long addr,
      Ptr<java.lang. @Unsigned Long> symbolsize, Ptr<java.lang. @Unsigned Long> offset,
      Ptr<String> modname, Ptr<String> modbuildid, String namebuf) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int kallsyms_lookup_size_offset(@Unsigned long addr,
      Ptr<java.lang. @Unsigned Long> symbolsize, Ptr<java.lang. @Unsigned Long> offset) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction("kallsyms_on_each_symbol((int (*)(void*, const u8*, long unsigned int))$arg1, $arg2)")
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int kallsyms_open(Ptr<inode> inode, Ptr<file> file) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @Type(
      ...
      cType = "struct kallsyms_data"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class kallsyms_data extends Struct {

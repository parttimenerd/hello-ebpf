...
/**
 * Generated class for BPF runtime types that start with sev
 */
@java.lang.SuppressWarnings("unused")
public final class SevDefinitions {
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int __sev_cpuid_hv(@Unsigned int fn, int reg_idx,
      Ptr<java.lang. @Unsigned Integer> reg) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int __sev_cpuid_hv_ghcb(Ptr<ghcb> ghcb, Ptr<es_em_ctxt> ctxt,
      Ptr<cpuid_leaf> leaf) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int __sev_cpuid_hv_msr(Ptr<cpuid_leaf> leaf) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void __sev_es_ist_enter(Ptr<pt_regs> regs) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<ghcb> __sev_get_ghcb(Ptr<ghcb_state> state) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void __sev_put_ghcb(Ptr<ghcb_state> state) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static boolean sev_es_check_cpu_features() {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int sev_es_efi_map_ghcbs_cas(Ptr<pgd_t> pgd) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static es_result sev_es_ghcb_hv_call(Ptr<ghcb> ghcb, Ptr<es_em_ctxt> ctxt,
      @Unsigned long exit_code, @Unsigned long exit_info_1, @Unsigned long exit_info_2) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static boolean sev_es_negotiate_protocol() {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @Unsigned long sev_es_rd_ghcb_msr() {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int sev_es_setup_ap_jump_table(Ptr<real_mode_header> rmh) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @Type(
      ...
      cType = "struct sev_config"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class sev_config extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct sev_es_save_area"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class sev_es_save_area extends Struct {
    public vmcb_seg es;
    ...
    public vmcb_seg gdtr;

    public vmcb_seg ldtr;

    public vmcb_seg idtr;
    ...
    public char @Size(2) [] reserved_0xc8;

    public char vmpl;

    public char cpl;

    public char @Size(4) [] reserved_0xcc;

    public @Unsigned long efer;

    public char @Size(104) [] reserved_0xd8;
    ...
    public char @Size(24) [] reserved_0x1c0;
    ...
    public char @Size(32) [] reserved_0x248;
    ...
    public char @Size(80) [] reserved_0x298;
    ...
    public char @Size(8) [] reserved_0x300;
    ...
    public char @Size(16) [] reserved_0x380;
    ...
    public char @Size(16) [] reserved_0x3f0;
    ...
    public char @Size(80) [] fpreg_x87;

    public char @Size(256) [] fpreg_xmm;

    public char @Size(256) [] fpreg_ymm;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct sev_es_runtime_data"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class sev_es_runtime_data extends Struct {
    public ghcb ghcb_page;

    public ghcb backup_ghcb;

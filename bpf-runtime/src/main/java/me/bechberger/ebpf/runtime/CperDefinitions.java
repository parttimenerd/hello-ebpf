...
/**
 * Generated class for BPF runtime types that start with cper
 */
...
public final class CperDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction("((const u8*)cper_mem_err_status_str($arg1))")
  public static String cper_mem_err_status_str(@Unsigned long status) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction("((const u8*)cper_mem_err_type_str($arg1))")
  public static String cper_mem_err_type_str(@Unsigned int etype) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction("((const u8*)cper_mem_err_unpack($arg1, $arg2))")
  public static String cper_mem_err_unpack(Ptr<trace_seq> p, Ptr<cper_mem_err_compact> cmem) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction("((const u8*)cper_severity_str($arg1))")
  public static String cper_severity_str(@Unsigned int severity) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @Type(
      ...
      cType = "struct cper_record_header"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class cper_record_header extends Struct {
    ...
    public @OriginalName("guid_t") uuid_t platform_id;

    public @OriginalName("guid_t") uuid_t partition_id;

    public @OriginalName("guid_t") uuid_t creator_id;

    public @OriginalName("guid_t") uuid_t notification_type;
    ...
    public char @Size(12) [] reserved;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct cper_section_descriptor"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class cper_section_descriptor extends Struct {
    ...
    public @OriginalName("guid_t") uuid_t section_type;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct cper_ia_proc_ctx"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class cper_ia_proc_ctx extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct cper_sec_mem_err"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class cper_sec_mem_err extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct cper_mce_record"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class cper_mce_record extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct cper_pstore_record"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class cper_pstore_record extends Struct {
    public cper_record_header hdr;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct cper_sec_proc_arm"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class cper_sec_proc_arm extends Struct {
    public @Unsigned int validation_bits;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct cper_arm_err_info"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class cper_arm_err_info extends Struct {
    public char version;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct cper_sec_pcie"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class cper_sec_pcie extends Struct {
    public @Unsigned long validation_bits;

    public @Unsigned int port_type;

    public version_of_cper_sec_pcie version;
    ...
    public device_id_of_cper_sec_pcie device_id;

    public anon_member_of_pn_and_anon_member_of_pn_t_and_serial_number_of_cper_sec_pcie serial_number;

    public bridge_of_cper_sec_pcie bridge;

    public char @Size(60) [] capability;

    public char @Size(96) [] aer_info;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct cper_cxl_event_devid"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class cper_cxl_event_devid extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct cper_cxl_event_sn"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class cper_cxl_event_sn extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct cper_mem_err_compact"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class cper_mem_err_compact extends Struct {
    public @Unsigned long validation_bits;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct cper_sec_proc_generic"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class cper_sec_proc_generic extends Struct {
    public @Unsigned long validation_bits;
    ...
    public char @Size(128) [] cpu_brand;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct cper_sec_proc_ia"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class cper_sec_proc_ia extends Struct {
    public @Unsigned long validation_bits;

    public @Unsigned long lapic_id;

    public char @Size(48) [] cpuid;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct cper_sec_fw_err_rec_ref"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class cper_sec_fw_err_rec_ref extends Struct {
    ...
    public @OriginalName("guid_t") uuid_t record_identifier_guid;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct cper_ia_err_info"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class cper_ia_err_info extends Struct {
    public @OriginalName("guid_t") uuid_t err_type;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct cper_arm_ctx_info"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class cper_arm_ctx_info extends Struct {

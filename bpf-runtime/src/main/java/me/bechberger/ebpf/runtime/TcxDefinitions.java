...
/**
 * Generated class for BPF runtime types that start with tcx
 */
...
public final class TcxDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void tcx_link_dealloc(Ptr<bpf_link> link) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int tcx_link_detach(Ptr<bpf_link> link) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int tcx_link_prog_attach(Ptr<bpf_link> link, @Unsigned int flags,
      @Unsigned int id_or_fd, @Unsigned long revision) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void tcx_link_release(Ptr<bpf_link> link) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int tcx_link_update(Ptr<bpf_link> link, Ptr<bpf_prog> nprog, Ptr<bpf_prog> oprog) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void tcx_uninstall(Ptr<net_device> dev, boolean ingress) {
    throw new MethodIsBPFRelatedFunction();
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct tcx_entry"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class tcx_entry extends Struct {
    public Ptr<mini_Qdisc> miniq;

    public bpf_mprog_bundle bundle;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct tcx_link"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class tcx_link extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "enum tcx_action_base"
  )
  public enum tcx_action_base implements Enum<tcx_action_base>, TypedEnum<tcx_action_base, java.lang.Integer> {
    /**
     * {@code TCX_NEXT = -1}
     */
    @EnumMember(

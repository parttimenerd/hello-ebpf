...
/**
 * Generated class for BPF runtime types that start with vcs
 */
@java.lang.SuppressWarnings("unused")
public final class VcsDefinitions {
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int vcs_fasync(int fd, Ptr<file> file, int on) {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("loff_t") long vcs_lseek(Ptr<file> file,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void vcs_make_sysfs(int index) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int vcs_notifier(Ptr<notifier_block> nb, @Unsigned long code, Ptr<?> _param) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int vcs_open(Ptr<inode> inode, Ptr<file> filp) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static @Unsigned @OriginalName("__poll_t") int vcs_poll(Ptr<file> file,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<vcs_poll_data> vcs_poll_data_get(Ptr<file> file) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long vcs_read(Ptr<file> file, String buf,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int vcs_release(Ptr<inode> inode, Ptr<file> file) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void vcs_remove_sysfs(int index) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void vcs_scr_updated(Ptr<vc_data> vc) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void vcs_scr_writew(Ptr<vc_data> vc, @Unsigned short val,
      Ptr<java.lang. @Unsigned Short> org) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @Type(
      ...
      cType = "struct vcs_poll_data"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class vcs_poll_data extends Struct {
    public notifier_block notifier;

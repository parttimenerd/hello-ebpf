...
/**
 * Generated class for BPF runtime types that start with resource
 */
...
public final class ResourceDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @Unsigned @OriginalName("resource_size_t") long resource_alignment(
      Ptr<resource> res) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long resource_in_use_show(Ptr<device> dev,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static boolean resource_is_exclusive(Ptr<resource> root, @Unsigned long addr,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<resource_entry> resource_list_create_entry(Ptr<resource> res,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void resource_list_free(Ptr<list_head> head) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @Unsigned @OriginalName("umode_t") short resource_resize_is_visible(
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long resource_show(Ptr<device> dev,
      Ptr<device_attribute> attr, String buf) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @Type(
      ...
      cType = "struct resource_constraint"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class resource_constraint extends Struct {
    ...
    public @OriginalName("resource_alignf") Ptr<?> alignf;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct resource_entry"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class resource_entry extends Struct {
    ...
    public resource __res;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct resource_win"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class resource_win extends Struct {
    public resource res;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct resource_table"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class resource_table extends Struct {
    ...
    public @Unsigned int @Size(0) [] offset;
  }
}

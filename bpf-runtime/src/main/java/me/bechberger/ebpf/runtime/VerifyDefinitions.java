...
/**
 * Generated class for BPF runtime types that start with verify
 */
@java.lang.SuppressWarnings("unused")
public final class VerifyDefinitions {
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int verify_and_dec_payload(Ptr<snp_msg_desc> mdesc, Ptr<snp_guest_req> req) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void verify_bh(Ptr<work_struct> work) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static boolean verify_data_blocks(Ptr<folio> data_folio, @Unsigned long len,
      @Unsigned long offset, @Unsigned long max_ra_pages) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int verify_dfa(Ptr<aa_dfa> dfa) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static es_result verify_exception_info(Ptr<ghcb> ghcb, Ptr<es_em_ctxt> ctxt) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int verify_group_input(Ptr<super_block> sb, Ptr<ext4_new_group_data> input) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static boolean verify_perms(Ptr<aa_policydb> pdb) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int verify_profile(Ptr<aa_profile> profile) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int verify_reserved_gdb(Ptr<super_block> sb,
      @Unsigned @OriginalName("ext4_group_t") int end, Ptr<buffer_head> primary) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int verify_spi_info(char proto, @Unsigned int min, @Unsigned int max,

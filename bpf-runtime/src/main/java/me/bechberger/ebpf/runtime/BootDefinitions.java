...
/**
 * Generated class for BPF runtime types that start with boot
 */
...
public final class BootDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int boot_config_proc_show(Ptr<seq_file> m, Ptr<?> v) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void boot_init_possible_blades(Ptr<uv_hub_info_s> hub_info) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long boot_vga_show(Ptr<device> dev,
  ...
  @Type(
      ...
      cType = "struct boot_e820_entry"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class boot_e820_entry extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct boot_params"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class boot_params extends Struct {
    public screen_info screen_info;

    public apm_bios_info apm_bios_info;

    public char @Size(4) [] _pad2;

    public @Unsigned long tboot_addr;

    public ist_info ist_info;

    public @Unsigned long acpi_rsdp_addr;

    public char @Size(8) [] _pad3;

    public char @Size(16) [] hd0_info;

    public char @Size(16) [] hd1_info;

    public sys_desc_table sys_desc_table;

    public olpc_ofw_header olpc_ofw_header;
    ...
    public char @Size(112) [] _pad4;

    public @Unsigned int cc_blob_address;

    public edid_info edid_info;

    public efi_info efi_info;
    ...
    public char @Size(2) [] _pad5;

    public char sentinel;

    public char @Size(1) [] _pad6;

    public setup_header hdr;

    public char @Size(36) [] _pad7;

    public @Unsigned int @Size(16) [] edd_mbr_sig_buffer;

    public boot_e820_entry @Size(128) [] e820_table;

    public char @Size(48) [] _pad8;

    public edd_info @Size(6) [] eddbuf;

    public char @Size(276) [] _pad9;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct boot_params_to_save"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class boot_params_to_save extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct boot_triggers"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class boot_triggers extends Struct {
    public String event;
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct boot_performance_record"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class boot_performance_record extends Struct {

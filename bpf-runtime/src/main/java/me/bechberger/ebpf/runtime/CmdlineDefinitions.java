...
/**
 * Generated class for BPF runtime types that start with cmdline
 */
...
public final class CmdlineDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int cmdline_parse_core(String p, Ptr<java.lang. @Unsigned Long> core,
      Ptr<java.lang. @Unsigned Long> percent) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int cmdline_parse_hugetlb_cma(String p) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int cmdline_parse_hugetlb_cma_only(String p) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int cmdline_partition(Ptr<parsed_partitions> state) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int cmdline_parts_setup(String s) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int cmdline_proc_show(Ptr<seq_file> m, Ptr<?> v) {
    throw new MethodIsBPFRelatedFunction();
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct cmdline_subpart"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class cmdline_subpart extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct cmdline_parts"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class cmdline_parts extends Struct {
    public char @Size(32) [] name;

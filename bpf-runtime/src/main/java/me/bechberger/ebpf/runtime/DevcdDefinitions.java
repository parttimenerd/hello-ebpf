...
/**
 * Generated class for BPF runtime types that start with devcd
 */
...
public final class DevcdDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void devcd_del(Ptr<work_struct> wk) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void devcd_dev_release(Ptr<device> dev) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int devcd_free(Ptr<device> dev, Ptr<?> data) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long devcd_read_from_sgtable(String buffer,
      @OriginalName("loff_t") long offset, @Unsigned long buf_len, Ptr<?> data,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long devcd_readv(String buffer,
      @OriginalName("loff_t") long offset, @Unsigned long count, Ptr<?> data,
  ...
  @Type(
      ...
      cType = "struct devcd_entry"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class devcd_entry extends Struct {
    public device devcd_dev;
    ...
    public delayed_work del_wk;

    public Ptr<device> failing_dev;
  }
}

...
/**
 * Generated class for BPF runtime types that start with debug
 */
...
public final class DebugDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int debug_async_open(Ptr<inode> inode, Ptr<file> file) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int debug_bandwidth_open(Ptr<inode> inode, Ptr<file> file) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int debug_close(Ptr<inode> inode, Ptr<file> file) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long debug_output(Ptr<file> file, String user_buf,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int debug_periodic_open(Ptr<inode> inode, Ptr<file> file) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int debug_registers_open(Ptr<inode> inode, Ptr<file> file) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void debug_show_blocker(Ptr<task_struct> task) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @Type(
      ...
      cType = "struct debug_store"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class debug_store extends Struct {
    ...
    public @Unsigned long @Size(48) [] pebs_event_reset;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct { struct kvm_debug_exit_arch arch; }"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class debug_of_anon_member_of_kvm_run extends Struct {
    public kvm_debug_exit_arch arch;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct debug_store_buffers"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class debug_store_buffers extends Struct {
    public char @Size(65536) [] bts_buffer;

    public char @Size(65536) [] pebs_buffer;
  }

  @Type(
      noCCodeGeneration = true,
      cType = "struct debug_buffer"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class debug_buffer extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct debug_reply_data"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class debug_reply_data extends Struct {

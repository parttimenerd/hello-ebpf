...
/**
 * Generated class for BPF runtime types that start with freeze
 */
@java.lang.SuppressWarnings("unused")
public final class FreezeDefinitions {
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void freeze_cgroup(Ptr<freezer> freezer) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long freeze_filesystems_show(Ptr<kobject> kobj,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int freeze_inc(Ptr<super_block> sb, freeze_holder who) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static @OriginalName("ssize_t") long freeze_on_smi_show(Ptr<device> cdev,
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static boolean freeze_task(Ptr<task_struct> p) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @Type(
      ...
      cType = "enum freeze_holder"
  )
  public enum freeze_holder implements Enum<freeze_holder>, TypedEnum<freeze_holder, java.lang. @Unsigned Integer> {
    /**
     * {@code FREEZE_HOLDER_KERNEL = 1}
     */
    @EnumMember(
        value = 1L,
        name = "FREEZE_HOLDER_KERNEL"
    )
    FREEZE_HOLDER_KERNEL,

    /**
     * {@code FREEZE_HOLDER_USERSPACE = 2}
     */
    @EnumMember(
        value = 2L,
        name = "FREEZE_HOLDER_USERSPACE"
    )
    FREEZE_HOLDER_USERSPACE,

    /**
     * {@code FREEZE_MAY_NEST = 4}
     */
    @EnumMember(
        value = 4L,
        name = "FREEZE_MAY_NEST"
    )
    FREEZE_MAY_NEST,

...
/**
 * Generated class for BPF runtime types that start with ndisc
 */
...
public final class NdiscDefinitions {
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<sk_buff> ndisc_alloc_skb(Ptr<net_device> dev, int len) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static int ndisc_constructor(Ptr<neighbour> neigh) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void ndisc_error_report(Ptr<neighbour> neigh, Ptr<sk_buff> skb) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void ndisc_net_exit(Ptr<net> net) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int ndisc_net_init(Ptr<net> net) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static int ndisc_netdev_event(Ptr<notifier_block> _this, @Unsigned long event,
      Ptr<?> ptr) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static Ptr<nd_opt_hdr> ndisc_next_option(Ptr<nd_opt_hdr> cur, Ptr<nd_opt_hdr> end) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void ndisc_ra_useropt(Ptr<sk_buff> ra, Ptr<nd_opt_hdr> opt) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static skb_drop_reason ndisc_rcv(Ptr<sk_buff> skb) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static skb_drop_reason ndisc_recv_na(Ptr<sk_buff> skb) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static skb_drop_reason ndisc_recv_ns(Ptr<sk_buff> skb) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static skb_drop_reason ndisc_recv_rs(Ptr<sk_buff> skb) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static skb_drop_reason ndisc_redirect_rcv(Ptr<sk_buff> skb) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static skb_drop_reason ndisc_router_discovery(Ptr<sk_buff> skb) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @NotUsableInJava
  @BuiltinBPFFunction
  public static void ndisc_send_unsol_na(Ptr<net_device> dev) {
    throw new MethodIsBPFRelatedFunction();
  }

  @NotUsableInJava
  @BuiltinBPFFunction
  public static void ndisc_solicit(Ptr<neighbour> neigh, Ptr<sk_buff> skb) {
    throw new MethodIsBPFRelatedFunction();
  }
  ...
  @Type(
      ...
      cType = "struct ndisc_ops"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class ndisc_ops extends Struct {
  ...
  @Type(
      noCCodeGeneration = true,
      cType = "struct ndisc_options"
  )
  @me.bechberger.ebpf.annotations.KernelBTF
  @NotUsableInJava
  public static class ndisc_options extends Struct {
    public Ptr<nd_opt_hdr> @Size(15) [] nd_opt_array;

    public Ptr<nd_opt_hdr> nd_opts_ri;

    public Ptr<nd_opt_hdr> nd_opts_ri_end;

    public Ptr<nd_opt_hdr> nd_useropts;

    public Ptr<nd_opt_hdr> nd_useropts_end;

    public Ptr<nd_opt_hdr> @Size(3) [] nd_802154_opt_array;
  }
}

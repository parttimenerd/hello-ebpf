...
![Tasks flow from the scheduler into a global DSQ, then into per-CPU local queues](../img/sched-ext/scheduler-dance.png)

---

## Example: Lottery Scheduler

![Visualization of lottery scheduling: tasks enqueue into a bowl, CPUs draw randomly](../img/sched-ext/lottery-bowl.png)
...
![Benchmark box-plot: Weighted Sample vs EEVDF vs FIFO scheduler (compilation time)](../img/sched-ext/benchmark-weighted-vs-eevdf.png)
